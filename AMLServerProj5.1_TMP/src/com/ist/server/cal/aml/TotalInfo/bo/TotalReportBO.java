...
public class TotalReportBO {
	...
	public int getP90_PJ_STAT_ANALYSIS(Connection conn, String statisticdate) throws Exception {
		String sql = " DELETE FROM T09_PJ_STAT_ANALY T WHERE T.STATISTICDATE = "
				+ func.vch2dt(statisticdate, "yyyy-mm-dd");
		int count = SQLExecute.exeSql(conn, sql);

		sql = " INSERT INTO T09_PJ_STAT_ANALY SELECT T1.ORGANKEY,T2.ORGANNAME,T1.PARTY_CLASS_CD,T1.EMENDATIONLEVEL, CUST_NUM,"
				+ func.vch2dt(statisticdate, "yyyy-mm-dd")
	...
	public int insert_t07_inrep_by_acct_mid(Connection conn, String statisticdate, String case_type, String granularity)
			throws Exception {
		...
		if (case_type.equals("1")) {
			...
			// sql="insert into
			// t07_inrep_by_acct_mid(organkey,report_dt,currency_cd,cast_type,total_num,"
			// +
			...
			// +" AND T1.SENDDATE_DT>=" +func.vch2dt(statisticdate,
			// "yyyy-mm-dd")
			// +" AND T1.SENDDATE_DT<=" +func.vch2dt(statisticdate,
			// "yyyy-mm-dd")
			// +" AND T1.MSG_TYPE_CD IN ('N', 'A') AND T2.INTERFACEKEY='BH' and
			// T3.ticd is null " +
			//
			// " GROUP BY T2.CREATE_ORG, T2.CURR_CD ) A GROUP BY
			// A.CREATE_ORG,A.CURR_CD";
			//
			// count = SQLExecute.exeSql(conn, sql);
	 ...
	 * "  from t47_party where  CREATE_DT=" + func.vch2dt(statisticdate,
	 * "yyyy-mm-dd"); int count = SQLExecute.exeSql(conn, sql); return count; }
	 */
	...
	public int insert_T10_CHECKPARTY_NEW(Connection conn, String statisticdate) throws Exception {
		...
		String sql = "insert into T10_CHECKPARTY_NEW(PARTY_ID,HOST_CUST_ID,PARTY_CLASS_CD,PARTY_CHN_NAME,CARD_TYPE,"
				...
				+ " A.CARD_NO,  A.ORGANKEY, A.create_dt,  A.PARTY_STATUS_CD,  A.AML1_TYPE_CD,  '0' "
				+ " from t47_party A, t47_individual B  where A.CREATE_DT ="+ func.vch2dt(statisticdate, "yyyy-mm-dd") 
				+ "AND A.PARTY_ID = B.PARTY_ID AND A.PARTY_CLASS_CD = 'I' AND "
				+ "( A.COUNTRY_CD is null or A.CARD_TYPE = NULL or A.CARD_NO is null or B.CARD_END_DT is null or B.OCCUPATION is null) ";
		int count = SQLExecute.exeSql(conn, sql);
		insert_T10_CHECKPARTY_NEW1(conn, statisticdate);
		insert_T10_T10_CHECKPARTY_RELT1(conn, statisticdate);
		insert_T10_T10_CHECKPARTY_RELT2(conn, statisticdate);
		return count;
	}

	public int insert_T10_CHECKPARTY_NEW1(Connection conn, String statisticdate) throws Exception {
		String sql = "insert into T10_CHECKPARTY_NEW(PARTY_ID,HOST_CUST_ID,PARTY_CLASS_CD,PARTY_CHN_NAME,CARD_TYPE,"
				+ "CARD_NO,ORGANKEY,CREATE_DT,PARTY_STATUS_CD,AML1_TYPE_CD,CHECK_STATUS) "
				+ " select A.PARTY_ID, A.HOST_CUST_ID, A.PARTY_CLASS_CD,A.PARTY_CHN_NAME, A.CARD_TYPE,"
				+ " A.CARD_NO,  A.ORGANKEY, A.create_dt,  A.PARTY_STATUS_CD,  A.AML1_TYPE_CD,  '0' "
				+ " from t47_party A, t47_corporation B  where  A.CREATE_DT = " + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ "AND A.PARTY_ID = B.PARTY_ID AND A.PARTY_CLASS_CD = 'C' AND "
				+ "( A.COUNTRY_CD is null  OR A.AML2_TYPE_CD is null OR A.CARD_TYPE is null  OR A.CARD_NO is null OR B.ENROL_FUND_CURRENCY_CD is null OR B.ENROL_FUND_AMT is null "
				+ "OR B.LEGAL_OBJ is null OR B.LEGAL_CARD_TYPE is null OR B.LEGAL_CARD_NO is null OR B.STOCK_HOLDER is null OR B.STOCK_HOLDER_CARD_TYPE is null OR B.STOCK_HOLDER_CARD_NO_END_DT is null) ";			
		int count2 = SQLExecute.exeSql(conn, sql);
		return count2;
	}
	...
	public int insert_T10_T10_CHECKPARTY_RELT2(Connection conn, String statisticdate) throws Exception {
		String sql = "insert into T10_CHECKPARTY_RELT (CHECK_NO,PARTY_ID,PARTY_CLASS_CD,PARTY_CHN_NAME,CARD_TYPE,CHECKER,CHECK_DT,"
				+ " CARD_NO,ORGANKEY,AML1_TYPE_CD,check_explain,VALID_DT,check_result) "
				+ "select SEQ_T10_CHECKPARTY_RELT.Nextval,A.PARTY_ID,A.PARTY_CLASS_CD, A.PARTY_CHN_NAME,  A.CARD_TYPE, A.LAST_UPD_USER,A.CREATE_DT,  A.CARD_NO, "
				+ "   A.ORGANKEY,A.AML1_TYPE_CD, '绯荤粺鑷姩璇嗗埆',  to_date('2030-12-31','yyyy-mm-dd'), '1' "
	...
	public int insert_T10_CHECKPARTY_RE1(Connection conn, String statisticdate) throws Exception {
		String sql = "insert into T10_CHECKPARTY_RE(PARTY_ID,RECHECK_TYPE,HOST_CUST_ID,PARTY_CLASS_CD,PARTY_CHN_NAME,CARD_TYPE,"
				...
				+ "b.CARD_NO,b.ORGANKEY," + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ ",b.PARTY_STATUS_CD,b.AML1_TYPE_CD"
				+ "  from t07_blacklist a,t47_party b left join T10_CHECKPARTY_RE c on c.party_id=b.party_id  "
				+ " where  a.party_id=b.party_id and c.party_id is null and  a.create_dt="
				+ func.vch2dt(statisticdate, "yyyy-mm-dd") + "  and a.isuse='0' and a.ischeck='1'";
		int count = SQLExecute.exeSql(conn, sql);
		return count;
	}
	...
	public int insert_T10_CHECKPARTY_RE2(Connection conn, String statisticdate) throws Exception {
		String sql = "insert into T10_CHECKPARTY_RE(PARTY_ID,RECHECK_TYPE,HOST_CUST_ID,PARTY_CLASS_CD,PARTY_CHN_NAME,CARD_TYPE,"
				...
				+ " where  a.party_id=b.party_id and c.party_id is null and   a.CARD_END_DT="
				+ func.vch2dt(statisticdate, "yyyy-mm-dd");
	...
	public int insert_T10_CHECKPARTY_RE3(Connection conn, String statisticdate) throws Exception {
		String sql = "insert into T10_CHECKPARTY_RE(PARTY_ID,RECHECK_TYPE,HOST_CUST_ID,PARTY_CLASS_CD,PARTY_CHN_NAME,CARD_TYPE,"
				...
				+ " where  a.party_id=b.party_id  and c.party_id is null and  a.LICENCE_END_DT="
				+ func.vch2dt(statisticdate, "yyyy-mm-dd");
	...
	public int insert_T10_CHECKPARTY_RE4(Connection conn, String statisticdate) throws Exception {
		...
		sql = "insert into T10_RISK_PARTY_MID(PARTY_ID) "
				+ " select a.party_id from t08_party_result a where a.emendationlevel<'1022' and a.appradate="
				+ func.vch2dt(statisticdate, "yyyy-mm-dd");
		count = SQLExecute.exeSql(conn, sql);
		...
		sql = " delete from T10_RISK_PARTY_MID a where exists(select 'X' from T10_CHECKPARTY_RE_UH b where b.party_id=a.party_id and b.VALID_DT>"
				+ func.vch2dt(statisticdate, "yyyy-mm-dd") + ")";
		count = SQLExecute.exeSql(conn, sql);
	...
	public int insert_T10_CHECKPARTY_RE5(Connection conn, String statisticdate) throws Exception {
		...
		sql = " delete from T10_REPORT_PARTY_MID a where exists(select 'X' from T10_CHECKPARTY_RE_UH b where b.party_id=a.party_id and b.VALID_DT>"
				+ func.vch2dt(statisticdate, "yyyy-mm-dd") + ")";
		count = SQLExecute.exeSql(conn, sql);
	...
	public int insert_T07_REPORT_STATISTIC_MID(Connection conn, String statisticdate, String granularity)
			throws Exception {
		int count = 0;
		String sql = "";
		String befredate = du.getEndDate(granularity,
				DateUtils.getDateChangeTime2(statisticdate + " 00:00:00", "m", -3));
		...
		if (month.equals("03") || month.equals("06") || month.equals("09") || month.equals("12")) {
			...
			sql = " INSERT INTO T07_REPORT_STATISTIC_MID(STATISTICDATE,ORGANKEY,CURRFLAG,CPT_REPORTNUM,CPT_REPORTAMT,IDT_REPORTNUM,IDT_REPORTAMT,"
					...
					+ "         WHERE T1.REPORTKEY = T2.REPORTKEY  AND T2.REPORTKEY = T3.REPORTKEY   AND T3.CRTP=T4.CURRENCY_CD                                                                                               "
					+ "         AND    T1.MSG_TYPE_CD IN ('N', 'A')  " + "          AND    T1.SENDDATE_DT>"
					+ func.vch2dt(befredate, "yyyy-mm-dd") + "          AND    T1.SENDDATE_DT<="
					+ func.vch2dt(statisticdate, "yyyy-mm-dd") + "         )T   "
	...
	public int del_T07_Table_MID(Connection conn, String statisticdate, String tablename) throws Exception {
		String sql = " DELETE FROM " + tablename + " T WHERE T.STATISTICDATE = "
				+ func.vch2dt(statisticdate, "yyyy-mm-dd");
		int count = SQLExecute.exeSql(conn, sql);
		return count;
	}
	...
	public int del_T07_Table_MID1(Connection conn, String statisticdate, String tablename) throws Exception {
		String sql = " DELETE FROM " + tablename + " T WHERE T.STATISTIC_DT = "
				+ func.vch2dt(statisticdate, "yyyy-mm-dd");
		int count = SQLExecute.exeSql(conn, sql);
		return count;
	}
	...
	public int insert_T07_USER_IDENTITY_D(Connection conn, String statisticdate) throws Exception {
		...
		String sql = " insert into t07_user_identity_mid(statisticdate,organkey,identityflag,cpm_total,cpm_proxy,cpm_thparty,cpm_disembark,cpm_benefit,cpm_questotal,   "
				...
				+ " select " + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ ",organkey,identitytype,cp_total,cp_proxy,cp_thparty,cp_disembark,cp_benefit,            "
		...
		sql = " insert into t07_user_identity_D(statisticdate,organkey,IDENTITYFLAG,cpm_total,cpm_proxy,cpm_thparty,cpm_disembark,cpm_benefit,cpm_questotal,        "
				...
				+ " idm_nonresiproxy,idm_questotal,idm_anonymous,idm_falsecard,idm_failurecard,idm_otherscard,idm_suspects,idm_othercase,ciall_total)                   "
				+ " SELECT " + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ ",B.ORGANKEY,B.IDENTITYFLAG,B.CPM_TOTAL,C.CPM_PROXY,C.cpm_thparty,C.cpm_disembark,C.cpm_benefit,C.cpm_questotal,            "
	...
	public int insert_T07_USER_IDENTITY_M(Connection conn, String statisticdate, String granularity) throws Exception {
		...
		String sql = " insert into t07_user_identity_m(statisticdate,organkey,IDENTITYFLAG,cpm_total,cpm_proxy,cpm_thparty,cpm_disembark,cpm_benefit,cpm_questotal,           "
				...
				+ " idm_nonresiproxy,idm_questotal,idm_anonymous,idm_falsecard,idm_failurecard,idm_otherscard,idm_suspects,idm_othercase,ciall_total)                      "
				+ " SELECT " + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ ",organkey,IDENTITYFLAG,sum(cpm_total),sum(cpm_proxy),sum(cpm_thparty),sum(cpm_disembark),sum(cpm_benefit),sum(cpm_questotal),                                    "
				...
				+ " WHERE C.statisticdate>=" + func.vch2dt(befredate, "yyyy-mm-dd") + " and C.statisticdate<="
				+ func.vch2dt(statisticdate, "yyyy-mm-dd") + " GROUP BY ORGANKEY,IDENTITYFLAG ";
		int count = SQLExecute.exeSql(conn, sql);
		return count;
	}
	...
	public int insert_T10_PARTY_CRETAL_D(Connection conn, String statisticdate) throws Exception {
		...
		String sql = " INSERT INTO T10_PARTY_CRETAL_D(STATISTIC_DT,ORGANKEY,CHECK_TYPE,PARTY_ID,QUERY_COUNT,KY_COUNT)"
				+ " SELECT " + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ ", A.CHECKER_ORG,A.CHECK_TYPE,A.PARTY_ID,                             "
	...
	public int insert_T10_PARTY_CRETAL(Connection conn, String statisticdate, String granularity) throws Exception {
		...
		// String befredate=DateUtils.getDateChangeTime2(statisticdate+"
		// 00:00:00", "m", -1);
		String befredate = du.getBeginDate(granularity, statisticdate);
		System.out.println("befredate:::" + befredate);
		...
		String sql = " INSERT INTO T10_PARTY_CRETAL(STATISTIC_DT,ORGANKEY,QUERYCOUNT_N,PARTYCOUNT_N,ACCTCOUNT_N,KYCOUNT_N,QUERYCOUNT_R,PARTYCOUNT_R,ACCTCOUNT_R,KYCOUNT_R,STATUS_CD)"
				+ " SELECT " + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ ",T1.ORGANKEY,T1.QUERYCOUNT_N,T1.PARTYCOUNT_N,T2.ACCTCOUNT_N,T1.KYCOUNT_N,T1.QUERYCOUNT_R,T1.PARTYCOUNT_R,T2.ACCTCOUNT_R,T1.KYCOUNT_R,'1'"
				...
				+ " FROM T10_PARTY_CRETAL_D A  WHERE  A.STATISTIC_DT>= " + func.vch2dt(befredate, "yyyy-mm-dd")
				+ " and A.STATISTIC_DT<=" + func.vch2dt(statisticdate, "yyyy-mm-dd")
				...
				+ " where c.PARTY_ID=d.PARTY_ID  and   c.STATISTIC_DT>= " + func.vch2dt(befredate, "yyyy-mm-dd")
				+ " and c.STATISTIC_DT<=" + func.vch2dt(statisticdate, "yyyy-mm-dd")
	...
	public int insert_T07_USER_REIDENTITY_D(Connection conn, String statisticdate) throws Exception {
		...
		String befredate = DateUtils.getDateChangeTime2(statisticdate + " 00:00:00", "m", -6);
		System.out.println("befredate:::" + befredate);
		String delsql = " delete from T07_USER_REIDENTITY_D where STATISTICDATE<="
				+ func.vch2dt(befredate, "yyyy-mm-dd");
		int count = SQLExecute.exeSql(conn, delsql);
		...
		String sql = "  INSERT INTO T07_USER_REIDENTITY_MID(STATISTICDATE,ORGANKEY,REIDENTITYFLAG,CHANGEINFO,BEHAVIOR,                                     "
				...
				+ "   SELECT " + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ ", a.CREATE_ORG,CASE WHEN A.PARTY_CLASS_CD='C' THEN '1' ELSE '3' END AS REIDENTITYFLAG,                   "
		...
		sql = "   INSERT INTO T07_USER_REIDENTITY_MID(STATISTICDATE,ORGANKEY,REIDENTITYFLAG,CHANGEINFO,BEHAVIOR,                                  "
				+ "      SUSPECTS,SUSPICIOUS,OTHERCASE,INFO_VERIFIED,BEHA_VERIFIED,SUSPE_VERIFIED,SUSPI_VERIFIED,OTHER_VERIFIED)                      "
				+ "	 SELECT " + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ ", a.CREATE_ORG,CASE WHEN A.AML1_TYPE_CD='01' THEN '4' ELSE '5' END AS REIDENTITYFLAG,                  "
				+ "	  COUNT(DISTINCT (CASE WHEN a.RISK_TYPE='F07' THEN a.PARTY_ID ELSE NULL END)) AS  CHANGEINFO,                                    "
				+ "	  COUNT(DISTINCT (CASE WHEN a.RISK_TYPE='F08' THEN a.PARTY_ID ELSE NULL END)) AS  BEHAVIOR,                                      "
				+ "	  COUNT(DISTINCT (CASE WHEN a.RISK_TYPE='F06' THEN a.PARTY_ID ELSE NULL END)) AS  SUSPECTS,                                      "
				+ "	  COUNT(DISTINCT (CASE WHEN a.RISK_TYPE='F09' THEN a.PARTY_ID ELSE NULL END)) AS  SUSPICIOUS,                                    "
				...
				+ "	                                                                                                                                 "
				+ "	 FROM T10_CHECK_PARTY_REASON a LEFT JOIN T10_PARTY_RISK B   ON (a.PARTY_ID=B.PARTY_ID and a.create_dt=b.create_dt)    "
				+ "	 WHERE a.CHECK_TYPE IN('2','5') AND a.PARTY_CLASS_CD='I' AND a.CREATE_DT="
				+ func.vch2dt(statisticdate, "yyyy-mm-dd")
		...
		sql = "   INSERT INTO T07_USER_REIDENTITY_MID(STATISTICDATE,ORGANKEY,REIDENTITYFLAG,CHANGEINFO,BEHAVIOR,                                  "
				+ "      SUSPECTS,SUSPICIOUS,OTHERCASE,INFO_VERIFIED,BEHA_VERIFIED,SUSPE_VERIFIED,SUSPI_VERIFIED,OTHER_VERIFIED)                      "
				+ "  SELECT " + func.vch2dt(statisticdate, "yyyy-mm-dd")
				+ ",a.CREATE_ORG,'2' AS REIDENTITYFLAG,                                                        "
				+ "  COUNT(DISTINCT (CASE WHEN a.RISK_TYPE='F07' THEN a.PARTY_ID ELSE NULL END)) AS  CHANGEINFO,                          "
				+ "  COUNT(DISTINCT (CASE WHEN a.RISK_TYPE='F08' THEN a.PARTY_ID ELSE NULL END)) AS  BEHAVIOR,                            "
				+ "  COUNT(DISTINCT (CASE WHEN a.RISK_TYPE='F06' THEN a.PARTY_ID ELSE NULL END)) AS  SUSPECTS,                            "
				+ "  COUNT(DISTINCT (CASE WHEN a.RISK_TYPE='F09' THEN a.PARTY_ID ELSE NULL END)) AS  SUSPICIOUS,                          "
		...
		sql = "insert  into T07_USER_REIDENTITY_MID(STATISTICDATE,organkey,REIDENTITYFLAG)select "
				+ func.vch2dt(statisticdate, "yyyy-mm-dd")
		...
		sql = "  UPDATE T07_USER_REIDENTITY_MID D SET FAILURECARD=(SELECT  C.FAILURECARD FROM(                                               "
				...
				+ " FROM T10_CHECKPARTY_RE B                                                                                                     "
				+ " WHERE B.RECHECK_TYPE='2' AND B.PARTY_CLASS_CD='I' AND B.CREATE_DT="
				+ func.vch2dt(statisticdate, "yyyy-mm-dd")
	...
	public int insert_T07_USER_REIDENTITY_M(Connection conn, String statisticdate, String granularity)
			throws Exception {
		...
		if (month.equals("03") || month.equals("06") || month.equals("09") || month.equals("12")) {
			String sql = " INSERT INTO T07_USER_REIDENTITY_M(STATISTICDATE,ORGANKEY,REIDENTITYFLAG,CHANGEINFO,BEHAVIOR,                                  "
					...
					+ " SELECT " + func.vch2dt(statisticdate, "yyyy-mm-dd")
					+ ",ORGANKEY,REIDENTITYFLAG,SUM(CHANGEINFO),SUM(BEHAVIOR),                                  "
					...
					+ " WHERE C.statisticdate> " + func.vch2dt(befredate, "yyyy-mm-dd") + " and C.statisticdate<="
					+ func.vch2dt(statisticdate, "yyyy-mm-dd") + " GROUP BY ORGANKEY,REIDENTITYFLAG ";
			count = SQLExecute.exeSql(conn, sql);

			sql = func.deleteTable("T07_USER_REIDENTITY_MID");
			count = SQLExecute.exeSql(conn, sql);

			sql = "insert into T07_USER_REIDENTITY_MID(STATISTICDATE,ORGANKEY,REIDENTITYFLAG,UPDATECARD)" + "select "
					+ func.vch2dt(statisticdate, "yyyy-mm-dd")
					+ ",B.ORGANKEY,CASE WHEN B.AML1_TYPE_CD='01' THEN '4' ELSE '5' END AS FLAG,                       "
			...
			sql = "insert into T07_USER_REIDENTITY_MID(STATISTICDATE,ORGANKEY,REIDENTITYFLAG,UPDATECARD)" + "select "
					+ func.vch2dt(statisticdate, "yyyy-mm-dd") + ",B.ORGANKEY, '3'  AS FLAG,                       "
					+ "  count(0) AS UPDATENUM FROM t47_individual a,T47_PARTY b WHERE a.PARTY_ID=b.PARTY_ID                 "
					+ "  AND b.PARTY_CLASS_CD='I' AND  a.CARD_END_DT> " + func.vch2dt(befredate, "yyyy-mm-dd")
					+ "  AND a.CARD_END_DT<=" + func.vch2dt(statisticdate, "yyyy-mm-dd") + "  GROUP BY b.organkey";
			...
			sql = "insert into T07_USER_REIDENTITY_MID(STATISTICDATE,ORGANKEY,REIDENTITYFLAG,UPDATECARD)" + "select "
					+ func.vch2dt(statisticdate, "yyyy-mm-dd") + ",B.ORGANKEY, '1'  AS FLAG,                       "
					+ "  count(0) AS UPDATENUM FROM T47_CORPORATION a,T47_PARTY b WHERE a.PARTY_ID=b.PARTY_ID                 "
					+ "  AND b.PARTY_CLASS_CD='C' and b.organkey is not null AND  a.LICENCE_END_DT> "
					+ func.vch2dt(befredate, "yyyy-mm-dd") + "  AND a.LICENCE_END_DT<="
					+ func.vch2dt(statisticdate, "yyyy-mm-dd") + "  GROUP BY b.organkey";
