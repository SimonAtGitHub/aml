...
public class T07_case_Assist implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -2823034026747120937L;
    ...
    private Date req_time_end=null;//请求时间
	...
	public Date getReq_time_end() {
		return req_time_end;
	}
	public void setReq_time_end(Date req_time_end) {
		this.req_time_end = req_time_end;
	}
