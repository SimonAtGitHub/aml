...
public class T07_post_operatorActionForm extends ActionForm {
...
private String case_source = "";
    ...
    /**
 * @return the selectedarea_key
 */
public String[] getSelectedarea_key() {
	return selectedarea_key;
}
/**
 * @param selectedarea_key the selectedarea_key to set
 */
...
public void setRecheck_num(String recheck_num) {
     ...
     * 构造函数           
     */                   
    public T07_post_operatorActionForm() {    
    }                     
