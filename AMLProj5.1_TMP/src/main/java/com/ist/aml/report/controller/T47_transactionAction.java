...
public class T47_transactionAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if ("searchT47_transaction".equalsIgnoreCase(myaction)) {
			myforward = performSearchT47_transaction(mapping, form, request, response);
		}
		// 查询结果lp
		else if ("getT47_transactionList".equalsIgnoreCase(myaction)) {
			myforward = performGetT47_transactionList(mapping, form, request, response);
		}
		// 按客户查询交易
		else if ("getT47_transaction_ucList".equalsIgnoreCase(myaction)) {
			myforward = performGetT47_transactionUCList(mapping, form, request, response);
		} else if ("getT47_transactionList2".equalsIgnoreCase(myaction)) {
			myforward = performGetT47_transactionList2(mapping, form, request, response);
		} else if ("getT47_transactionList_tpla".equalsIgnoreCase(myaction)) {
			myforward = performGetT47_transactionList_tpla(mapping, form, request, response);
			// 案例处理添加交易动作
		} else if ("getT47_transactionList_tpla_addDo".equalsIgnoreCase(myaction)) {
			myforward = performGetT47_transactionList_tpla_addDo(mapping, form, request, response);
		} else
			// 一补交易查询界面
			if ("searchT47_alert_transaction".equalsIgnoreCase(myaction))
				myforward = performSearchT47_alerttransaction(mapping, form, request, response);
		// 一补交易查询结果
			else if ("getT47_alert_transactionList".equalsIgnoreCase(myaction))
				myforward = performGetT47_alerttransactionList(mapping, form, request, response);
		// 一补修改界面
			else if ("modifyT47_transaction".equalsIgnoreCase(myaction)) {
				myforward = performModifyT47_transactioncqc(mapping, form, request, response);
			} // 一补修改动作
			else if ("modifyT47_transactionDo".equalsIgnoreCase(myaction)) {
				myforward = cqcperformModifyT47_transactionDo(mapping, form, request, response);
			} // 二补页面
			else if ("getT47_transaction_SE_List1".equalsIgnoreCase(myaction)) {
				myforward = performGetT47_transaction_SE_List1(mapping, form, request, response);
			} // 二补修改页面
			else if ("modifySeT47_transaction1".equalsIgnoreCase(myaction)) {
				myforward = performModifyT47_SEtransaction(mapping, form, request, response);
			} // 二补修改动作
			else if ("saveSecondTransDo1".equalsIgnoreCase(myaction)) {
				myforward = performModifySecondTransDo(mapping, form, request, response);
			}

		// 交易信息补录日志
			else if ("getT47_transaction_recordlog_List".equals(myaction)) {
				myforward = performGetT47_transaction_recordLog_List(mapping, form, request, response);
			}

		// 新增交易查询
			else if ("getT47_transaction_newList".equalsIgnoreCase(myaction)) {
				myforward = performGetnewT47_transactionList(mapping, form, request, response);
			} // 案例添加交易页面
			else if ("case_new_trans_add".equalsIgnoreCase(myaction)) {
				myforward = performCase_new_trans_add(mapping, form, request, response);
			}
		// 案例添加交易保存
			else if ("case_new_trans_add_do".equalsIgnoreCase(myaction)) {
				myforward = performCase_new_trans_add_do(mapping, form, request, response);
			}
		// 新增交易删除
			else if ("case_new_trans_delete_do".equalsIgnoreCase(myaction)) {
				myforward = performCase_new_trans_delete_do(mapping, form, request, response);
			}
		// 交易查询中导出Excel lp
			else if ("getT47_transactionExcelList".equalsIgnoreCase(myaction)) {
				myforward = performGetT47_transactionExcelList2(mapping, form, request, response);
			}
		// 查询详细信息lp
			else if ("getT47_transactionDisp".equalsIgnoreCase(myaction)) {
				myforward = performGetT47_transactionDisp(mapping, form, request, response);
			}
		// 新增交易修改界面
			else if ("modifyT47_transaction_new".equalsIgnoreCase(myaction)) {
				myforward = performModifyT47_transaction_new(mapping, form, request, response);
			} else if ("modifyT47_transaction_new_do".equalsIgnoreCase(myaction)) {
				myforward = performModifyT47_transaction_newDo(mapping, form, request, response);
			}
		return myforward;
		...
		try {
			...
			if ("0".equals(newsearchflag)) {
				...
				if (form.getCreate_user() != null) {
					t47_trans_recordLog.setCreate_usr(form.getCreate_user());
				}
				// 获取客户号
				if (form.getParty_id() != null) {
					t47_trans_recordLog.setParty_id(form.getParty_id());
				}

			} else {
				t47_trans_recordLog = (T47_trans_recordLog) session.getAttribute("T47_transsearch");
			...
			t47_trans_recordLogList = t47_transactionDAO.getT47_trans_recordLogList(sqlMap, t47_trans_recordLog,
			                          this.getStartRec(intPage), this.getIntPageSize());
			totalRow = t47_transactionDAO.getT47_trans_recordLog_ListCount(sqlMap, t47_trans_recordLog);
	...
	public ActionForward performSearchT47_transaction(ActionMapping actionMapping, ActionForm actionForm,
	        HttpServletRequest request, HttpServletResponse response) {
		// ActionErrors errors = new ActionErrors();
		String pageInfo = "";
		...
		try {
			...
			*/
			...
			request.setAttribute("tradesortMap", this.getOptionsListByMap(tradesortMap, null, true));
			LinkedHashMap cal_indMap = cm.getMapFromCache("yesNo");
			request.setAttribute("cal_indMap", this.getOptionsListByMap(cal_indMap, null, true));
			// 借贷标志
			...
			String debit_credit_disp_str = cm.getMapFromCacheToStr("trackflag", "debit_credit_disp",
			                               form.getDebit_credit_disp(), "", true);
			request.setAttribute("debit_credit_disp_str", debit_credit_disp_str);
			/*
			* ljd 注释//现转标记 String
			* cash_trans_flag_str=cm.getMapFromCacheToStr("goflag",
			                      * "cash_trans_flag_disp", form.getCash_trans_flag_disp(),"", true);
			* request.setAttribute("cash_trans_flag_str", cash_trans_flag_str);
			*
			*
			* // 客户类型 // LinkedHashMap clienttypeMap =
			* cm.getMapFromCache("clienttype"); //
			* request.setAttribute("clienttypeMap", this.getOptionsListByMap(
			                           * // clienttypeMap, null, true)); String
			                           * party_class_cd_str=cm.getMapFromCacheToStr("clienttype",
			                                   * "party_class_cd", form.getParty_class_cd(),"", true);
			                           * request.setAttribute("party_class_cd_str", party_class_cd_str);
			                           */

			                           /**
			                            * ljd add start 2017-06-10
			                            */
			                           // 现转标记
			...
			cash_trans_flag_str = cm.getMapFromCacheToStr("goflag", "cash_trans_flag_disp",
			                      form.getCash_trans_flag_disp(), "", true);
		}
				request.setAttribute("cash_trans_flag_str", cash_trans_flag_str);
				...
				// cm.getMapFromCacheToStr("clienttype", "party_class_cd",
				// form.getParty_class_cd(),"", true);
				if ("CPDE-DE02".equals(stcr)) {
					...
					party_class_cd_str = cm.getMapFromCacheToStr("clienttype", "party_class_cd",
					                     form.getParty_class_cd(), "", true);
				}
					request.setAttribute("party_class_cd_str", party_class_cd_str);
					
					// 是否跨境
					String overarea_ind_str = cm.getMapFromCacheToStr("yesNo", "overarea_ind", form.getOverarea_ind(), "",
					                          true);
					request.setAttribute("overarea_ind_str", overarea_ind_str);
					/**
					 * ljd add end 2017-06-10
					 */
					// 对手客户类型
					String opp_party_class_cd_str = cm.getMapFromCacheToStr("clienttype", "opp_party_class_cd",
					                                form.getOpp_party_class_cd(), "", true);
					...
					String tendaybefor = dateUtils.getDateChangeTime(today, "d", -183);
					...
					return actionMapping.findForward("failure");
						 ...
						 * @return ActionForward
						 */
					public ActionForward performGetT47_transactionList(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						...
						try {
							...
							form.setTx_dtEnd(DateUtils.stringToDateShort(form.getTx_enddt_disp()));
							...
							if (newsearchflag.equals("1")) {// 新的查询
								...
								// }
								intPage = 0;
								session.setAttribute("t47_transactionSearchObj", t47_transaction);
							} else {// 翻页
								t47_transaction = (T47_transaction) session.getAttribute("t47_transactionSearchObj");
							}
							...
							t47_transactionList = t47_transactionDAO.getT47_trade_transactionList1(sqlMap, t47_transaction,
							                      this.getStartRec(intPage), this.getIntPageSize());
							int totalRow = t47_transactionDAO.getT47_trade_transactionListCount1(sqlMap, t47_transaction);
							...
							String debit_credit_disp_str = cm.getMapFromCacheToStr("trackflag", "debit_credit_disp",
							                               form.getDebit_credit_disp(), "", true);
							request.setAttribute("debit_credit_disp_str", debit_credit_disp_str);
							String cash_trans_flag_str = cm.getMapFromCacheToStr("goflag", "cash_trans_flag_disp",
							                             form.getCash_trans_flag_disp(), "", true);
							request.setAttribute("cash_trans_flag_str", cash_trans_flag_str);
							String party_class_cd_str = cm.getMapFromCacheToStr("clienttype", "party_class_cd",
							                            form.getParty_class_cd(), "", true);
							request.setAttribute("party_class_cd_str", party_class_cd_str);
							// 对手客户类型
							String opp_party_class_cd_str = cm.getMapFromCacheToStr("clienttype", "opp_party_class_cd",
							...
							e.printStackTrace();
							logger.error(e);
							errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("error.pagertitle.default", e.getMessage()));
					...
					public ActionForward performGetT47_transactionUCList(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						ArrayList t47_transactionList;
						...
						try {
							...
							if (newsearchflag.equals("1")) {// 新的查询
								...
								session.setAttribute("t47_transaction_ucSearchObj", t47_transaction);
							} else {// 翻页
								t47_transaction = (T47_transaction) session.getAttribute("t47_transaction_ucSearchObj");
							}

							if (t47_transaction == null)
								t47_transaction = new T47_transaction();

							t47_transactionList = t47_transactionDAO.getT47_transactionUCList(sqlMap, t47_transaction,
							                      this.getStartRec(intPage), this.getIntPageSize());
							int totalRow = t47_transactionDAO.getT47_transactionUCCount(sqlMap, t47_transaction);
							String url = request.getContextPath() + "/inves" + actionMapping.getPath() + ".do";
					...
					public ActionForward performGetT47_transactionList2(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						ArrayList t47_transactionList;
						...
						try {
							 ...
							 */
							if (form.getStcr().equals("CPDE-DE01") || form.getStcr().equals("CPDE-DE02")
							|| form.getStcr().equals("CPDE-DE03") || form.getStcr().equals("CPDE-DE04")) {
								// 现转标记
							...
							// 现转标记
							// LinkedHashMap goflagMap = cm.getMapFromCache("goflag");
							// request.setAttribute("goflagMap",
							// this.getOptionsListByMap(goflagMap,
							// null, true));
							String cash_trans_flag_str = cm.getMapFromCacheToStr("goflag", "cash_trans_flag_disp",
							                             form.getCash_trans_flag_disp(), "", true);
							request.setAttribute("cash_trans_flag_str", cash_trans_flag_str);
					...
					public ActionForward performGetT47_transactionList_tpla(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						...
						try {
							...
							if (newsearchflag.equals("1")) {// 新的查询
								...
								session.setAttribute("t47_transactionSearchObjByParty_id", t47_transaction);
							} else {// 翻页
								t47_transaction = (T47_transaction) session.getAttribute("t47_transactionSearchObjByParty_id");
							}
							if (!"0".equals(newsearchflag)) {
								t47_transactionList = t47_transactionDAO.getT47_trade_transactionList_tpla(sqlMap, t47_transaction,
								                      this.getStartRec(intPage), this.getIntPageSize());
								int totalRow = t47_transactionDAO.getT47_trade_transactionListCount_tpla(sqlMap, t47_transaction);
								String url = request.getContextPath() + "/report" + actionMapping.getPath() + ".do";
					...
					public ActionForward performGetT47_transactionList_tpla_addDo(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						ArrayList t47_transactionList = new ArrayList();
						...
						try {
							...
							if (transList.size() > 0) {
								...
								ArrayList trans_acct_numList = t47_transactionDAO.getT47_transactionList_acct_num_tpla(sqlMap,
								                               t47_transaction);
					 ...
					 * @return ActionForward
					 */
					public ActionForward performSearchT47_alerttransaction(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						// ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						ActionErrors errors = new ActionErrors();
						...
						try {
							...
							// 排序
							LinkedHashMap tradesortMap = cm.getMapFromCache("tradesort");
							request.setAttribute("tradesortMap", this.getOptionsListByMap(tradesortMap, null, false));

							// LinkedHashMap statusMap = cm.getMapFromCache("yesNo");
							// request.setAttribute("statusMap",
							// this.getOptionsListByMap(statusMap,
							// null, false));
							...
							// request.setAttribute("curr_cdMap",
							// this.getOptionsListByMap(curr_cdMap,
							// null, true));

							// 验证状态
							// String status_str=cm.getMapFromCacheToStr("status1",
							// "validate_ind", form.getValidate_ind(),"", true);
							// request.setAttribute("status_str", status_str);
							// 是否已补录
							if (form.getAddtional_search().equals("")) {
								form.setAddtional_search("0");
							}
							String yesNo_str = cm.getMapFromCacheToStr("yesNo", "addtional_search", form.getAddtional_search(), "",
							                   false);
							...
							// 现转标记1
							String goflag_str = cm.getMapFromCacheToStr("goflag", "cash_trans_flag_search_disp",
							                    form.getCash_trans_flag_search_disp(), "", true);
							request.setAttribute("goflag_str", goflag_str);

							// 本外币1
							String curr_cd_str = cm.getMapFromCacheToStr("curr_cd", "curr_cd_search", form.getCurr_cd_search(), "",
							                     true);
							request.setAttribute("curr_cd_str", curr_cd_str);

							// 借贷标志1
							String trackflag_str = cm.getMapFromCacheToStr("trackflag", "debit_credit_search_disp",
							                       form.getDebit_credit_search_disp(), "", true);
							request.setAttribute("trackflag_str", trackflag_str);

							// 客户类型1
							String clienttype_str = cm.getMapFromCacheToStr("clienttype", "party_class_cd_search",
							                        form.getParty_class_cd_search(), "", true);
							...
							String today = DateUtils.getCurrTime();
							DateUtils dateUtils = new DateUtils();
							String tendaybefor = dateUtils.getDateChangeTime(today, "d", -Constans.BEFOREDAY);
							tendaybefor = tendaybefor.substring(0, 10);
							today = today.substring(0, 10);
					...
					public ActionForward performGetT47_alerttransactionList(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						...
						try {
							...
							if (form.getTx_dt_search_disp() != null)
								form.setTx_dt(DateUtils.stringToDateShort(form.getTx_dt_search_disp()));
							if (form.getTx_enddt_search_disp() != null)
								form.setTx_dtEnd(DateUtils.stringToDateShort(form.getTx_enddt_search_disp()));
							if (form.getTx_today_disp() != null)
								form.setTx_today(DateUtils.stringToDateShort(form.getTx_today_disp()));
							form.setDebit_credit(form.getDebit_credit_search_disp());
							form.setCash_trans_flag(form.getCash_trans_flag_search_disp());

							if (form.getAmt_start_search().trim() != null && !"".equals(form.getAmt_start_search().trim())) {
								form.setAmt(new Double(Double.parseDouble(form.getAmt_start_search())));
								form.setAmt_start(Double.valueOf(form.getAmt_start_search().trim()));

							} else {
								form.setAmt_start(null);
							}
							if (form.getAmt_end_search().trim() != null && !"".equals(form.getAmt_end_search().trim())) {
								form.setAmt_max_value(new Double(Double.parseDouble(form.getAmt_end_search().trim())));
							...
							if (newsearchflag.equals("1")) {// 新的查询
								...
								if (!form.getParty_class_cd_search().equals("")) {
									t47_transaction.setParty_class_cd(form.getParty_class_cd_search());
								}
								if (!form.getAddtional_search().equals("")) {
									t47_transaction.setAddtional(form.getAddtional_search());
								}
							...
							t47_transactionList = t47_transactionDAO.getT47_trade_transactionList_1b(sqlMap, t47_transaction,
							                      this.getStartRec(intPage), this.getIntPageSize());

							String strSessionkey = "";
							for (int k = 0; k < t47_transactionList.size(); k++) {
								T47_transaction t47_transactioninfo = (T47_transaction) t47_transactionList.get(k);
								// logger.info("-------["+k+"]--------"+t47_transactioninfo.getTransactionkey());
								if (k == t47_transactionList.size() - 1) {
									strSessionkey += "" + t47_transactioninfo.getTransactionkey() + "";
								} else {
									strSessionkey += "" + t47_transactioninfo.getTransactionkey() + "@";
								}
							...
							int totalRow = t47_transactionDAO.getT47_trade_transactionListCount_1b(sqlMap, t47_transaction);
							// int totalRow=0;
							String url = request.getContextPath() + "/report" + actionMapping.getPath() + ".do?newsearchflag=2";

							pageInfo = this.getPageInfoStr(totalRow, intPage, url, "");
							MyBeanUtils.copyBean2Bean(form, t47_transaction);
							if (t47_transaction.getTx_dt() != null)
								form.setTx_dt_start_disp(DateUtils.dateToStringShort(t47_transaction.getTx_dt()));
							if (t47_transaction.getTx_dtEnd() != null)
								form.setTx_enddt_search_disp(DateUtils.dateToStringShort(t47_transaction.getTx_dtEnd()));
							// 是否已补录
							String yesNo_str = cm.getMapFromCacheToStr("yesNo", "addtional_search", form.getAddtional_search(), "",
							                   false);
							request.setAttribute("yesNo_str", yesNo_str);
					...
					public ActionForward performModifyT47_transactioncqc(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						...
						try {
							...
							String url = StringUtils.null2String(request.getParameter("url")) + "&" + "intPage="
							             + request.getSession().getAttribute("intPage");
							// String intPage = StringUtils.null2String(request
							// .getParameter("intPage"));
							// String intPage =
							// (String)request.getSession().getAttribute("intPage");
							LinkedHashMap opp_organ_typeMap = cm.getMapFromCache("cfct_hash"); // 对手行行号类型

							request.setAttribute("opp_organ_typeMap", this.getOptionsListByMap(opp_organ_typeMap, null, true));
							...
							request.setAttribute("currencyMap", this.getOptionsListByMap(currencyMap, null, false));
							...
							request.setAttribute("receive_payMap", this.getOptionsListByMap(receive_payMap, null, false));
							LinkedHashMap debit_creditMap = cm.getMapFromCache("trackflag"); // 借贷类型
							request.setAttribute("debit_creditMap", this.getOptionsListByMap(debit_creditMap, null, false));
							// 获取交易发生地国别
							LinkedHashMap nationalityMap = cm.getMapFromCache("country");
							request.setAttribute("countryMap", this.getOptionsListByMap(nationalityMap, null, true));

							LinkedHashMap area1Map = cm.getMapFromCache("area1"); // 省信息
							request.setAttribute("area1Map", this.getOptionsListByMap(area1Map, null, true));
							LinkedHashMap pbc_catpMap = cm.getMapFromCache("pbc_catp"); // 帐户类型
							request.setAttribute("pbc_catpMap", this.getOptionsListByMap(pbc_catpMap, null, true));
							LinkedHashMap pbc_cttpMap = cm.getMapFromCache("pbc_cttp"); // 客户类型
							request.setAttribute("pbc_cttpMap", this.getOptionsListByMap(pbc_cttpMap, null, true));
							LinkedHashMap t87_pbc_cashMap = cm.getMapFromCache("t87_pbc_cash"); // 现钞标志
							request.setAttribute("t87_pbc_cashMap", this.getOptionsListByMap(t87_pbc_cashMap, null, false));

							LinkedHashMap BITPMap = cm.getMapFromCache("BITP"); // 代办人证件类型
							request.setAttribute("BITPMap", this.getOptionsListByMap(BITPMap, null, true));
							LinkedHashMap PBC_SWSZ1Map = cm.getMapFromCache("PBC_SWSZ1"); // 境内外汇收支交易
							request.setAttribute("PBC_SWSZ1Map", this.getOptionsListByMap(PBC_SWSZ1Map, null, true));
							...
							request.setAttribute("overareaMap", this.getOptionsListByMap(overareaMap, null, false));
							request.setAttribute("oppoffMap", this.getOptionsListByMap(overareaMap, null, false));// 是否离岸账户
							LinkedHashMap tx_typeMap = cm.getMapFromCache("tradetype"); // 交易类型
							request.setAttribute("tx_typeMap", this.getOptionsListByMap(tx_typeMap, null, false));
							LinkedHashMap tx_cdMap = cm.getMapFromCache("aml_tx_cd"); // 交易代码
							request.setAttribute("tx_cdMap", this.getOptionsListByMap(tx_cdMap, null, false));
							LinkedHashMap tsctMap = cm.getMapFromCache("tsct_hash1");
							request.setAttribute("tsctMap", this.getOptionsListByMap(tsctMap, null, true));

							String transactionkey = StringUtils.null2String(request.getParameter("transactionkey"));
							String trans_key = StringUtils.null2String(request.getParameter("trans_key"));

							String tag = "0";
							ArrayList transkeyMap = new ArrayList();
							if (session.getAttribute("transListKey") != null) {
								String strTransListkey = (String) session.getAttribute("transListKey");
							...
							String flag = StringUtils.null2String((String) request.getParameter("flag"));
							if (!trans_key.equals("") && flag.equals("1")) {
								t47_transaction.setTransactionkey(trans_key);
							}
							request.setAttribute("transkeyMap", this.getOptionsByList(transkeyMap, transkeyMap, false));
							String tableName = StringUtils.null2String(request.getParameter("tableName")); // 针对t47_transaction_ub,t47_transaction_uc
							t47_transaction = t47_transactionDAO.getT47_transactionFillDisp11(sqlMap,
							                  t47_transaction.getTransactionkey(), tableName);
							if (t47_transaction.getAgent_card_type() != null && !t47_transaction.getAgent_card_type().trim().equals("")
							&& t47_transaction.getAgent_card_type().length() > 2) {
								String type08 = t47_transaction.getAgent_card_type().substring(0, 2);
								String info08 = t47_transaction.getAgent_card_type().substring(2);
								t47_transaction.setAgent_card_type(type08);
								t47_transaction.setCard_inf(info08);
							}
							if (t47_transaction.getOpp_card_type() != null && !t47_transaction.getOpp_card_type().trim().equals("")
							&& t47_transaction.getOpp_card_type().length() > 2) {
								String opp_type08 = t47_transaction.getOpp_card_type().substring(0, 2);
								String opp_info08 = t47_transaction.getOpp_card_type().substring(2);
								t47_transaction.setOpp_card_type(opp_type08);
								t47_transaction.setOpp_card_inf(opp_info08);
							}
							// 将查询出来的值拼成字符串用#分开
							String saveString = "|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOrg_trans_rela())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getAgent_name())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getAgent_country())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getAgent_card_type())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getAgent_card_no())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getParty_chn_name())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getHost_cust_id())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getAcct_num())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getSettle_type_cd())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_off_shore_ind())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getTx_type_cd())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getTx_cd())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getCash_ind())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getTx_go_country())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getTx_go_area())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getTx_occur_country())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getTx_occur_area())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getUse_des())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getTsctkey())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_acct_type_cd())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_acct_num())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_card_type())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_name())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_card_no())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_organname())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_organ_type())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_organkey())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_country())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_area())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_pbc_party_class_cd()))
							                    + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_party_class_cd()))
							                    + "@|" + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getCal_ind())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_sys_id())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getOpp_party_id())) + "@|"
							                    + java.net.URLEncoder.encode(StringUtils.null2String(t47_transaction.getCurrency_cd()));
							...
							if (t47_transaction.getOrgankey() != null) {
								...
								String comstr = org_area.substring(org_area.length() - 2, org_area.length());
								String comstr1 = org_area.substring(org_area.length() - 4, org_area.length());
								if (comstr.equals("00")) {
									if (comstr1.equals("0000")) {
										t47_transaction.setOrg_area((String) pbcareaMap.get(org_area));
									} else {
										t47_transaction.setOrg_area(
										    (String) pbcareaMap.get(updaid2) + "-" + (String) pbcareaMap.get(org_area));
									}
								}
								if (!comstr.equals("00")) {
									String updaid1 = "";
									if (updaid2 != null) {
										...
										t47_transaction.setOrg_area(StringUtils.nullObject2String(pbcareaMap.get(updaid1)) + "-"
										                            + (String) pbcareaMap.get(updaid2) + "-" + (String) pbcareaMap.get(org_area));
									}
							...
							if (t47_transaction.getCurr_cd() != null && !"".equals(t47_transaction.getCurr_cd())
							&& !t47_transaction.getCurr_cd().equals("1") && t47_transaction.getCash_ind().equals("00")) {
								t87_pbc_gjfsMap = cm.getMapFromCache("t87_pbc_gjfs2");
							} else if (t47_transaction.getCurr_cd() != null && !"".equals(t47_transaction.getCurr_cd())
							&& !t47_transaction.getCurr_cd().equals("1") && t47_transaction.getCash_ind().equals("01")) {
							...
							request.setAttribute("t87_pbc_gjfsMap", this.getOptionsListByMap(t87_pbc_gjfsMap, null, true));
							...
							for (int i = 0; i < tranList.size(); i++) {
								...
								if (trans.getTrans_field().equals("party_chn_name")) {
									t47_transaction.setParty_chn_name_flag(trans.getModify_ind());
									t47_transaction.setParty_chn_name_value(trans.getDefault_val());
								}
								// =========Acct_num 我行账号
								...
								if (trans.getTrans_field().equals("org_trans_rela")) {
									t47_transaction.setOrg_trans_rela_flag(trans.getModify_ind());

								}
								// =========Party_class_cd 我行客户类型
								if (trans.getTrans_field().equals("party_class_cd")) {
									t47_transaction.setParty_class_cd_flag(trans.getModify_ind());
									t47_transaction.setParty_class_cd_value(trans.getDefault_val());
								}
								...
								if (trans.getTrans_field().equals("receive_pay_cd")) {
									t47_transaction.setReceive_pay_cd_flag(trans.getModify_ind());

								}
								// =========Currency_cd 货币符号
								if (trans.getTrans_field().equals("currency_cd")) {
									t47_transaction.setCurrency_cd_flag(trans.getModify_ind());
									t47_transaction.setCurrency_cd_value(trans.getDefault_val());
								}

								// =========Opp_organkey 对方行行号
								if (trans.getTrans_field().equals("opp_organkey")) {
									t47_transaction.setOpp_organkey_flag(trans.getModify_ind());
									t47_transaction.setOpp_organkey_value(trans.getDefault_val());
								}
								// =========Opp_organ_type 对方行行号类型
								if (trans.getTrans_field().equals("opp_organ_type")) {
									t47_transaction.setOpp_organ_type_flag(trans.getModify_ind());
									t47_transaction.setOpp_organ_type_value(trans.getDefault_val());
								}
								// =========Opp_name 对方人名称
								...
								if (trans.getTrans_field().equals("opp_acct_num")) {
									...
									t47_transaction.setOpp_acct_num_value(trans.getDefault_val());
								}
								// opp_acct_type_cd_flag 对手帐户类型
								if (trans.getTrans_field().equals("opp_acct_type_cd")) {
									t47_transaction.setOpp_acct_type_cd_flag(trans.getModify_ind());
								...
								if (trans.getTrans_field().equals("opp_pbc_party_class_cd")) {
									t47_transaction.setOpp_pbc_party_class_cd_flag(trans.getModify_ind());

								}
								// =========Opp_Card_type 对手客户证件类型
								if (trans.getTrans_field().equals("opp_card_type")) {
									t47_transaction.setOpp_Card_type_flag(trans.getModify_ind());
									t47_transaction.setOpp_Card_type_value(trans.getDefault_val());
								}
								// =========Opp_Card_no 对手客户证件号码
								if (trans.getTrans_field().equals("opp_card_no")) {
									t47_transaction.setOpp_Card_no_flag(trans.getModify_ind());
									t47_transaction.setOpp_Card_no_value(trans.getDefault_val());
								}
								// =========Opp_tx_dt 对手交易日期
								/*
								...
								if (trans.getTrans_field().equals("agent_card_type")) {
									t47_transaction.setAgent_card_type_flag(trans.getModify_ind());

								}
								// =========agent_card_no //代办人身份证件/证明文件号码
								if (trans.getTrans_field().equals("agent_card_no")) {
									t47_transaction.setAgent_card_no_flag(trans.getModify_ind());

								}
								// =========agent_country //代办人国籍
								if (trans.getTrans_field().equals("agent_country")) {
									t47_transaction.setAgent_country_flag(trans.getModify_ind());

								}

								// ===============settle_type_cd 结算方式
								if (trans.getTrans_field().equals("settle_type_cd")) {
									t47_transaction.setSettle_type_cd_flag(trans.getModify_ind());
								...
								if (trans.getTrans_field().equals("opp_off_shore_ind")) {
									t47_transaction.setOpp_off_shore_ind_flag(trans.getModify_ind());
							...
							if (t47_transaction.getTx_occur_area() == null || t47_transaction.getTx_occur_area().equals("")) {
							...
							// }
							request.setAttribute("occur_area", t47_transaction.getTx_occur_area());
							MyBeanUtils.copyBean2Bean(form, t47_transaction);
					...
					public ActionForward cqcperformModifyT47_transactionDo(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						...
						try {
							...
							MyBeanUtils.copyBean2Bean(t47_transaction, form);
							t47_transaction.setTx_dt(DateUtils.stringToDateShort(form.getTx_dt_disp()));
							...
							if (t47_transaction.getAgent_card_type().equals("19") || t47_transaction.getAgent_card_type().equals("29"))
								t47_transaction
								.setAgent_card_type(t47_transaction.getAgent_card_type() + t47_transaction.getCard_inf());
							if (t47_transaction.getOpp_card_type().equals("19") || t47_transaction.getOpp_card_type().equals("29"))
								t47_transaction
								.setOpp_card_type(t47_transaction.getOpp_card_type() + t47_transaction.getOpp_card_inf());
							if (!t47_transaction.getOpp_coutry().equals("")) {
								if (!t47_transaction.getOpp_coutry().equals(Constans.CHINA)
								        && !t47_transaction.getOpp_coutry().equals(Constans.CHINA_Bonded)
								        && !t47_transaction.getOpp_coutry().equals(Constans.CHINA_Processing)
								&& !t47_transaction.getOpp_coutry().equals(Constans.CHINA_Diamond)) {
							...
							if (t47_transaction.getTx_go_country() != null && !"".equals(t47_transaction.getTx_go_country().trim())) {
								if (!t47_transaction.getTx_go_country().equals(Constans.CHINA)
								        && !t47_transaction.getTx_go_country().equals(Constans.CHINA_Bonded)
								        && !t47_transaction.getTx_go_country().equals(Constans.CHINA_Processing)
								&& !t47_transaction.getTx_go_country().equals(Constans.CHINA_Diamond)) {
									...
									if (t47_transaction.getTx_go_area().equals("")) {
										if (!t47_transaction.getTx_go_area2().equals("")) {
											t47_transaction.setTx_go_area(t47_transaction.getTx_go_area2());
										} else {
											if (!t47_transaction.getTx_go_area1().equals("")) {
												t47_transaction.setTx_go_area(t47_transaction.getTx_go_area1());
											}
										}
							...
							if (!t47_transaction.getTx_occur_country().equals("")) {
								if (!t47_transaction.getTx_occur_country().equals(Constans.CHINA)
								        && !t47_transaction.getTx_occur_country().equals(Constans.CHINA_Bonded)
								        && !t47_transaction.getTx_occur_country().equals(Constans.CHINA_Processing)
								&& !t47_transaction.getTx_occur_country().equals(Constans.CHINA_Diamond)) {
									...
									if (t47_transaction.getTx_occur_area().equals("")) {
										if (!t47_transaction.getTx_occur_area2().equals("")) {
											t47_transaction.setTx_occur_area(t47_transaction.getTx_occur_area2());
										} else {
											if (!t47_transaction.getTx_occur_area1().equals("")) {
												t47_transaction.setTx_occur_area(t47_transaction.getTx_occur_area1());
											}
										}
							...
							for (int i = 0; i < tranList.size(); i++) {
								...
								if (trans.getTrans_field().equals("opp_organname")) {
									t47_transaction.setOpp_organname_flag(trans.getModify_ind());
							...
							String saveString = StringUtils.null2String((String) request.getParameter("saveString"));
							...
							String opp_pbc_party_class_cd = t47_transaction.getOpp_pbc_party_class_cd();
							if (opp_pbc_party_class_cd != null && !opp_pbc_party_class_cd.equals("")) {
								if (opp_pbc_party_class_cd.equals(Constans.PARTY_CLASS_CD_I)) {
									t47_transaction.setOpp_party_class_cd(Constans.PARTY_CLASS_CDI);
								} else {
									t47_transaction.setOpp_party_class_cd(Constans.PARTY_CLASS_CDC);
								}
							}
							...
							if (!opp_acct_num.equals("")) {
								...
								.equals(java.net.URLDecoder.decode(saveStrings[20].substring(1)))) {
									if (opp_pbc_party_class_cd != null && !opp_pbc_party_class_cd.equals("")) {
										if (opp_pbc_party_class_cd.equals(Constans.PARTY_CLASS_CD_I)) {

											T47_id_deposit t47_id_deposit = t47_id_deposiDao.getT47_id_depositDisp(sqlMap,
											                                opp_acct_num);
											if (t47_id_deposit == null || t47_id_deposit.getParty_id().equals("")) {
												opp_party_id = com.ist.util.Constans.OPFLAG + opacctnum + opname;
											...
											T47_cp_deposit t47_cp_deposit = t47_cp_depositDao.getT47_cp_depositDisp(sqlMap,
											                                opp_acct_num);
											if (t47_cp_deposit == null || t47_cp_deposit.getParty_id().equals("")) {
												opp_party_id = com.ist.util.Constans.OPFLAG + opacctnum + opname;
							...
							if (saveStrings.length > 0) {
								if (StringUtils.null2String(t47_transaction.getOrg_trans_rela())
								.equals(java.net.URLDecoder.decode(saveStrings[0].substring(1)))) {
									t47_transaction.setOrg_trans_rela("#");
								}
								if (StringUtils.null2String(t47_transaction.getAgent_name())
								.equals(java.net.URLDecoder.decode(saveStrings[1].substring(1)))) {
									t47_transaction.setAgent_name("#");
								}
								if (StringUtils.null2String(t47_transaction.getAgent_country())
								.equals(java.net.URLDecoder.decode(saveStrings[2].substring(1)))) {
									t47_transaction.setAgent_country("#");
								}
								if (StringUtils.null2String(t47_transaction.getAgent_card_type())
								.equals(java.net.URLDecoder.decode(saveStrings[3].substring(1)))) {
									t47_transaction.setAgent_card_type("#");
								}
								if (StringUtils.null2String(t47_transaction.getAgent_card_no())
								.equals(java.net.URLDecoder.decode(saveStrings[4].substring(1)))) {
									t47_transaction.setAgent_card_no("#");
								}
								if (StringUtils.null2String(t47_transaction.getParty_chn_name())
								.equals(java.net.URLDecoder.decode(saveStrings[5].substring(1)))) {
									t47_transaction.setParty_chn_name("#");
								}
								if (StringUtils.null2String(t47_transaction.getHost_cust_id())
								.equals(java.net.URLDecoder.decode(saveStrings[6].substring(1)))) {
									t47_transaction.setHost_cust_id("#");
								}
								if (StringUtils.null2String(t47_transaction.getAcct_num())
								.equals(java.net.URLDecoder.decode(saveStrings[7].substring(1)))) {
									t47_transaction.setAcct_num("#");
								}
								if (StringUtils.null2String(t47_transaction.getSettle_type_cd())
								.equals(java.net.URLDecoder.decode(saveStrings[8].substring(1)))) {
									t47_transaction.setSettle_type_cd("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_off_shore_ind())
								.equals(java.net.URLDecoder.decode(saveStrings[9].substring(1)))) {
									t47_transaction.setOpp_off_shore_ind("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_type_cd())
								.equals(java.net.URLDecoder.decode(saveStrings[10].substring(1)))) {
									t47_transaction.setTx_type_cd("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_cd())
								.equals(java.net.URLDecoder.decode(saveStrings[11].substring(1)))) {
									t47_transaction.setTx_cd("#");
								}
								if (StringUtils.null2String(t47_transaction.getCash_ind())
								.equals(java.net.URLDecoder.decode(saveStrings[12].substring(1)))) {
									t47_transaction.setCash_ind("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_go_country())
								.equals(java.net.URLDecoder.decode(saveStrings[13].substring(1)))) {
									t47_transaction.setTx_go_country("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_go_area())
								.equals(java.net.URLDecoder.decode(saveStrings[14].substring(1)))) {
									t47_transaction.setTx_go_area("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_occur_country())
								.equals(java.net.URLDecoder.decode(saveStrings[15].substring(1)))) {
									t47_transaction.setTx_occur_country("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_occur_area())
								.equals(java.net.URLDecoder.decode(saveStrings[16].substring(1)))) {
									t47_transaction.setTx_occur_area("#");
								}
								if (StringUtils.null2String(t47_transaction.getUse_des())
								.equals(java.net.URLDecoder.decode(saveStrings[17].substring(1)))) {
									t47_transaction.setUse_des("#");
								}
								if (StringUtils.null2String(t47_transaction.getTsctkey())
								.equals(java.net.URLDecoder.decode(saveStrings[18].substring(1)))) {
									t47_transaction.setTsctkey("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_acct_type_cd())
								.equals(java.net.URLDecoder.decode(saveStrings[19].substring(1)))) {
								...
								.equals(java.net.URLDecoder.decode(saveStrings[21].substring(1)))) {
									t47_transaction.setOpp_card_type("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_name())
								.equals(java.net.URLDecoder.decode(saveStrings[22].substring(1)))) {
									t47_transaction.setOpp_name("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_card_no())
								.equals(java.net.URLDecoder.decode(saveStrings[23].substring(1)))) {
									t47_transaction.setOpp_card_no("#");
								}

								if (StringUtils.null2String(t47_transaction.getOpp_organname())
								.equals(java.net.URLDecoder.decode(saveStrings[24].substring(1)))) {
									t47_transaction.setOpp_organname("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_organ_type())
								.equals(java.net.URLDecoder.decode(saveStrings[25].substring(1)))) {
									t47_transaction.setOpp_organ_type("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_organkey())
								.equals(java.net.URLDecoder.decode(saveStrings[26].substring(1)))) {
									t47_transaction.setOpp_organkey("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_coutry())
								.equals(java.net.URLDecoder.decode(saveStrings[27].substring(1)))) {
									t47_transaction.setOpp_coutry("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_area())
								.equals(java.net.URLDecoder.decode(saveStrings[28].substring(1)))) {
									t47_transaction.setOpp_area("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_pbc_party_class_cd())
								.equals(java.net.URLDecoder.decode(saveStrings[29].substring(1)))) {
									t47_transaction.setOpp_pbc_party_class_cd("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_party_class_cd())
								.equals(java.net.URLDecoder.decode(saveStrings[30].substring(1)))) {
									t47_transaction.setOpp_party_class_cd("#");
								}
								if (StringUtils.null2String(t47_transaction.getCal_ind())
								.equals(java.net.URLDecoder.decode(saveStrings[31].substring(1)))) {
									t47_transaction.setCal_ind("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_sys_id())
								.equals(java.net.URLDecoder.decode(saveStrings[32].substring(1)))) {
									t47_transaction.setOpp_sys_id("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_party_id())
								.equals(java.net.URLDecoder.decode(saveStrings[33].substring(1)))) {
									t47_transaction.setOpp_party_id("#");
								}
								if (StringUtils.null2String(t47_transaction.getCurrency_cd())
								.equals(java.net.URLDecoder.decode(saveStrings[34].substring(1)))) {
							...
							String tableName = StringUtils.null2String(request.getParameter("tableName")); // 针对一补t47_transaction_ub,
							// 二补t47_transaction_uctem

							int rows = t47_transactionDAO.cqcmodifyT47_transaction(sqlMap, t47_transaction, "0", tableName);
							if (rows <= 0) {
								throw new Exception("");
							}
							if (session.getAttribute("transListKey") != null) {
								...
								if (strTransListkey.indexOf("@") != -1) {
									...
									for (int i = 0; i < listkey.length; i++) {
										...
										if (!transkey.equals(t47_transaction.getTransactionkey())) {
							...
							if (status.equals("1")) {
								...
								if (t47_transaction.getOpp_acct_type_cd().equals("#")) {
									t47_transaction.setOpp_acct_type_cd(form.getOpp_acct_type_cd());
								}
								if (t47_transaction.getOpp_pbc_party_class_cd().equals("#")) {
									t47_transaction.setOpp_pbc_party_class_cd(form.getOpp_pbc_party_class_cd());
								}
								...
								if (opp_sys_id.equals("")) {
									 ...
									 */
									t47_opp_info.setOpp_acct_num(t47_transaction.getOpp_acct_num());
									t47_opp_info.setOpp_card_no(t47_transaction.getOpp_card_no());
									t47_opp_info.setOpp_card_type(t47_transaction.getOpp_card_type());
									t47_opp_info.setOpp_name(t47_transaction.getOpp_name());
									t47_opp_info.setOpp_acct_type_cd(t47_transaction.getOpp_acct_type_cd());
									t47_opp_info.setOpp_pbc_party_class_cd(t47_transaction.getOpp_pbc_party_class_cd());
									...
									int rows1 = t47_opp_infoDAO.insertT47_Opp_info(sqlMap, t47_opp_info);
								} else {
									T47_Opp_info t47_opp_info = new T47_Opp_info();
									...
									t47_opp_info.setOpp_acct_type_cd(t47_transaction.getOpp_acct_type_cd());
									t47_opp_info.setOpp_pbc_party_class_cd(t47_transaction.getOpp_pbc_party_class_cd());
									int rows2 = t47_opp_infoDAO.modifyT47_Opp_info1(sqlMap, t47_opp_info);
								}
								...
								if (!opp_organkey.equals("")) {
									...
									t47_opp_bank1.setUnion_type(t47_transaction.getOpp_organ_type());
									T47_OPP_bank bank = bankdao.getT87_UnionDisp(sqlMap, t47_opp_bank1);
									T47_OPP_bank t47_opp_bank = new T47_OPP_bank();
									t47_opp_bank.setUnionorgkey(opp_organkey);
									t47_opp_bank.setUnion_name(t47_transaction.getOpp_organname());
									t47_opp_bank.setUnion_type(t47_transaction.getOpp_organ_type());
									...
									if (bank == null || bank.getUnionorgkey().equals("")) {
										int rows3 = bankdao.insertT847_Union(sqlMap, t47_opp_bank);
									} else {
										int row4 = bankdao.modifyT87_Union(sqlMap, t47_opp_bank);
									}
								...
								if (!opp_organkey.equals("")) {
									t00_operate_log.setOperate_desc("t47_transaction;t47_opp_info;t47_opp_bank");// 操作描述(操作的表名，用"；"分割)
								} else {
									t00_operate_log.setOperate_desc("t47_transaction;t47_opp_info");
								}
								// 2.写操作日志
					...
					public ActionForward performGetT47_transaction_SE_List1(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						ArrayList t47_transactionList = new ArrayList();
						...
						try {
							...
							// request.setAttribute("dekyMap", this.getOptionsListByMap(dekyMap,
							// null,
							// true));
							...
							if (form.getAmt_end_search().trim() != null && !"".equals(form.getAmt_end_search().trim())) {
								form.setAmt_max_value(new Double(Double.parseDouble(form.getAmt_end_search())));
								form.setAmt_end(Double.valueOf(form.getAmt_end_search()));
							...
							String newsearchflag = StringUtils.nullObject2String(request.getParameter("newsearchflag"));
							String tag = StringUtils.nullObject2String(request.getParameter("tag"));
							int intPage = PageUtils.intPage(request, newsearchflag);
							request.getSession().setAttribute("intPage", intPage + "");
							...
							if (newsearchflag.equals("1")) {// 新的查询
								...
								String validate_ind = StringUtils.null2String(request.getParameter("validate_ind"));
								...
								session.setAttribute("t47_transactionSearchObjb", t47_transaction);
							} else {// 翻页
							...
							// 本外币
							String clienttype_str = cm.getMapFromCacheToStr("curr_cd", "curr_cd_search", form.getCurr_cd_search(), "",
							                        true);
							request.setAttribute("clienttype_str", clienttype_str);

							// 客户类型
							String curr_cd_str = cm.getMapFromCacheToStr("clienttype", "party_class_cd_search",
							                     form.getParty_class_cd_search(), "", true);
							request.setAttribute("curr_cd_str", curr_cd_str);
							int page = 0;
							...
							if (newsearchflag.equals("1") || newsearchflag.equals("2") || tag.equals("1")) {
								...
								t47_transactionList = t47_transactionDAO.getT47_trade_transactionList_2b(sqlMap, t47_transaction,
								                      this.getStartRec(page), this.getIntPageSize());

								totalRow = t47_transactionDAO.getT47_trade_transactionListCount_2b(sqlMap, t47_transaction);
							}
							String url = request.getContextPath() + "/report" + actionMapping.getPath() + ".do?newsearchflag=2";
					...
					public ActionForward performModifyT47_SEtransaction(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						T47_transaction t47_transaction = new T47_transaction();
						...
						try {
							...
							if ("2".equals(saveType)) {
								...
								transactionkey = StringUtils.null2String((String) request.getParameter("transactionkey"));
								t47_transaction.setTransactionkey(transactionkey);
							...
							request.setAttribute("area1Map", this.getOptionsListByMap(area1Map, null, true));
							LinkedHashMap t87_pbc_cashMap = cm.getMapFromCache("t87_pbc_cash"); // 现钞标志
							request.setAttribute("t87_pbc_cashMap", this.getOptionsListByMap(t87_pbc_cashMap, null, true));

							request.setAttribute("agent_card_typeMap", this.getOptionsListByMap(agent_card_typeMap, null, true));
							request.setAttribute("legal_card_typeMap", this.getOptionsListByMap(card_typeMap, null, true));
							request.setAttribute("agent_countryMap", this.getOptionsListByMap(agent_countryMap, null, true));
							request.setAttribute("opp_organ_typeMap", this.getOptionsListByMap(opp_organ_typeMap, null, true));
							request.setAttribute("opp_card_typeMap", this.getOptionsListByMap(card_typeMap, null, true));
							request.setAttribute("opp_acct_type_cdMap", this.getOptionsListByMap(acct_typeMap, null, true));
							request.setAttribute("org_trans_relaMap", this.getOptionsListByMap(org_trans_relaMap, null, true));
							request.setAttribute("acct_typeMap", this.getOptionsListByMap(acct_typeMap, null, true));
							request.setAttribute("receive_pay_cdMap", receive_pay_cdMap);
							request.setAttribute("currency_cdMap", currency_cdMap);
							T47_transactionActionForm form = (T47_transactionActionForm) actionForm;

							t47_transaction = t47_transactionDAO.getModifySET47_transaction(sqlMap, t47_transaction, agreementDAO);
							// 如果补完了当前查询的所有交易则弹出提示框
							if ("".equals(t47_transaction.getTransactionkey())) {
								return actionMapping.findForward("finash");
							}
							// String t47_transactionString =
							// ObjectCompare.ObjectToFormatStr(t47_transaction, "#_#", "@_@");
							request.setAttribute("t47_transactionString", StringUtils.null2String(t47_transaction.getAcct_type()));

							// 将查询出来的值拼成字符串用#分开
							String saveString = "|" + java.net.URLEncoder.encode(NullToString(t47_transaction.getOrg_trans_rela()))
							                    ...
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getAcct_type())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getAcct_num())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpen_dt_disp())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getClose_dt_disp())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getCurrency_cd())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getCash_ind())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getSettle_type_cd())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getTsctkey())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getReceive_pay_cd())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getUse_des())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getTx_occur_country())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getTx_occur_area())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getTx_go_country())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getTx_go_area())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_acct_type_cd())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_acct_num())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_card_type())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_name())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_card_no())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_organname())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_organ_type())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_organkey())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_country())) + "@|"
							                    + java.net.URLEncoder.encode(NullToString(t47_transaction.getOpp_area()));
							...
							if (t47_transaction.getAgent_card_type() != null && !t47_transaction.getAgent_card_type().equals("")) {
								String type08 = t47_transaction.getAgent_card_type().substring(0, 2);
								String info08 = t47_transaction.getAgent_card_type().substring(2);
								t47_transaction.setAgent_card_type(type08);
								t47_transaction.setCard_inf(info08);
							}
							if (t47_transaction.getOpp_card_type() != null && !t47_transaction.getOpp_card_type().equals("")) {
								String opp_type08 = t47_transaction.getOpp_card_type().substring(0, 2);
								String opp_info08 = t47_transaction.getOpp_card_type().substring(2);
								t47_transaction.setOpp_card_type(opp_type08);
								t47_transaction.setOpp_card_inf(opp_info08);
					...
					public ActionForward performModifySecondTransDo(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						...
						try {
							...
							if (!t47_transaction.getDt_time_disp().equals("")) {
								t47_transaction.setDt_time(DateUtils.stringToDateShort(t47_transaction.getDt_time_disp()));
							}
							// 判断帐户是否修改，如果未修改则不更新表
							...
							// ObjectCompare.StrToFormatObject(t47_transaction_org,
							// t47_agreementString, "#_#", "@_@");
							boolean bool = true;
							...
							if (!bool) { // 不相等修改账户表
								...
								t47_id_deposit.setAml_acct_type_cd(t47_transaction.getAcct_type());
							...
							// 判断客户是否存在
							//
							// T47_party t47_party = t47_partydao.getT47_partyById(sqlMap,
							// t47_transaction.getParty_id());
							// if(t47_party==null || t47_party.getParty_id()==null ||
							// t47_party.getParty_id().equals("")) {
							//
							...
							if (validateflag.equals("2") || validateflag.equals("3")) {
								if (!t47_transaction.getOpp_country().equals("")) {
									if (!t47_transaction.getOpp_country().equals(Constans.CHINA)
									        && !t47_transaction.getOpp_country().equals(Constans.CHINA_Bonded)
									        && !t47_transaction.getOpp_country().equals(Constans.CHINA_Processing)
									&& !t47_transaction.getOpp_country().equals(Constans.CHINA_Diamond)) {
										t47_transaction.setOpp_area(Constans.AREAVALUE);
									} else {
										if (t47_transaction.getOpp_area().equals("")) {
											if (!t47_transaction.getOpp_area2().equals("")) {
							...
							if (saveStrs.length > 0) {
								if ((StringUtils.null2String(t47_transaction.getOrg_trans_rela()))
								.equals(java.net.URLDecoder.decode(saveStrs[0].substring(1)))) {
									t47_transaction.setOrg_trans_rela("#");
								}
								if (StringUtils.null2String(t47_transaction.getAgent_name())
								.equals(java.net.URLDecoder.decode(saveStrs[1].substring(1)))) {
									t47_transaction.setAgent_name("#");
								}
								if (StringUtils.null2String(t47_transaction.getAgent_country())
								.equals(java.net.URLDecoder.decode(saveStrs[2].substring(1)))) {
									t47_transaction.setAgent_country("#");
								}
								if (StringUtils.null2String(t47_transaction.getAgent_card_type())
								.equals(java.net.URLDecoder.decode(saveStrs[3].substring(1)))) {
									t47_transaction.setAgent_card_type("#");
								}
								if (StringUtils.null2String(t47_transaction.getAgent_card_no())
								.equals(java.net.URLDecoder.decode(saveStrs[4].substring(1)))) {
									t47_transaction.setAgent_card_no("#");
								}
								if (StringUtils.null2String(t47_transaction.getAcct_type())
								.equals(java.net.URLDecoder.decode(saveStrs[5].substring(1)))) {
									t47_transaction.setAcct_type("#");
								}
								if (StringUtils.null2String(t47_transaction.getAcct_num())
								.equals(java.net.URLDecoder.decode(saveStrs[6].substring(1)))) {
									t47_transaction.setAcct_num(t47_transaction.getAcct_num());
								}
								/*
								 * if(StringUtils.null2String(t47_transaction.getOpen_dt_disp())
								 * .equals(java.net.URLDecoder.decode(saveStrs[7].substring(1)))
								 * ){ t47_transaction.setOpen_dt_disp(""); }
								 * if(StringUtils.null2String(t47_transaction.getClose_dt_disp()
								 * ).equals(java.net.URLDecoder.decode(saveStrs[8].substring(1))
								 * )){ t47_transaction.setClose_dt_disp(""); }
								 */
								/*
								 * if(StringUtils.null2String(t47_transaction.getCurrency_cd()).
								 * equals(java.net.URLDecoder.decode(saveStrs[9].substring(1))))
								 * { t47_transaction.setCurrency_cd(""); }
								 * if(StringUtils.null2String(t47_transaction.getCash_ind()).
								 * equals(java.net.URLDecoder.decode(saveStrs[10].substring(1)))
								 * ){ t47_transaction.setCash_ind(""); }
								 */
								if (StringUtils.null2String(t47_transaction.getSettle_type_cd())
								.equals(java.net.URLDecoder.decode(saveStrs[11].substring(1)))) {
									t47_transaction.setSettle_type_cd("#");
								}
								if (StringUtils.null2String(t47_transaction.getTsctkey())
								.equals(java.net.URLDecoder.decode(saveStrs[12].substring(1)))) {
									t47_transaction.setTsctkey("#");
								}
								/*
								 * if(StringUtils.null2String(t47_transaction.getReceive_pay_cd(
								 * )).equals(java.net.URLDecoder.decode(saveStrs[13].substring(1
								 * )))){ t47_transaction.setReceive_pay_cd(""); }
								 */
								if (StringUtils.null2String(t47_transaction.getUse_des())
								.equals(java.net.URLDecoder.decode(saveStrs[14].substring(1)))) {
									t47_transaction.setUse_des("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_occur_country())
								.equals(java.net.URLDecoder.decode(saveStrs[15].substring(1)))) {
									t47_transaction.setTx_occur_country("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_occur_area())
								.equals(java.net.URLDecoder.decode(saveStrs[16].substring(1)))) {
									t47_transaction.setTx_occur_area("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_go_country())
								.equals(java.net.URLDecoder.decode(saveStrs[17].substring(1)))) {
									t47_transaction.setTx_go_country("#");
								}
								if (StringUtils.null2String(t47_transaction.getTx_go_area())
								.equals(java.net.URLDecoder.decode(saveStrs[18].substring(1)))) {
									t47_transaction.setTx_go_area("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_acct_type_cd())
								.equals(java.net.URLDecoder.decode(saveStrs[19].substring(1)))) {
									t47_transaction.setOpp_acct_type_cd("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_acct_num())
								.equals(java.net.URLDecoder.decode(saveStrs[20].substring(1)))) {
									t47_transaction.setOpp_acct_num("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_card_type())
								.equals(java.net.URLDecoder.decode(saveStrs[21].substring(1)))) {
									t47_transaction.setOpp_card_type("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_name())
								.equals(java.net.URLDecoder.decode(saveStrs[22].substring(1)))) {
									t47_transaction.setOpp_name("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_card_no())
								.equals(java.net.URLDecoder.decode(saveStrs[23].substring(1)))) {
									t47_transaction.setOpp_card_no("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_organname())
								.equals(java.net.URLDecoder.decode(saveStrs[24].substring(1)))) {
									t47_transaction.setOpp_organname("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_organ_type())
								.equals(java.net.URLDecoder.decode(saveStrs[25].substring(1)))) {
									t47_transaction.setOpp_organ_type("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_organkey())
								.equals(java.net.URLDecoder.decode(saveStrs[26].substring(1)))) {
									t47_transaction.setOpp_organkey("#");
								}
								if (StringUtils.null2String(t47_transaction.getOpp_country())
								.equals(java.net.URLDecoder.decode(saveStrs[27].substring(1)))) {
									t47_transaction.setOpp_country("#");
								}

								if (StringUtils.null2String(t47_transaction.getOpp_area())
								.equals(java.net.URLDecoder.decode(saveStrs[28].substring(1)))) {
									t47_transaction.setOpp_area("#");
								}
							}
							 ...
							 * t00_operate_log.setModule_key_sub2("");// 子功能点2级 t00_operate_log
							 * .setOperate_obj1(t47_transaction.getTransactionkey());// 操作对象1级
							 * t00_operate_log.setOperate_type("2");// 操作类型 //
							 * 1:添加2:修改3:删除4:查询（暂不记） t00_operate_log.setIs_succ("");// 操作结果
							 * 1：成功0：失败 t00_operate_log.setOperate_desc("t47_transaction_uc");//
							 * 操作描述(操作的表名，用"；"分割) // 2.写操作日志 this.writeOperLog(auth, sqlMap,
							 * t00_operate_log);
							 */
							// 写操作日志
					...
					private void writeT47_trans_recordLog(T47_transaction t47_transaction, HttpServletRequest request)
					throws Exception {
					...
					public ActionForward performGetnewT47_transactionList(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						ArrayList t47_transactionList = new ArrayList();
						...
						try {
							...
							if ("1".equals(newsearchflag)) {// 新的查询
								if (form.getTx_dt_disp() != null && !"".equals(form.getTx_dt_disp())) {
									form.setTx_dt(DateUtils.stringToDateShort(form.getTx_dt_disp()));
								}
								if (form.getTx_enddt_disp() != null && !"".equals(form.getTx_enddt_disp())) {
									form.setTx_dtEnd(DateUtils.stringToDateShort(form.getTx_enddt_disp()));
								}
								form.setDebit_credit(form.getDebit_credit_disp());
								form.setCash_trans_flag(form.getCash_trans_flag_disp());
								if (form.getAmt_start_search() != null && !"".equals(form.getAmt_start_search().trim())) {
									form.setAmt_start(Double.valueOf(form.getAmt_start_search()));
								} else {
									form.setAmt(null);
								}
								if (form.getAmt_end_search() != null && !"".equals(form.getAmt_end_search().trim())) {
									form.setAmt_end(Double.valueOf(form.getAmt_end_search()));
								} else {
									form.setAmt_max_value(null);
								}
								...
								t47_transaction.setOrgankeystr(org_id);
								intPage = 0;
								session.setAttribute("t47_transactionSearchObj11", t47_transaction);
							} else {// 翻页
								t47_transaction = (T47_transaction) session.getAttribute("t47_transactionSearchObj11");
							}
							if (!newsearchflag.equals("2")) {
								if (t47_transaction == null)
									t47_transaction = new T47_transaction();
								t47_transactionList = t47_transactionDAO.getT47_transaction_newList(sqlMap, t47_transaction,
								                      this.getStartRec(intPage), this.getIntPageSize());
								totalRow = t47_transactionDAO.getT47_transaction_newListCount(sqlMap, t47_transaction);
								String url = request.getContextPath() + "/report" + actionMapping.getPath() + ".do";
							...
							// 客户类型
							String party_class_str = cm.getMapFromCacheToStr("clienttype", "party_class_cd", form.getParty_class_cd(),
							                         "", true);
							...
							// request.setAttribute("trackflagMap", this.getOptionsListByMap(
							// trackflagMap, null, true));
							String debit_credit_str = cm.getMapFromCacheToStr("trackflag", "debit_credit_disp",
							                          form.getDebit_credit_disp(), "", true);
					...
					public ActionForward performCase_new_trans_add(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						T47_transaction t47_transaction = new T47_transaction();
						...
						try {
							...
							request.setAttribute("party_typeMap", this.getOptionsListByMap(party_typeMap, null, true));
							...
							request.setAttribute("nationalityMap", this.getOptionsListByMap(countryMap, null, true));
							request.setAttribute("countryMap", this.getOptionsListByMap(countryMap, null, true));
							LinkedHashMap area1Map = cm.getMapFromCache("area1"); // 省信息
							request.setAttribute("area1Map", this.getOptionsListByMap(area1Map, null, true));
							LinkedHashMap t87_pbc_cashMap = cm.getMapFromCache("t87_pbc_cash"); // 现钞标志
							request.setAttribute("t87_pbc_cashMap", this.getOptionsListByMap(t87_pbc_cashMap, null, false));
							...
							request.setAttribute("agent_card_typeMap", this.getOptionsListByMap(agent_card_typeMap, null, true));
							request.setAttribute("legal_card_typeMap", this.getOptionsListByMap(card_typeMap, null, true));
							request.setAttribute("agent_countryMap", this.getOptionsListByMap(countryMap, null, true));
							request.setAttribute("opp_organ_typeMap", this.getOptionsListByMap(opp_organ_typeMap, null, true));
							request.setAttribute("opp_card_typeMap", this.getOptionsListByMap(card_typeMap, null, true));
							request.setAttribute("opp_acct_type_cdMap", this.getOptionsListByMap(opp_acct_type_cdMap, null, true));
							request.setAttribute("org_trans_relaMap", this.getOptionsListByMap(org_trans_relaMap, null, true));
							request.setAttribute("acct_typeMap", this.getOptionsListByMap(acct_typeMap, null, true));
							request.setAttribute("receive_pay_cdMap", receive_pay_cdMap);
							request.setAttribute("currency_cdMap", currency_cdMap);
							LinkedHashMap tx_cdMap = cm.getMapFromCache("aml_tx_cd"); // 交易代码
							request.setAttribute("tx_cdMap", this.getOptionsListByMap(tx_cdMap, null, true));
							T47_transactionActionForm form = (T47_transactionActionForm) actionForm;
							...
							request.setAttribute("t87_pbc_gjfs1Map", this.getOptionsListByMap(t87_pbc_gjfs1Map, null, true));
							request.setAttribute("t87_pbc_gjfs2Map", this.getOptionsListByMap(t87_pbc_gjfs2Map, null, true));
							request.setAttribute("t87_pbc_gjfs3Map", this.getOptionsListByMap(t87_pbc_gjfs3Map, null, true));
							request.setAttribute("t87_pbc_gjfs4Map", this.getOptionsListByMap(t87_pbc_gjfs4Map, null, true));
					...
					public ActionForward performCase_new_trans_add_do(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						...
						try {
							...
							if (!t47_transaction.getDt_time_disp().equals("")) {
								t47_transaction.setDt_time(DateUtils.stringToDateShort(t47_transaction.getDt_time_disp()));
								t47_transaction.setTx_dt(DateUtils.stringToDateShort(t47_transaction.getDt_time_disp()));
							}
							// 本外币
							...
							if (t47_transaction.getCurr_cd().equals("2")) {// 外币
								if (t47_transaction.getTsctkey() == null || t47_transaction.getTsctkey().equals("")) {
									t47_transaction.setTsctkey("000000");
								}
								if (exchange_rateMap.containsKey(t47_transaction.getCurrency_cd())) {
									double rate = Double
									              .parseDouble(String.valueOf(exchange_rateMap.get(t47_transaction.getCurrency_cd())));
									double res = Double.parseDouble(String.valueOf(t47_transaction.getAmt())) * rate
									             / Constans.CURRENCY_UNIT;
									...
									t47_transaction.setCny_amt(Double.valueOf(String
									                           .valueOf(t47_transaction.getUsd_amt().doubleValue() * Constans.CURRENCY_UNIT / usd_rate)));
								}
								...
								t47_transaction.setUsd_amt(Double.valueOf(String
								                           .valueOf(t47_transaction.getCny_amt().doubleValue() / Constans.CURRENCY_UNIT * usd_rate)));
							...
							if (!"".equals(t47_transaction.getTx_go_country()) && !"CHN".equals(t47_transaction.getTx_go_country())
							        || !"".equals(t47_transaction.getTx_occur_country())
							&& !"CHN".equals(t47_transaction.getTx_occur_country())) {
							...
							t47_transaction.setTransactionkey("MT" + this.getSequenceNextVal("t47_transactionkey_mt"));
							...
							// t47_transactionDAO.modifyT47_transactionDo(sqlMap,
							// t47_transaction);
					 ...
					 * @return
					 */
					public ActionForward performCase_new_trans_delete_do(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						ArrayList t47_transactionList;
						...
						try {
							...
							if (re_dt_disp.equals(currdate.substring(0, 10))) {
								...
								if (Integer.parseInt(hour) > 17) {
									errors.add(errors.GLOBAL_ERROR, new ActionError("error.pagertitle.common", "该交易超过时间不可进行删除！"));
									saveErrors(request, errors);
					 ...
					 * @return
					 */
					public ActionForward performGetT47_transactionExcelList2(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						HttpSession session = request.getSession();
						ArrayList t47_transactionList;
					 ...
					 * @return ActionForward
					 */
					public ActionForward performGetT47_transactionDisp(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						T47_transactionDAO t47_transactionDAO = (T47_transactionDAO) context.getBean("t47_transactionDAO");
						...
						try {
							...
							// t47_transaction =
							// t47_transactionDAO.getT47_transactionDisp(sqlMap, transactionkey,
							// tableName);
							// T47_transaction t47_transaction1 =
							// t47_transactionDAO.getT47_transactionFillDisp(sqlMap,
							// transactionkey, tableName);
							// t47_transaction.setOrgankeystr(t47_transaction1.getUnionorgkey());
							// if(!tableName.equals("") && tableName != null){//针对创建案例里添加交易的交易信息
							if ((!tableName.equals("") && !tableName.equals("ls"))
							|| (!new_case.equals("") && new_case != null && new_case.equals("1"))) {
								...
								// t47_transaction.setAlertsearchtime(alertsearchtime);
								// T47_transaction t47_transaction1 =
								// t47_transactionDAO.getT47_transactionFillDisp2(sqlMap,
								// t47_transaction);
								// t47_transaction.setOrgankeystr(t47_transaction1.getUnionorgkey());
							}
							// end modify by lixx
					...
					public ActionForward performModifyT47_transaction_new(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						T47_transactionDAO t47_transactionDAO = (T47_transactionDAO) context.getBean("t47_transactionDAO");
						T47_transaction t47_transaction = new T47_transaction();
						...
						try {
							...
							request.setAttribute("pbc_catpMap", this.getOptionsListByMap(pbc_catpMap, null, true));
							LinkedHashMap pbc_cttpMap = cm.getMapFromCache("pbc_cttp"); // 客户类型
							request.setAttribute("pbc_cttpMap", this.getOptionsListByMap(pbc_cttpMap, null, false));
							LinkedHashMap t87_pbc_cashMap = cm.getMapFromCache("t87_pbc_cash"); // 现钞标志
							request.setAttribute("t87_pbc_cashMap", this.getOptionsListByMap(t87_pbc_cashMap, null, false));
							...
							// request.setAttribute("agent_countryMap",
							// this.getOptionsListByMap(
							// legal_country_cdMap, null, true));

							LinkedHashMap currency_typeMap = cm.getMapFromCache("currency");
							request.setAttribute("currency_typeMap", this.getOptionsListByMap(currency_typeMap, null, true));

							ArrayList areaList = cm.getListFromCache("getArea_forall");
							request.setAttribute("areaList", areaList);
							T47_transactionActionForm form = (T47_transactionActionForm) actionForm;
							String transactionkey = StringUtils.null2String(request.getParameter("transactionkey"));
							t47_transaction = t47_transactionDAO.getT47_transactionFillDisp(sqlMap, transactionkey, "t47_transaction");
							...
							if (t47_transaction.getTx_go_area() != null) {
								if ((String) area3Map.get(t47_transaction.getTx_go_area()) != null) {// 第三级
									t47_transaction.setTx_go_area2(t47_transaction.getTx_go_area());
									t47_transaction.setTx_go_area1((String) areaupMap.get(t47_transaction.getTx_go_area()));
									t47_transaction.setTx_go_area((String) areaupMap.get(t47_transaction.getTx_go_area1()));
								} else if ((String) area23Map.get(t47_transaction.getTx_go_area()) != null
								&& (String) area3Map.get(t47_transaction.getTx_go_area()) == null) {// 第二级
									t47_transaction.setTx_go_area1(t47_transaction.getTx_go_area());
									t47_transaction.setTx_go_area((String) areaupMap.get(t47_transaction.getTx_go_area()));
								}
							}
							if (t47_transaction.getTx_occur_area() != null) {
								if ((String) area3Map.get(t47_transaction.getTx_occur_area()) != null) {// 第三级
									t47_transaction.setTx_occur_area2(t47_transaction.getTx_occur_area());
									t47_transaction.setTx_occur_area1((String) areaupMap.get(t47_transaction.getTx_occur_area()));
									t47_transaction.setTx_occur_area((String) areaupMap.get(t47_transaction.getTx_occur_area1()));
								} else if ((String) area23Map.get(t47_transaction.getTx_occur_area()) != null
								&& (String) area3Map.get(t47_transaction.getTx_occur_area()) == null) {// 第二级
									t47_transaction.setTx_occur_area1(t47_transaction.getTx_occur_area());
									t47_transaction.setTx_occur_area((String) areaupMap.get(t47_transaction.getTx_occur_area()));
								}
							}
							if (t47_transaction.getOpp_area() != null) {
								if ((String) area3Map.get(t47_transaction.getOpp_area()) != null) {// 第三级
									t47_transaction.setOpp_area2(t47_transaction.getOpp_area());
									t47_transaction.setOpp_area1((String) areaupMap.get(t47_transaction.getOpp_area()));
									t47_transaction.setOpp_area((String) areaupMap.get(t47_transaction.getOpp_area1()));
								} else if ((String) area23Map.get(t47_transaction.getOpp_area()) != null
								&& (String) area3Map.get(t47_transaction.getOpp_area()) == null) {// 第二级
									t47_transaction.setTx_occur_area1(t47_transaction.getOpp_area());
									t47_transaction.setOpp_area((String) areaupMap.get(t47_transaction.getOpp_area()));
								}
							}
							if (t47_transaction.getCurr_cd().equals("2")) {
								t47_transaction.setSettle_type_cd1(t47_transaction.getSettle_type_cd());
							}
							MyBeanUtils.copyBean2Bean(form, t47_transaction);
					...
					public ActionForward performModifyT47_transaction_newDo(ActionMapping actionMapping, ActionForm actionForm,
					HttpServletRequest request, HttpServletResponse response) {
						ActionErrors errors = new ActionErrors();
						...
						try {
							...
							// 折算金额
							// 交易时间
							if (t47_transaction.getTx_dt_disp() != null && !t47_transaction.getTx_dt_disp().equals("")) {
								t47_transaction.setTx_dt(DateUtils.stringToDateShort(t47_transaction.getTx_dt_disp()));
								t47_transaction.setDt_time(t47_transaction.getTx_dt());
							}
							// 交易去向
							if (t47_transaction.getTx_go_country() != null && t47_transaction.getTx_go_country().equals("CHN")) {
								if (t47_transaction.getTx_go_area2().length() == 6) {
									t47_transaction.setTx_go_area(t47_transaction.getTx_go_area2());
								} else if (t47_transaction.getTx_go_area1().length() == 6) {
									t47_transaction.setTx_go_area(t47_transaction.getTx_go_area1());
								}
							} else if (t47_transaction.getTx_go_country() != null && t47_transaction.getTx_go_country().length() == 3) {
								t47_transaction.setTx_go_area("000000");
							}
							// 交易发生地
							if (t47_transaction.getTx_occur_country() != null && t47_transaction.getTx_occur_country().equals("CHN")) {
							...
							// 对方机构行政区代码
							if (t47_transaction.getOpp_country() != null && t47_transaction.getOpp_country().equals("CHN")) {
								if (t47_transaction.getOpp_area2().length() == 6) {
									t47_transaction.setOpp_area(t47_transaction.getOpp_area2());
								} else if (t47_transaction.getOpp_area1().length() == 6) {
									t47_transaction.setOpp_area(t47_transaction.getOpp_area1());
								}
							} else if (t47_transaction.getOpp_country() != null && t47_transaction.getOpp_country().length() == 3) {
							...
							if (t47_transaction.getCash_ind().equals("00"))
								...
								t47_transaction.setCash_trans_flag("2");
							t47_transaction.setOpp_isparty(form.getIs_party());
							int i = t47_transactionDAO.modifyT47_transactiondo(sqlMap, t47_transaction);
