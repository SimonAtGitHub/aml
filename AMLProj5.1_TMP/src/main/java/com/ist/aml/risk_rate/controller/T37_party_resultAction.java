...
public class T37_party_resultAction extends BaseAction {
	 ...
	 * @return ActionForward
	 */
	public ActionForward performGetT37_party_resultList(ActionMapping actionMapping, ActionForm actionForm,
		...
		try {
			...
			if (!"0".equals(newsearchflag)) {
				t37_party_resultList = t37_party_resultDAO.getT37_party_resultList(sqlMap, t37_party_result,
	 ...
	 * @return ActionForward
	 */
	public ActionForward performGetT37_party_result_checkList(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		List t37_party_resultList = null;
		...
		try {
			...
			operlist = t37_party_resultDAO.getT31_n_moveopRiskList(sqlMap, node_id);
			if (!"0".equals(newsearchflag)) {
				t37_party_resultList = t37_party_resultDAO.getT37_party_result_checkList(sqlMap, t37_party_result,
						this.getStartRec(intPage), this.getIntPageSize());
				int totalRow = t37_party_resultDAO.getT37_party_result_checkListCount(sqlMap, t37_party_result);
				String url = request.getContextPath() + "/risk_rate" + actionMapping.getPath() + ".do";
				pageInfo = this.getPageInfoStr(totalRow, intPage, url, "");
				MyBeanUtils.copyBean2Bean(form, t37_party_result);
				// 发起调整完成后不再设置默认机构号
	 ...
	 * @return
	 */
	public ActionForward performGetT37_level_auditList(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		String pageInfo = "";
		...
		try {
			...
			t37_level_auditList = t37_party_resultDAO.getT37_level_auditList(sqlMap, t37_party_result,
					this.getStartRec(intPage), this.getIntPageSize());
			int totalRow = t37_party_resultDAO.getT37_level_auditListCount(sqlMap, t37_party_result);
			String url = request.getContextPath() + "/risk_rate" + actionMapping.getPath() + ".do";
			pageInfo = this.getPageInfoStr(totalRow, intPage, url, "");
			MyBeanUtils.copyBean2Bean(form, t37_party_result);
		} catch (Exception e) {
	...
	public ActionForward performgetT37_level_auditList_export(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		ArrayList t37_level_auditList = new ArrayList();
		HttpSession session = request.getSession();
		...
		try {
			...
			t37_level_auditList= t37_party_resultDAO.getT37_level_auditList1(sqlMap, t37_party_result);
	 ...
	 * @return
	 */
	public ActionForward performGetT37_helpcheckList(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		String pageInfo = "";
		...
		try {
			...
			t37_help_checkList = t37_help_checkDAO.getT37_help_check_dispList(sqlMap, t37_help_check,
					this.getStartRec(intPage), this.getIntPageSize());
	...
	/**
	 * 符号环绕 将例如string=a,b,c regex=，symbol=‘ 返回形式为'a','b','c'
	 * 
	 * @param string
	 *            要换换的字符串
	 * @param regex
	...
	public ActionForward performGetT37_appr_bas_rsltList(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
	...
	public ActionForward performGetT10_checkparty_main(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_result t37_party_result = new T37_party_result();
		String backurl = StringUtils.null2String(request.getParameter("backurl"));
		...
		try {
			...
			if (dispatcher.equals("_view")) {
				/**
				 * T37_party_resultDAO t37_party_resultDAO =
				 * (T37_party_resultDAO) context
				 ...
				 * t37_party_result.setParty_id(form.getParty_id());
				 * t37_party_result=t37_party_resultDAO.getT37_party_resultDisp1
				 * (sqlMap, t37_party_result); if(t37_party_result!=null){
	...
	public ActionForward performRecountT37_party_result(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_result t37_party_result = new T37_party_result();
		String backurl = StringUtils.null2String(request.getParameter("backurl"));
	 ...
	 * @return ActionForward
	 */
	public ActionForward performModifyT37_party_gs_result(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_resultDAO t37_party_resultDAO = (T37_party_resultDAO) context.getBean("t37_party_result_rateDAO");
		T37_party_result t37_party_result = new T37_party_result();
		...
		try {
			...
			if (t37_party_result.getTemptype().equals("1")) {
				...
				// t37_level_auditList=t37_party_resultDAO.getT37_level_auditList(sqlMap,
				// t37_party_result);
	 ...
	 * @return
	 */
	public ActionForward performT37_party_resultMain(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_resultDAO t37_party_resultDAO = (T37_party_resultDAO) context.getBean("t37_party_result_rateDAO");
		T37_party_result t37_party_result = new T37_party_result();
	...
	public ActionForward performT37_party_viewMain(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_result t37_party_result = new T37_party_result();
		String backurl = StringUtils.null2String(request.getParameter("backurl"));
	...
	public ActionForward performGetCurrentT37_party_result(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
	...
	public ActionForward performGetT37_party_gs_resultDisp(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_resultDAO t37_party_resultDAO = (T37_party_resultDAO) context.getBean("t37_party_result_rateDAO");
		T37_party_result t37_party_result = new T37_party_result();
	...
	public ActionForward performGetT37_party_jf_resultDisp(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_resultDAO t37_party_resultDAO = (T37_party_resultDAO) context.getBean("t37_party_result_rateDAO");
		T37_party_result t37_party_result = new T37_party_result();
	...
	public ActionForward performGetT37_party_gsjf_resultDisp(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
	 ...
	 * @return ActionForward
	 */
	public ActionForward performModifyT37_party_resultDo(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		AuthBean authBean = (AuthBean) session.getAttribute("authBean");
		...
		try {
			...
			for (int i = 0; i < t31_switchList.size(); i++) {
				...
				if (node_id.equals(t31_switch.getOrig_node()) && oper_id.equals(t31_switch.getOper_id())
						&& levelkey.equals(t31_switch.getLevelkey())) {
	...
	public ActionForward performReturnT37_party_resultDo(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		AuthBean authBean = (AuthBean) session.getAttribute("authBean");
	...
	private void isModify_fields(String oper_id, String curr_post, T37_party_result t37_party_result,
			AuthBean authBean) {
	 ...
	 * @return
	 */
	public ActionForward performT37_party_gs_result(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_resultDAO t37_party_resultDAO = (T37_party_resultDAO) context.getBean("t37_party_result_rateDAO");
		T37_party_result t37_party_result = new T37_party_result();
	 ...
	 * @return ActionForward
	 */
	public ActionForward performT37_party_jf_result(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_resultDAO t37_party_resultDAO = (T37_party_resultDAO) context.getBean("t37_party_result_rateDAO");
		LinkedHashMap levelMap = cm.getMapFromCache("t31_risk_level"); // 风险等级
		...
		try {
			...
			t37_appr_bas_rslt.setOrgankey(t37_party_result.getOrgankey());
			t37_appr_bas_rslt.setStatistic_dt(t37_party_result.getStatistic_dt());
			// t37_appr_bas_rsltList =
			// t37_party_resultDAO.getT37_appr_elem_rsltList(sqlMap,
			// t37_appr_bas_rslt);
			...
			//
			// T37_appr_bas_rslt
			// t37_appr_bas=(T37_appr_bas_rslt)t37_appr_bas_rsltList.get(i);
			// JSONObject json = JSONObject.fromObject(t37_appr_bas);
			// jsonArray.add(json);
			//
			// }
	...
	public ActionForward performGetT37_appr_elem_rslt_dispList(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_resultDAO t37_party_resultDAO = (T37_party_resultDAO) context.getBean("t37_party_result_rateDAO");
		LinkedHashMap levelMap = cm.getMapFromCache("t31_risk_level"); // 风险等级
		...
		try {
			...
			if (elementkey.equals("fristList")) {
				...
				for (int i = 0; i < eleList.size(); i++) {
					...
					String js_type = t31_def_element1.getJs_type();
					com.ist.aml.newrisk.dto.T37_appr_bas_rslt t37_appr_bas = new com.ist.aml.newrisk.dto.T37_appr_bas_rslt();
					// PropertyUtils.copyProperties(t37_appr_bas,
					// t31_def_element1);
				...
				// t37_appr_bas_rslt_dispList =
				// t37_party_resultDAO.getT37_appr_elem_rslt_dispList(sqlMap,
				// t37_appr_bas_rslt);
				// if(t37_appr_bas_rslt_dispList.size()==0){
				// t37_appr_bas_rslt_dispList =
				// t37_party_resultDAO.getT37_appr_bas_rslt_dispList(sqlMap,
				// t37_appr_bas_rslt);
				// jsonFlag = "1";
				// }
				t37_appr_bas_rslt.setTemplatekey(t37_party_result.getTemplatekey());
				...
				if (is_last.equals("1")) {
					ArrayList t37_appr_bas_rsltList = t37_party_resultDAO.getT37_appr_bas_rsltList(sqlMap,
							t37_appr_bas_rslt);
					jsonFlag = "1";
				} else {
	...
	public ActionForward performGetT37_appr_elem_rslt_dispList2(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		T37_party_resultDAO t37_party_resultDAO = (T37_party_resultDAO) context.getBean("t37_party_result_rateDAO");
		T37_party_result t37_party_result = new T37_party_result();
	...
	public ActionForward performAddT37_operDo(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		AuthBean authBean = (AuthBean) session.getAttribute("authBean");
		...
		try {
			...
			if (!keys.equals("")) {
				...
				for (int i = 0; i < flow_id.length; i++) {
					...
					t31_switch_n.setOper_id(oper_id);
					t31_switch_n.setOrig_node(node_id);
					ArrayList t31_switch_searchList = (ArrayList) sqlMap.queryForList("getT31_switchList",
							t31_switch_n);
	...
	public ActionForward performBatchT37_operDo(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		AuthBean authBean = (AuthBean) session.getAttribute("authBean");
	 ...
	 * @return ActionForward
	 */
	public ActionForward performGetT37_party_resultList1(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		List t37_party_resultList = null;
	 ...
	 * @return ActionForward
	 */
	public ActionForward performGetT31_party_result_BExcel(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
	 ...
	 * @return ActionForward
	 */
	public ActionForward performGetT31_party_result_SExcel(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		ArrayList t37_party_resultList = new ArrayList();
	...
	public ActionForward performReturnT37_party_result(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
		T37_party_resultDAO t37_party_resultDAO = (T37_party_resultDAO) context.getBean("t37_party_result_rateDAO");
	...
	public ActionForward performChangeLevelByLastscore(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
		ActionMessages errors = new ActionMessages();
		HttpSession session = request.getSession();
