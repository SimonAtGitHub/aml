...
/**
* <p>T07_INREP_BS_levelActionForm.java</p>
* <p>Description: </p>
...
public class T07_INREP_BS_levelActionForm extends ActionForm {
...
/**报送开始日期*/
private String statistic_dt_start = "";
/**报送截至日期*/
private String statistic_dt_end = "";   
    /**                   
     * 构造函数           
     */                   
    public T07_INREP_BS_levelActionForm() {    
    }                     
...
public String getStatistic_dt_start() {
	return statistic_dt_start;
}
public void setStatistic_dt_start(String statistic_dt_start) {
	this.statistic_dt_start = statistic_dt_start;
}
public String getStatistic_dt_end() {
	return statistic_dt_end;
}
public void setStatistic_dt_end(String statistic_dt_end) {
