...
public class MultiboxTag extends BaseHandlerTag {
    ...
    /**
     * The minimum number of characters allowed, or negative for no limit.
     * add minlength attribute by sunny 2010-02-26
     */    
    protected String minlength = null;    
    
    
    /**
     * The warning of characters allowed, or negative for no limit.
     * add minlength attribute by sunny 2010-04-26
     */    
    ...
    /**
    *
    * add checkfunc attribute by sunny 2010-04-26
    */    
   protected String checkfunc = null;        
  ...
  protected String dictcode = null;       
    ...
    /**
     * @param checkfunc the checkfunc to set
     */
    ...
    public int doEndTag() throws JspException {
        ...
        prepareAttribute(results, "dictcode", getDictcode());          
        ...
        //add by sunny 2010-05-17
        if ( (getDictcode()!=null)&&(!"".equals(getDictcode())) ){
            results.append(ExpandTagUtils.getInstance().getDictDesc(ExpandTagUtils.getInstance().getCatchManagerInstance(pageContext),value,getDictcode()));            
        }
