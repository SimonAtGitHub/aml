/*
 * $Id: BaseFieldTag.java 684305 2008-08-09 17:43:00Z niallp $
 *
 ...
 *
 * @version $Rev: 684305 $ $Date: 2004-10-16 12:38:42 -0400 (Sat, 16 Oct 2004)
 *          $
 */
public abstract class BaseFieldTag extends BaseInputTag {
    ...
    protected String renderInputElement()
        ...
        prepareAttribute(results, "require", getRequire());
        prepareAttribute(results, "datatype", getDatatype());
        prepareAttribute(results, "msg", getMsg());
        prepareAttribute(results, "max", getMax());
        prepareAttribute(results, "min", getMin());
        prepareAttribute(results, "compare", getCompare());
        prepareAttribute(results, "regexp", getRegexp());
        prepareAttribute(results, "url", getUrl());
        prepareAttribute(results, "msgid", getMsgid());
