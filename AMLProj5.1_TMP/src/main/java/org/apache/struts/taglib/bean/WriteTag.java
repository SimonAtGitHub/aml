...
public class WriteTag extends TagSupport {
    ...
    protected String intcplength = null;
    
    

    /**
     * @return the intcplength
     */
    public String getIntcplength() {
        return intcplength;
    }

    /**
     * @param intcplength the intcplength to set
     */
    public void setIntcplength(String intcplength) {
        this.intcplength = intcplength;
    }
    ...
    public int doStartTag() throws JspException {
        ...
        if ((dictcode!=null)&&(!"".equals(dictcode))){   
            value = ExpandTagUtils.getInstance().getDictDesc(ExpandTagUtils.getInstance().getCatchManagerInstance(pageContext),value.toString(),dictcode,"WriteTag");
        }

        
        if (intercept == true){
            value = ExpandTagUtils.getInstance().getInterceptValue(value.toString(), intcplength);
        }
