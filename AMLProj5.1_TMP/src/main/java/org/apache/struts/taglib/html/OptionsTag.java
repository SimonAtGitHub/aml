...
import org.apache.struts.taglib.ExpandTagUtils;
...
public class OptionsTag extends TagSupport {
    ...
    /**
    * add checkfunc attribute by sunny 2010-05-17
    */    
    protected String dictcode = null;   
    ...
    */    
    ...
    protected String curtyear = null; 
     ...
     * @return the curtyear
     */
    public String getCurtyear() {
        return curtyear;
    }

    /**
     * @param curtyear the curtyear to set
     */
    public void setCurtyear(String curtyear) {
        this.curtyear = curtyear;
    }
    ...
    public int doEndTag() throws JspException {
        ...
        if ((dictcode!=null)&&(!"".equals(dictcode))){
            ArrayList list = ExpandTagUtils.getInstance().getOptionsListByMap(ExpandTagUtils.getInstance().getCatchManagerInstance(pageContext), dictcode, optional);
            int randint = org.apache.commons.lang.math.RandomUtils.nextInt(99999999);
            collection =(new Integer(randint))+ExpandTagUtils.opitons_split+dictcode;            
            pageContext.setAttribute(collection, list);
        }else{
            if ((curtyear!=null)&&(!"".equals(curtyear))){
                ArrayList list = ExpandTagUtils.getInstance().getOptionsListByMap(ExpandTagUtils.getInstance().getCanSelectYear(curtyear),optional);
                int randint = org.apache.commons.lang.math.RandomUtils.nextInt(99999999);
                collection =(new Integer(randint))+ExpandTagUtils.opitons_split+"curtyear";            
                pageContext.setAttribute(collection, list);                
            }            
        }
