...
<HTML>
 ...
 <BODY>
 <div id="content">
 <html:form method="post" action="/t10_report/t10_reportparm_modify.do">
 	...
 	<div class='awp_title'>
				<table>
					<tr>
						...
						<td width="23%" nowrap>
							<span class="awp_title_td2">报表定义 - 查询参数 - 修改输入参数</span>
						</td>
						<td align="right">
							<input type=button value="保 存" onClick="checkForm('t10_reportparm_modify_do.do');">
							...
							<tr   style="display:none" id="user_sel_3">
                               ...
                               <tr   style="display:none" id="user_sel_4">
								...
								<tr>
									...
									<td>
										 <html:text property="displen" size="15" maxlength="10" styleClass="awp_number"></html:text>（最多10位数字）
									</td>
								</tr>
								<tr>
									...
									<td>
										<html:text property="dispseq" styleClass="awp_number" size="15" maxlength="10"/>（最多10位数字）
									</td>
								</tr>
								<!--<tr >
								...
								<tr>
									...
									<td >
										<html:text property="maxlen" styleClass="awp_number" size="15" maxlength="6"/>（最多6位数字）
									</td>
								</tr>
								<tr>
									<td height="22" align="right" width="20%">
									...
									<td >
										<html:text property="minlen" styleClass="awp_number" size="15" maxlength="6" />（最多6位数字）
									</td>
								</tr>
								<tr>
									<td height="22" align="right" width="20%">
