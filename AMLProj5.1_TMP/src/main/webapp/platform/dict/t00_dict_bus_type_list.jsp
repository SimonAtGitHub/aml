...
<SCRIPT LANGUAGE="JavaScript" src="../../js/load_window.js"></script>
		...
		function dosubmit(theUrl,type){
		    ...
		    }else if(type=='search' || type=='add' || type=='sys' || type=='pre'){
		        isSub = true;
		    }
		    if(isSub && errMsg==''){
		...
		<div id='main'>
			<html:form method="post" action="/t00_dict/t00_dict_list.do">
				...
				<div class="cond_t">
				  ...
				  <a href="#" onclick="dosubmit('t00_dict_add.do?upcategorykey=<%=request.getAttribute("upcategorykey")%>&applytype=2','add')"><img src="../../images/<%=session.getAttribute("style") %>/b_add.png" />新建</a>
				  <a href="#" onclick="dosubmit('t00_dict_modify.do?applytype=2','modi')"><img src="../../images/<%=session.getAttribute("style") %>/b_edit.png" />修 改</a>
				  <a href="#" onclick="dosubmit('t00_dict_delete_do.do?applytype=2','del')"><img src="../../images/<%=session.getAttribute("style") %>/b_delete.png" />删 除</a>
				  </span>
				</div>
				</div>
				<div id="tab_menu">
	                ...
	                <a href="#" onClick="dosubmit('t00_dict_list_by_type.do?newsearchflag=1','sys');return false;">系统码表管理</a>
	             </div>
				<!--<div id="bigTab">				
					<dl class="tabm">
					    <dd>业务码表管理 </dd>
						<dd >
							<span onClick="javascript:dosubmit('t00_dict_list_by_type.do?newsearchflag=1','sys');return false;">系统码表管理</span>
						</dd>
						<dd class="tabcur">
				...
				<div class='cond_c' id="searchtable" style="display: none">
					<table>
						<tr>
							...
							<td>
								<html:text property="disctype" styleClass="text_white" size="30"  maxlength="30"/>
							</td>
							<td>
								类别名称：
							</td>
						...
						<tr>
							...
							<td nowrap>
								<input type="button" name="button" value="查 询"
									onClick="dosubmit('t00_dict_list_business_type.do?newsearchflag=1&type=search&applytype=2','search')"
									class="in_button1">
							</td>
						</tr>
