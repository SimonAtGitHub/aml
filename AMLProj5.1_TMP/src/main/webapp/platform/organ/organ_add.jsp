...
function checkForm(theUrl){
    ...
    else if(getLength(document.forms[0].organkey.value)>16){
        errMsg+="机构号不能大于16个字符！";
        document.forms[0].organkey.focus();
    }
    else if(checkNum(document.forms[0].organkey.value)==0){
        errMsg+="机构号含有非法字符！";
        document.forms[0].organkey.focus();
    }
    //机构名
    else if(getLength(document.forms[0].organname.value)==0){
        errMsg+="机构名不能为空！";
	...
	<div class="cond_c2">
	  <table border="0" cellpadding="0" cellspacing="0">
        <tr>
         ...
         <td><html:text property="organkey"  size="10"/></td>
       ...
       <tr>
         ...
         <td><html:text property="org_area" readonly="true" size="9"  onclick="window.open('../../common/editCountryArea.jsp?type=short&inname=org_area&inname_disp=org_disp&type=0','enter1','height=20, width=850,left=100,top=100,scrollbars=yes,resizable=yes');"  />
          <input type="text"  name="org_disp" readonly="true" />
         </td>
       ...
       <tr>
		...
		<td align="center" class="in_button" colspan="4">
		  <html:button property="button" value="提 交" onclick="checkForm('organ_add_do.do')"/>
