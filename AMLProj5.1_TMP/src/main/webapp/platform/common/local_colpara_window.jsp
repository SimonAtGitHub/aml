			...
			<!-- conditions --> 
 			 <div class="conditions">
                ...
                <span class="buttons">
                     ...
                     <a href="#" onclick="checkForm('local_colpara_window_result.do')"><img src="../../images/<%=session.getAttribute("style") %>/b_add.png" />选 定</a>
                     <a href="#" onclick="dosubmit('location_window.do?flag=1')" ><img src="../../images/<%=session.getAttribute("style") %>/b_add.png" />全 部</a>
                     <a href="#" onclick="window.close()" ><img src="../../images/<%=session.getAttribute("style") %>/b_add.png" />关 闭</a>
               </span>
                </div>
          	<!-- table content -->
