...
function checkForm(theUrl){
    ...
    if(getLength(document.forms[0].rolename.value)>64){
        ...
        errMsg="角色名不能为空！";
        document.forms[0].rolename.focus();
    }else if(checkString(document.forms[0].rolename.value)!=0){
        errMsg+="角色名含有非法字符！";
        document.forms[0].rolename.focus();
    }
    if(errMsg!=""){
...
<body class="mainbg">
<html:form method="post" action="/role/role_modify_do.do">
<div id="main">
<!-- conditions --> 
      ...
      <td colspan="3"> <html:select property="flag">
       ...
       <tr>
		...
		<td align="center" class="in_button" colspan="4">
		 <input name="" type="button" value="提 交" onclick="checkForm('role_modify_do.do')" />	
