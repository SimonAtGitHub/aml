...
<!-- conditions --> 
  <div class="conditions">
	...
	<div class="cond_t">
	  ...
	  <a href="#" onclick="dosubmit('role_person_add_do.do','del')"><img src="../../images/<%=session.getAttribute("style") %>/b_submit.png" />确 定</a>
	   <a href="#" onclick="dosubmit('role_person_list.do?newsearchflag=1','add')"><img src="../../images/<%=session.getAttribute("style") %>/b_back.png" />返 回</a>
	  </span>
	</div>
	<!-- table content -->
        ...
        <td align="right">真实姓名：</td>
          <td ><html:text property="realname" /></td>
            ...
            <tr >
				<td >归属机构号：</td>
				<td >
				 <input type="text" name="searchOrganName"  />
				...
				<td></td>
                   <td>
					<input type="button" name="ok" class="in_button1" value="查 询" onclick="dosubmit('role_person_add.do?newsearchflag=1','chaxun')" />
