...
<SCRIPT LANGUAGE="JavaScript"> 
 ...
 <html:hidden property="tableename"/>
   <div class="conditions">
    	<div class="cond_t">
    	<span>结果主体表维护 - 添加列属性</span>
    	<span class="buttons">
			<a href="#" onclick="save('col_t03_entity_kind_man_add_do.do')"><img src="../../images/<%=session.getAttribute("style") %>/b_save.png" />保 存</a>
	...
	<div class="cond_c2">
       <table>
          ...
          <tr>
           ...
           <td>
             <html:text property="colename"  style="width:30%"></html:text><br>（最多32个字符，必须以字母开头，后面允许跟数字和_下划线）
           </td>
         </tr>
         <tr>
         ...
         <tr>
           <td>列长度：</td>
           <td>
             <html:text property="collength" styleClass="avp_number"  style="width:30%"></html:text>（最多4个数字,不能大于4000）
           </td>
         </tr> 
         <tr>
           <td>列精度：</td>
           <td>
             <html:text property="numpoint"  styleClass="avp_number"   style="width:30%"></html:text><br>（最多4个数字，只有字段类型为数字的列精度才有效 指小数点位数）
           </td>
         </tr>
