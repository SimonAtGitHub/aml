    ...
    if(getLength(trim(document.forms[0].rtettypekey.value))==0){
        ...
        document.forms[0].rtetfactkey.focus();
      	...
      	if(getLength(document.forms[0].rtetfactsctable.value)==0){
       	...
       	}else if(getLength(document.forms[0].rtetfactsctable.value)>32){
       		errMsg+='结果主体事实表源表名不能大于16个汉字'; 
            document.forms[0].rtetfactsctable.focus();
        	}
...
<div id="main">
	<html:form method="post" action="/entity/entity_kind_add.do">
	<div class="conditions">
		<div class="cond_t">
			<span><strong>结果主体管理 - 新建</strong></span>
			<span class="buttons">
				<a href="#" onclick="checkForm('entity_kind_add_do.do')"><img src="../../images/<%=session.getAttribute("style") %>/b_save.png" />保 存</a>
 	   			<a href="#" onclick="dosubmit('t03_entity_kind_list.do')"><img src="../../images/<%=session.getAttribute("style") %>/b_back.png" />返  回</a>
			</span>
		</div>
		<html:errors/>
		<div class="cond_c2">
			<table>
					<tr>
						...
						<td>
							<html:text property="rtettypekey" styleClass="text_white" size="3" />（结果主体主键必须为3位）
						</td>
					</tr>
					<tr>
						<td nowrap>
					...
					<tr id='sTabKey'>
						...
						<td>
							<html:text property="rtetfactsckey" styleClass="text_white"
								size="30" />							
						</td>
					</tr>
					<tr>
