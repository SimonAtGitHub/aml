...
<HTML>
 ...
 <div id="content">
 <html:form method="post" action="/t21_rule/t03_param_org_modify.do">
 	  	<html:hidden property="tplakey"/>
		<html:hidden property="parmvalkey_old" name="t03_param_orgActionForm"/>	
		<div class="conditions">			
			<div class='cond_t'>
			   <span>规则管理 - 修改机构参数</span>
			   <span class="buttons">
			    <a href="javascript:void(0);" onClick="checkForm('t03_param_org_modify_do.do');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_save.png" />保 存</a>
