				...
				<div class="conditions">
					<div class="cond_t">
						...
						<span class="buttons">
							...
							<a href="#" onclick="dosubmit('add_t21_rule_disp.do','add')"><img src="../../images/<%=session.getAttribute("style")%>/b_add.png" />新增</a>
							<a href="#" onclick="dosubmit('t21_rule_main_modify.do','modi')"><img src="../../images/<%=session.getAttribute("style")%>/b_edit.png" />修改</a>
							<a href="#" onclick="dosubmit('t21_rule_delete.do','del')"><img src="../../images/<%=session.getAttribute("style")%>/b_delete.png" />删除</a>
							<a href="#" onclick="dosubmit('t03_rule_copy_do.do','copy')"><img src="../../images/<%=session.getAttribute("style")%>/b_copy.png" />复制</a>
							<a href="#" onclick="dosubmit('t03_rule_task.do','sub')"><img src="../../images/<%=session.getAttribute("style")%>/b_edit.png" />提交验证</a>
						</span>
					</div>
                               ...
                               <td>
								...
								<td>
									...
									<input type="button" value="查 询" class="in_button1"
										onclick="dosubmit('<%=request.getContextPath()%>/rule/t21_rule/t21_rule_list.do?newsearchflag=1&deployflag=0','search');"/>
								</td>
                            </tr>
						</table>
					</div>
				...
				<div class="list">
					<TABLE border=0 cellpadding="2" cellspacing="1">
						...
						<logic:iterate id="t21_rule" name="t21_ruleList" indexId="i"
							...
							map.put("rulekey",t21_rule.getRulekey());
							...
							<TR align="center" class="interval"
								...
								<TD height=22>
									<html:multibox property="select_rulekey">
										<bean:write name="t21_rule" property="tplakey" />
									</html:multibox>
								</TD>
								<TD>
								<logic:equal value="1" property="gs_type" name="t21_rule">
								     <html:link name="map" page="/t21_rule/rule_indic_disp.do?deployflag=0">
										<bean:write name="t21_rule" property="rulekey" />
									</html:link>
								</logic:equal>
								<logic:equal value="2" property="gs_type" name="t21_rule">
									<html:link name="map" page="/t21_rule/t03_rule_all_info_disp.do?deployflag=0">
										<bean:write name="t21_rule" property="rulekey" />
									</html:link>
								</logic:equal>
