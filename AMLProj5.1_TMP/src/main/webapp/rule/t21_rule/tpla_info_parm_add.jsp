...
<head>
 ...
 <html:form method="post" action="/t21_rule/t03_page_in_parm_add.do">
		...
		<html:hidden property="parmkey" name="t03_page_in_parmActionForm"/>
	<div class="conditions">			
			<div class='cond_t'>
			   <span>规则管理 - 新 建</span>
			   <span class="buttons">
			    <a href="javascript:void(0);" onClick="checkForm('t03_page_in_parm_add_do.do');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_save.png" />保 存</a>
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr >
									...
									<td bgcolor="F6F9FF" width="70%">
										p_<html:text property="sysinparmcd" size="25" />
									</td>
								</tr>
								<tr>
									<td>
