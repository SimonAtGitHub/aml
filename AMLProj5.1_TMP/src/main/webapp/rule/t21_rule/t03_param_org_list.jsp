...
function win_edit(url){
	var	property = 'height=450, width=600,left=350,top=250,scrollbars=yes,resizable=yes';
...
<div id="content">
	...
	<div class="conditions">
		<div class="cond_t">
			...
			<span class="buttons">
			<%if(!"2".equals((String)request.getAttribute("implway"))){ %>
				<a href="#" onclick="dosubmit('t03_param_org_add.do','add');"><img src="../../images/<%=session.getAttribute("style")%>/b_add.png" />新增</a>
				<a href="#" onclick="dosubmit('t03_param_org_modify.do','mod');"><img src="../../images/<%=session.getAttribute("style")%>/b_edit.png" />修改</a>
				<a href="#" onclick="dosubmit('t03_param_org_delete_do.do','del');"><img src="../../images/<%=session.getAttribute("style")%>/b_delete.png" />删除</a>
			<%} %>
			</span>
		</div>
	</div>
		...
		<TABLE>
			...
			<TR align="center">
				...
				<logic:equal value="3" name="parinfo" property="parmtype">
					<a href="#" onclick="win_edit('t03_param_bsn_argEdit.do?parmvalkey=p_<bean:write name="parinfo" property="parmvalkey" />&tplakey=<bean:write name="t03_param_orgActionForm" property="tplakey" />','')" >编辑参数</a>
				</logic:equal>
				<logic:notEqual value="3" name="parinfo" property="parmtype">
					<a href="#" onclick="win_edit('t03_param_org_argEdit.do?parmvalkey=<bean:write name="parinfo" property="parmvalkey" />&tplakey=<bean:write name="t03_param_orgActionForm" property="tplakey" />&parmtype=<bean:write name="parinfo" property="parmtype" />&samevalue=<bean:write name="parinfo" property="samevalue" />','')" >编辑参数</a>
				</logic:notEqual>
