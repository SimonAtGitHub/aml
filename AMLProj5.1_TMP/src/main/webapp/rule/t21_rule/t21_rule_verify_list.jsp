...
function dosubmit(theUrl,type){
    ...
    else if(type=='revoke' || type=='apply'){
				...
				<div class="conditions">
					<div class="cond_t">
						...
						<span class="buttons">
							...
							<a href="#" onclick="dosubmit('revokeRulesDo.do?deployflag=0','revoke')"><img src="../../images/<%=session.getAttribute("style")%>/b_re_refused.png" />撤销验证</a>
							<a href="#" onclick="dosubmit('applyProT03_rule.do?deployflag=2','apply')"><img src="../../images/<%=session.getAttribute("style")%>/b_edit.png" />投产申请</a>
						</span>
					</div>
                               ...
                               <td>
								...
								<td>
									...
									<input type="button" value="查 询" class="in_button1"
										onclick="dosubmit('<%=request.getContextPath()%>/rule/t21_rule/t21_rule_verify_list.do?newsearchflag=1&deployflag=1','search');"/>
								</td>
                            </tr>
						</table>
					</div>
						...
						<logic:iterate id="t21_rule" name="t21_ruleList" indexId="i"
							...
							<TR align="center" class="interval"
								...
								<logic:equal value="1" property="gs_type" name="t21_rule">
								     <html:link name="map" page="/t21_rule/rule_indic_disp.do?deployflag=1">
										<bean:write name="t21_rule" property="rulekey" />
									</html:link>
								</logic:equal>
								<logic:equal value="2" property="gs_type" name="t21_rule">
									<html:link name="map" page="/t21_rule/t03_rule_all_info_disp.do?deployflag=1">
										<bean:write name="t21_rule" property="rulekey" />
									</html:link>
								</logic:equal>
								</TD>
								...
								<TD>
									<a href="#" onclick="dosubmit('<%=request.getContextPath()%>/rule/t27_alert/t27_alert_listByRulekey.do?newsearchflag=1&rulekey=<bean:write name="t21_rule" property="rulekey" />','view')">
											预警结果</a>
								</TD> 
							</TR>
						</logic:iterate>
