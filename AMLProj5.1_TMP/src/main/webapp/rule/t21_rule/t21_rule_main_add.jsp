...
<body leftmargin="0" topmargin="0"  class="mainbg" >
		<html:form action="/t21_rule/t21_rule_add.do" method="post">
			<div id="main">
				<!-- conditions -->
				<html:errors/>
				<!-- 大选项卡开始 -->
		...
		<div id="bigTab">
			<dl class="tabm">
				<dd class="tabcur">
					<span><a  target="t21_rule" href="<%=request.getContextPath()%>/rule/t21_rule/modify_rule_disp.do?tplakey=<bean:write name="t21_ruleActionForm" property="tplakey" />" class="bglink">基本属性</a></span>
				</dd>
				
					<dd id="ruledef">
						<span><a  target="t21_rule" href="<%=request.getContextPath()%>/rule/t21_rule/modify_rule_indic.do?rulekey=<bean:write name="t21_ruleActionForm" property="rulekey" />" class="">规则定义</a></span>
					</dd>
					<dd id="sqldef">
						<span><a target="t21_rule" href="<%=request.getContextPath()%>/rule/t21_rule/sql_rule_index.do?tplakey=<bean:write name="t21_ruleActionForm" property="tplakey" />" class="">SQL定义</a></span>
					</dd>
