			...
			<div id="main">
					...
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td colspan="3" style="white-space:normal;">
									<c:out value="${rtetnames}" escapeXml="false"/>
							</td>
						</tr>
                ...
                <div class="cond_t2">
						<span class="buttons"> <strong><img
									src="../../images/<%=session.getAttribute("style") %>/titleicon02.png" />输入参数</strong> </span>
				</div>
				<div class="list">
					<TABLE border="0" cellspacing="0" cellpadding="0">
						...
						<logic:iterate id="parinfo" name="t03_page_in_parmList"
							...
							<TR align="center" >
								...
								<TD nowrap>
									<bean:write name="parinfo" property="param"
										scope="page" />
								</TD>
								<TD nowrap>
				...
				<div class="cond_t2">
						<span class="buttons"> <strong><img
									src="../../images/<%=session.getAttribute("style") %>/titleicon02.png" />业务参数</strong> </span>
				</div>
				<div class="list">
		   <TABLE>
