...
<head>
 ...
 <BODY>
 <div id="content">
 <html:form method="post" action="/t21_rule/t03_page_in_parm_add.do">
 	  <html:hidden property="tplakey"/>
 	  <html:hidden property="parmkey"/>
 	<html:hidden property="oldsysinparmcd"/>
 	
 	<div class="conditions">	
	 		<div class='cond_t'>
	 		     <span>规则管理 - 修 改</span>
	 		     <span class="buttons">
	 		       <a href="javascript:void(0);" onClick="checkForm('t03_page_in_parm_modify_do.do');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_save.png" />保 存</a>
							 	
				   <a href="javascript:void(0);" onClick="dosubmit('t03_page_in_parm_list.do');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_back.png" />返 回</a>
	 		     </span>
				</div>   
		 </div>
        ...
        <div class="cond_c2">	
		      <table border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td >
										<html:text property="dispname" styleClass="text_white" size="15"/>（最多32个汉字）
									</td>
								</tr>
								<tr >
									<td nowrap>
							...
							<tr   style="display:none" id="user_sel_3">
								...
								<tr   style="display:none" id="user_sel_2">
									...
									<td bgcolor="F6F9FF">
										...
										<a href="#" onclick="locate_dict_window('<%=request.getContextPath()%>','location','targetcde,targetcde_disp');"><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>
									</td>
								</tr>
								<tr   style="display:none" id="user_sel_tree">
									...
									<td >
                                     <html:hidden property="targetcde_tree" styleId="targetcde_tree"/>
										...
										<a href="#" onclick="locate_dict_window('<%=request.getContextPath()%>','tree','targetcde_tree,targetcde_tree_disp');"><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>
									</td>
								</tr>
                               <tr   style="display:none" id="user_sel_4">
									...
									<td bgcolor="F6F9FF">
                                        <html:text property="targetcdehname" styleClass="text_white" size="25"/>
										 ...
										 <a href="#" onclick="locate_dict_window('<%=request.getContextPath()%>','dict','targetcdeh,targetcdehname');"><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>
								...
								<tr >
									...
									<td >
										 <html:text property="displen" size="15" styleClass="awp_number"></html:text>（最多10位数字）
									</td>
								</tr>
								<tr >
									...
									<td >
										<html:text property="dispseq" styleClass="awp_number" size="15"/>（最多10位数字）
									</td>
								</tr>
								<!--<tr >
								...
								<tr >
									...
									<td >
										<html:text property="maxlen" styleClass="awp_number" size="15"/>（最多6位数字）
									</td>
								</tr>
								<tr >
									<td height="22" align="right" width="20%">
									...
									<td >
										<html:text property="minlen" styleClass="awp_number" size="15"/>（最多6位数字）
									</td>
								</tr>
								<tr >
									<td height="22" align="right" width="20%">
