	...
	<body>
		<html:form method="post" action="/t27_alert/t27_alert_disp.do">
			...
			<div class="conditions">
				<!-- title -->
				<div class="cond_t">
					<span>预警编号: <bean:write property="alertkey" name="t27_alert" />
					</span>
					<span class="buttons">
					<a href="#" onclick="dosubmit('t27_alert_search.do?searchtype=2')"><img src="../../images/<%=session.getAttribute("style")%>/b_back.png" />返 回</a>
					</span>
				</div>
