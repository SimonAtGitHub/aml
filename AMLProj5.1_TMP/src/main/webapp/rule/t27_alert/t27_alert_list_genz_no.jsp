...
function dosubmit(theUrl,type){
	...
	<body leftmargin="0" topmargin="0">
		<div id="main">
			...
			<html:form action="t27_alert/t27_alert_listByGenzNo.do" method="post">
				<div class="conditions">
					<div class="cond_t">
						<span>预警结果</span>
						<span class="buttons">
							<a href="#" id="hdd_display" class="bt_hidden"></a>
							<a href="#" onclick="dosubmit('<%=request.getContextPath()%>/inves/partyganz/t07_party_ganz_list.do?newsearchflag=1','back')"><img src="../../images/<%=session.getAttribute("style")%>/b_back.png" />返回</a>
						</span>
					</div>
					...
					<div class="cond_c" id="searchtable">
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td>
									<html:text property="alertkey" size="10"/>
								</td>
							...
							<tr>
								...
								<td>
									<input type="button" value="查 询" class="in_button1"
										onclick="dosubmit('t27_alert_listByGenzNo.do?newsearchflag=1&selectGenzNo=<bean:write name="selectGenzNo" scope="session"/>','search');"/>
								</td>
							</tr>
						</table>
					</div>
					...
					<TABLE border=0 cellpadding="2" cellspacing="1">
						...
						<logic:iterate id="t27_alert" name="t27_alertList" indexId="i"
							...
							<TR align="center">
								...
								<TD>
								 <a href="#" onclick="dosubmit('t27_alert_dispByGenzNo.do?alertkey=<bean:write name="t27_alert" property="alertkey" />','view')">
