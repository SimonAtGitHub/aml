...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script type="text/javascript">
			function doSubmint(){
				if(jQuery(document.forms[0]).validateAll()){
					document.forms[0].action="t01_fun_param_modify_do.do";
	...
	<body class="mainbg">
		<html:form action="/t01_fun_param/t01_fun_param_modify_do.do" method="post">
			...
			<div id="main">
				...
				<div class="conditions">
					...
					<div class="cond_t">
						<span>公共参数编辑</span>
						<span class="buttons"> <a href="t01_fun_param_list.do?newsearchflag=1"
							><img
					...
					<div class="cond_c2">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									s_<html:text property="paramcd" styleClass="text_white" size="40" readonly="true"/>
								</td>
								<td>
							...
							<td>
								<html:select property="rtntype" require="true" datatype="require"  msg="返回类型需要选择一个">
							...
							<td>
								<html:select property="parmtype" require="true" datatype="require"  msg="参数类型需要选择一个">
							...
							<tr>
								...
								<td>
									<html:select property="basedt" require="true" datatype="require"  msg="基期类型需要选择一个">
