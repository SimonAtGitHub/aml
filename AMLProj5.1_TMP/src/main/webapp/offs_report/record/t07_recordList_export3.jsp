...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1378 style='border-collapse:
 ...
 <tr height=53 style='mso-height-source:userset;height:39.95pt'>
  ...
  width:656pt'>金融机构反洗钱内控制度建设情况</td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl33 width=132 style='height:30.0pt;width:99pt'>制度名称</td>
  <td class=xl34 width=214 style='width:161pt'>主要内容</td>
  <td class=xl34 width=132 style='width:99pt'>制定部门</td>
  <td class=xl34 width=132 style='width:99pt'>制定时间</td>
  <td class=xl34 width=132 style='width:99pt'>相关文号</td>
