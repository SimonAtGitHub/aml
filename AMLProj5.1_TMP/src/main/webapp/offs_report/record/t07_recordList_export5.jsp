...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1373 style='border-collapse:
 ...
 <tr height=53 style='mso-height-source:userset;height:39.95pt'>
  ...
  width:653pt'>金融机构协助公安机关、其他机关打击洗钱活动情况</td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td colspan=2 height=40 class=xl25 width=198 style='height:30.0pt;width:149pt'>配合人行开展调查情况：</td>
  <td colspan=2 class=xl27 width=177 style='width:133pt'>配合调查次数：</td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl31 width=132 style='height:30.0pt;width:99pt'>被协助单位</td>
  <td colspan=2 class=xl32 width=177 style='width:133pt'>协助时间</td>
  <td colspan=2 class=xl32 width=164 style='width:124pt'>协助内容</td>
  <td colspan=2 class=xl32 width=132 style='width:100pt'>效果</td>
  <td class=xl32 width=132 style='width:99pt'>被协助单位类型（公安机关/其他机关）</td>
