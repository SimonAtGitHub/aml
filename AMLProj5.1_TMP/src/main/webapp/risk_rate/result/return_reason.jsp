				...
				<div class="conditions">
					...
					<div class="cond_c2">
						<table border="0" cellpadding="0" cellspacing="0">
						    ...
						    <html:hidden property="node_id"/>
						    <html:hidden property="oper_id"/>
						    <html:hidden property="flow_id"/>
						    <html:hidden property="rate_source"/>
						    <html:hidden property="fristappralevel"/>
						    <html:hidden property="emendationlevel"/>
							...
							<tr>
								...
								<td>
									<html:textarea property="return_reason" styleId="return_reason" cols="50" rows="10"></html:textarea>
