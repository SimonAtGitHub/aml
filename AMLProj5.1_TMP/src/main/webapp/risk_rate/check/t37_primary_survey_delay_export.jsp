...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1381 style='border-collapse:
 ...
 <tr class=xl26 height=39 style='mso-height-source:userset;height:29.25pt'>
  <td colspan=7 height=39 class=xl28 width=1381 style='border-right:.5pt solid black;
  height:29.25pt;width:1038pt'>调查延期数据</td>
 </tr>
 <tr class=xl27 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td class=xl38 width=230 style='border-top:none;border-left:none;width:173pt'>所属机构</td>
  <td class=xl38 width=102 style='border-top:none;border-left:none;width:77pt'>开户日期</td>
  <td class=xl39 width=113 style='border-top:none;border-left:none;width:85pt'>识别日期</td>
  <td class=xl38 width=91 style='border-top:none;border-left:none;width:85pt'>识别柜员号</td>
  <td class=xl40 style='border-top:none;border-left:none'>识别柜员名</td>
 </tr>
 
 <logic:iterate id="result" name="tempList"  type="com.ist.aml.risk_rate.dto.T37_primary_survey_delayResult">
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td class=xl34 width=230 style='border-top:none;border-left:none;width:173pt'><bean:write name="result" property="organname" /></td>
  <td class=xl34 width=102 style='border-top:none;border-left:none;width:77pt'><bean:write name="result" property="create_dt" format='yyyy-MM-dd'/></td>
  <td class=xl34 width=113 style='border-top:none;border-left:none;width:85pt'><bean:write name="result" property="check_dt" format='yyyy-MM-dd'/></td>
  <td class=xl34 width=91 style='border-top:none;border-left:none;width:85pt'><bean:write name="result" property="checker" /></td>
  <td class=xl34 style='border-top:none;border-left:none'><bean:write name="result" property="check_realname" /></td>
 </tr>
 </logic:iterate>
