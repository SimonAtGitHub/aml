...
<BODY leftmargin=0 topmargin=0>
	<html:form method="post" action="/check/t37_helpcheck_attach_add.do" enctype="multipart/form-data">
		...
		<div id="main">
			...
			<div class="conditions">
				...
				<div class="cond_t">
					<span>评级意见附件管理</span>
					<span class="buttons">
					 <a href="#" onclick="dosubmit('t37_help_check_attachList.do')"><img src="../../images/<%=session.getAttribute("style") %>/b_back.png" />返 回</a>
					</span>
				</div>
				<html:errors />
				<div class="cond_c">
									...
									<tr>
										...
										<td align="right" bgcolor="ECF3FF">
											<input type=button value="上  传" name=Button23222
												class="in_button1"
												onClick="dosubmit('t37_help_check_attach_add_do.do','sub');">
										</td>
									</tr>
								</table>
							</TD>
