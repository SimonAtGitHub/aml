    	   ...
    	   if(!is_inRange(document.forms[0].organkey.value,1,128)){
	    	    ...
	    	    document.forms[0].apply_dt_start_disp.focus();
		 		errMsg = "请填写完整的起始时间范围！";
	   			...
	   			document.forms[0].apply_dt_start_disp.focus();
		 		errMsg = "开始时间不能大于结束时间！";		    
		   	} else if(getLength(trim(apply_reason))==0){
...
<body>
<html:form  method="post" action="/pbc/getT1q_pbc_apply_modify.do" >
  <div id='main'>
 <div class="conditions">
 <html:errors/>
  <!-- 标题区域 -->
	<div class='cond_t'>
          <span class="awp_title_td2"><strong>数据提取申请修改</strong></span>
			<span class="buttons">
         ...
         <div id="bigTab">
			<dl class="tabm">
             <dd class="tabcur">
               ...
               <dd id="ruledef">
					<span >
						<a href="javascript:void(0);" onclick="jumpTabPanel('getT1q_pbc_app_add_other_modify.do?tb_id=<bean:write  name='t1q_pbc_applyActionForm' property='tb_id' />',document.forms[0])">相关信息</a>
               </span>
				</dd>
				</dl>
        </div>
		<div class="cond_c2">
							...
							<img src="../../images/calendar.gif" id="img1"
								...
								onclick="new Calendar().show(document.forms[0].apply_dt_end_disp);">
									...
									<td bgcolor="F6F9FF">
										<html:text property="organkey" size="10" onblur="_Onblur('organName')" styleId="organkey"/>
									...
									<logic:equal value="2" name="t1q_pbc_applyActionForm"  property="apply_status">
									<tr>
									<td>退回原因：</td>
									<td>
									<html:textarea readonly='true' styleId="return_advi" property="return_advi"  cols="70" rows="10"  maxlength="124"></html:textarea>
									</td>
									</tr>
									</logic:equal>
									<tr>
							...
							<td  align="left" class="in_button">
								<input type=button value="保 存" name=Button52  onClick="dosubmit('getT1q_pbc_apply_modify_put.do');">
