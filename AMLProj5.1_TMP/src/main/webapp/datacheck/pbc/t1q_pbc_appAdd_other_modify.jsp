...
<body>
<html:form  method="post" action="/pbc/getT1q_pbc_app_modify.do" target="_self">
 <div id='main'>
 ...
 <html:errors/>
  ...
  <!-- 标题区域 -->
	<div class='cond_t'>
          <span><strong>数据提取申请修改</strong></span>
			<span class="buttons">
        ...
        <div id="bigTab">
			<dl class="tabm">
             <dd class="ruledef">
                 <span><a href="javascript:void(0);" onclick="jumpTabPanel('getT1q_pbc_apply_modify.do?tb_id=<bean:write  name='t1q_pbc_applyActionForm' property='tb_id' />',document.forms[0])">基本信息</a></span>
              </dd>
               <dd id="tabcur">
