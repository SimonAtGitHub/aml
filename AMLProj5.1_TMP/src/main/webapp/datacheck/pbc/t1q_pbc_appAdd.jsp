...
<SCRIPT language="JavaScript" src="../../js/load_window.js"></script>
 <script type="text/javascript" src="../../js/calendar.js"></script>
	...
	function is_inRange(formValue,mix,max){
     ...
     function intopage(){
    	 var organkey='<bean:write  name='t1q_pbc_applyActionForm' property='organkey' />';
         var apply_dt_start_disp='<bean:write  name='t1q_pbc_applyActionForm' property='apply_dt_start_disp' />';	 
    	 var apply_dt_end_disp='<bean:write  name='t1q_pbc_applyActionForm' property='apply_dt_end_disp' />';	 
    	 if(organkey=='' || apply_dt_start_disp == '' || apply_dt_end_disp== ''){
        	 alert("请先保存再选择'相关信息'!");
        	 return;
         }
    	 jumpTabPanel("getT1q_pbc_app_add_other.do",document.forms[0]);
     }
...
<html:form  method="post" action="/pbc/getT1q_pbc_app_add.do" >
 <div id='main'>
    	...
    	<div id="bigTab">
			<dl class="tabm">
             <dd class="tabcur">
               ...
               <dd id="ruledef">
					<span ><a  onclick="javascript:intopage()">相关信息</a></span>
				</dd>
			</dl>
        </div>
	<div class="cond_c2">
								  ...
								  <tr>
									...
									<td bgcolor="F6F9FF">
										<html:text property="organkey" size="10" onblur="_Onblur('organName')" styleId="organkey" readonly="true"/>
											<html:text property="organName" size="20" readonly="true" />&nbsp;
									...
									<td >
									<html:select  property="file_type" style="width:100px;" >
							...
							<td  align="left" class="in_button">
								<input type=button value="保 存" name=Button52  onClick="dosubmit('getT1q_pbc_app_add_save.do');">
