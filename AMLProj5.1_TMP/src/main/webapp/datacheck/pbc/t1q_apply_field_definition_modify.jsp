...
<body class="mainbg">
	<html:form method="post" action="/pbc/t1q_pbc_apply_conf_modify_save.do">
	<html:errors/>
	<div id="main">
<!-- conditions --> 
  <div class="conditions">
	...
	<div class="cond_t">
	  <span>设置字段</span>
	  <span class="buttons">
	   <a href="#" onclick="dosubmit('t1q_pbc_apply_conf_modify_save.do')"><img src="../../images/<%=session.getAttribute("style") %>/b_save.png" />保存</a>
