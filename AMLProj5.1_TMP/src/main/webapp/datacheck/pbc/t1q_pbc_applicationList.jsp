   ...
   obj.value="";
	...
	<body leftmargin="0" topmargin="0">
		<div id="main">
			...
			<html:form action="/pbc/getT1q_pbc_application.do" method="post">
			<html:errors/>
				<div class="conditions">
					<div class="cond_t">
						...
						<span class="buttons">
							...
							<a href="#" onclick="dosubmit('getT1q_pbc_app_add.do','add')"><img src="../../images/blue/b_add.png" />新增</a>
							<a href="#" onclick="dosubmit('getT1q_pbc_apply_modify.do','modify')"><img src="../../images/blue/b_edit.png" />修改</a>
							<a href="#" onclick="dosubmit('getT1q_pbc_app_delete.do','delete')"><img src="../../images/blue/b_delete.png" />删除</a>
							<a href="#" onclick="dosubmit('getT1q_pbc_app_submit.do','submit')"><img src="../../images/blue/b_export.png" />提交申请</a>
						</span>
					</div>
					<div class="cond_c" id="searchtable">
						<table border="0" cellspacing="0" cellpadding="0">
							...
							<input type="button" value="查 询" class="in_button1"
										onclick="dosubmit('<%=request.getContextPath()%>/datacheck/pbc/getT1q_pbc_application.do?newsearchflag=2','search');"/>
								</td>
							</tr>
						</table>
					</div>
					...
					<TABLE border=0 cellpadding="2" cellspacing="1">
						...
						<logic:iterate id="ta_pbc_apply" name="ta_pbc_applyList" indexId="i"
							...
							<TR align="center" class="interval"
								...
								<!-- <TD>
									<a href="#" onclick="window.open('getT1q_pbc_applyCheck.do?tb_id=<bean:write name="ta_pbc_apply" property="tb_id" />','enter2','height=400, width=600,left=100,top=100,scrollbars=yes,resizable=yes');" ><img src="../../images/blue/b_edit.png" />查看</a>	
								</TD> -->
							</TR>
						</logic:iterate>
					</TABLE>
