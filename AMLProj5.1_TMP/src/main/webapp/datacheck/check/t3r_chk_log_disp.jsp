...
function checkForm(theUrl){
 ...
 function dosubmit(theUrl){     
	...
	<BODY leftmargin="0" topmargin="0" class="mainbg">
		<html:form method="post" action="/check/t3r_chk_logDisp.do">
			<div id="main">
				<!-- conditions -->
					...
					<div class="cond_c2">
						<table border="0" cellpadding="0" cellspacing="0">
							...
							<TR align="center">
								...
								<TD bgcolor="F6F9FF">
									<div align="left">
									<bean:write name="log" property="logdt"/>
							</div>
								</TD>
							</TR>
							<TR align="center">
								...
								<TD bgcolor="F6F9FF">
									<div align="left">
											<bean:write name="log" property="create_user_disp"/>
									</div>
								</TD>
							</TR>
							<TR align="center">
								...
								<TD bgcolor="F6F9FF">
									<div align="left">
											<bean:write name="log" property="create_dt"/>
									</div>
								</TD>
							</TR>
							<TR align="center">
								...
								<TD bgcolor="F6F9FF">
									<div align="left">
											<bean:write name="log" property="create_org_disp"/>
									</div>
								</TD>
							</TR>
							...
							<TR align="center">
								...
								<TD bgcolor="F6F9FF"  >
									 <html:textarea cols="80" rows="5"  name="log"  property="log_des" readonly="true"></html:textarea>
								</TD>
							</TR>
						</table>
					</div>
