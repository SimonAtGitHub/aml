...
function checkForm(theUrl){
 ...
 function dosubmit(theUrl){     
	...
	<BODY leftmargin="0" topmargin="0" class="mainbg">
		<html:form method="post" action="/check/t3r_chk_qst_modify.do">
		...
		<html:hidden property="qstkey"/>
			<div id="main">
				...
				<div class="conditions">
					...
					<div class="cond_t">
						<span>问题修改</span>
						<span class="buttons"> <a href="#" onclick="dosubmit('t3r_chk_qstList.do');" ><img src="../../images/<%=session.getAttribute("style") %>/b_back.png"/>返回</a> </span>
					</div>
						...
						<tr>
							<td align="center">
										<input type="button" class="in_button1" value="提 交"
											onclick="checkForm('t3r_chk_qst_modify_do.do')" />
