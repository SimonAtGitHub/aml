...
<%--	    	else if(getLength(document.forms[0].fetchcmdpath.value)==0){--%>
<%--	    		errMsg+="卸载命令路径不能为空！";--%>
<%--	        	document.forms[0].fetchcmdpath.focus();--%>
<%--	    	}  --%>
	    	}
	    	else{
...
<%--		document.getElementById("jdbc_dblink").style.display = "";--%>
	...
	<BODY leftmargin="0" topmargin="0">
			...
			<html:form action="/hpom/t18_datasource_modify.do" method="POST">
			<div id='main'>
                <div class="conditions">
				    <!-- title -->
					<div class="cond_t">
					  <span>业务数据源设置 - 修改</span>
					  <span class="buttons">
					    <a href="javascript:void(0);" onClick="checkForm('t18_datasource_modify_do.do');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_save.png" />保 存</a>
				...
				<div class='cond_c2'>
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td>
								<html:text property="dskey" styleClass="text_white" size="30"  readonly="true"/>
							</td>
						</tr>
						<tr>
							<td noWrap>
						...
						<tr>
							...
							<td>
								<html:select property="flaglocation"    onchange="islocal_fun(this)" >
						...
						<tr id="jdbc_con" >
							...
							<td>
								...
								<br>
								数据库别名：
								<html:text property="serveralias" styleClass="text_white" size="30" />
								<br>
