...
<body >
	...
	<div class="cond_t">
	    ...
	    <span class="buttons">
          ...
          <a href="javascript:void(0);" onclick="locate_order_window('<%=request.getContextPath() %>','<%=request.getAttribute("keys") %>','<%=request.getAttribute("names") %>','t18_ods_fetch','tableename','fetchseq');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_sort.png" />调 序</a>
		  <a href="javascript:void(0);" onclick="dosubmit('t18_ods_fetch_deploy.do?isdeploy=1','deploy');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_edit.png" />部署生产</a>
		  <a href="javascript:void(0);" onclick="dosubmit('t18_ods_fetch_deploy.do?isdeploy=0','cancel');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_re_refused.png" />撤销部署</a>
		  <a href="javascript:void(0);" onclick="dosubmit('<%=request.getContextPath()%>/bmp/hpom/generate_script_db.do','generate');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_agencyinfo.png" />批量生成脚本</a>
		  <a href="javascript:void(0);" onclick="dosubmit('<%=request.getContextPath()%>/bmp/hpom/db_batch_download.do','batchdown');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_download.png" />批量下载</a>
		  <a href="javascript:void(0);" onclick="dosubmit('t18_ods_fetch_modify.do','modi');return false;"><img src="../../images/<%=session.getAttribute("style") %>/toolsicon03.gif" />手动修改</a>
	    </span>
	</div>
			...
			<logic:notEmpty name="t18_ods_fetchList">
				 <logic:iterate id="dto" name="t18_ods_fetchList"
					...
					<TR align="center" >
						...
						<TD noWrap>
							<a href="javascript:void(0);" onclick="dosubmit('<%=request.getContextPath()%>/bmp/hpom/db_batch_download.do?tableename=<bean:write name="dto" property="tableename" />','down');return false;">下载</a>
						</TD>
						<TD noWrap>
