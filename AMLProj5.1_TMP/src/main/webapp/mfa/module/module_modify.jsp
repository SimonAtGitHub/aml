...
function checkForm(theUrl){
  ...
  else if(getLength(document.forms[0].module_name.value)>100){
     errMsg+="模型名称长度过长！";
     document.forms[0].module_name.focus();
  }
...
<body class="mainbg">
<div id="main">
<html:form method="post" action="/module/module_modify_do.do">
    ...
    <div class="conditions">
        ...
        <table border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td>
             ...
             <html:text property="module_name"  size="15"/>
            </td>
          ...
          <tr> 
          	<td>模型描述和指引：</td>
            <td colspan="3"  >
              <html:textarea property="module_des" cols="70" styleId="module_des"  rows="4"></html:textarea>
            </td>
     ...
     <div class="list">
        <table border="0" cellpadding="0" cellspacing="0" id="tableid">
          ...
          <tr>
            <td align="center" colspan="4"><input name="" type="button" class="in_button1" value="提 交" onclick="checkForm('module_modify_do.do')" />
...
<SCRIPT LANGUAGE="JavaScript">
	 var val = document.forms[0].module_grey.value;
	 _onblur(val);
