...
validator={
	...
	mobile : /^0{0,1}(13[0-9]|15[3-9]|15[0-2]|18[0-9])[0-9]{8}$/,
...
validator.getDefultMsg=function(datatype)
	{
			...
			switch(datatype){
				case "require" : return "不能为空";
				case "email" : return "电子邮件地址格式错误"; 
				case "phone" : return "电话号码格式错误";
				case "mobile" : return "手机号码格式错误";
				case "url" : return "地址格式错误";
				case "idCard" : return  "身份证号码格式错误";
				case "currency" : return  "货币格式错误";
				case "number" : return  "请输入正整数";
				case "zip" : return  "邮政编码格式错误";
				case "ip" : return  "IP地址格式错误";
				case "qq" : return  "QQ号码格式错误";
				case "integer" : return  "请输入整数";
				case "double" : return  "请输入数字";
				case "english" : return  "只能输入英文字母";
				case "chinese" : return  "只能输入汉字";
				case "userName" : return  "只能输入数字及字母组合的字符串)"; 
				case "isSafe" : return  "不能包含! # < > ? * $ + - =@ % . * { } ( ) | \ / ~ ^等字符";
				case "limit_min" : return  "长度不能小于"+obj.attr('min');
				case "limit_max" : return  "长度不能大于"+obj.attr('max');
				case "limit" : return  "长度不能小于"+obj.attr('min')+"且不能大于"+obj.attr('max');
				case "limitB" : return  "请输入"+obj.attr('min')+"至"+obj.attr('max')+"位字符串";   
				case "date" : return  "日期格式错误";
				case "repeat" : return  "与上次输入的密码不同";
				case "range" : return  "请输入"+obj.attr('min')+"到"+obj.attr('max')+"之间的数字"; 
				case "compare" : return  "请输入"+obj.attr('compare')+"的数"; 
				case "group" : return "必须选中"+obj.attr('min')+"至"+obj.attr('max')+"个选项";		
				default: return '格式错误' ;				
				}
	}
