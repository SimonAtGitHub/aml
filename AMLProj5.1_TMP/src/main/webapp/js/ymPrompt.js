...
var eastxy={
		confirmWin:function(fuc){
			ymPrompt.confirmInfo('确定删除吗?',null,null,null,fuc);
		},
		succeedWin:function(fuc,msg){
			msg=msg==undefined?'操作成功':msg;
			ymPrompt.succeedInfo(msg,null,null,null,fuc);
		},errorInfo:function(fuc,msg){
			msg=msg==undefined?'操作失败':msg;
			ymPrompt.errorInfo(msg,null,null,null,fuc);
		},
		addSucceedWin:function(fuc,msg){
			msg=msg==undefined?'添加成功':msg;
			ymPrompt.succeedInfo(msg,null,null,null,fuc);
		},addErrorInfo:function(fuc,msg){
			msg=msg==undefined?'添加失败':msg;
			ymPrompt.errorInfo(msg,null,null,null,fuc);
		},
		updateSucceedWin:function(fuc,msg){
			msg=msg==undefined?'修改成功':msg;
			ymPrompt.succeedInfo(msg,null,null,null,fuc);
		},updateErrorInfo:function(fuc,msg){
			msg=msg==undefined?'修改失败':msg;
			ymPrompt.errorInfo(msg,null,null,null,fuc);
		}
}
		function cn(){
