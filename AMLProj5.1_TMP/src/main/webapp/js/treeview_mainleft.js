function TreeView(obj,target){
	...
	this.config={
                //root		:'img/web.gif',
                root		:'../images/top1.gif',
		//open		:'img/open.gif',
                open		:'../images/openfolder1.gif',
		//close		:'img/close.gif',
                close		:'../images/folder1.gif',
		//file		:'img/file.gif',
                file		:'../images/item9.gif',
		//join		:'img/T.gif',
                join		:'../images/T.gif',
