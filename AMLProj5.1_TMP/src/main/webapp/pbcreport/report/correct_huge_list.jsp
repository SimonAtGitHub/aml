...
function dosubmit(theUrl,type){
 ...
 if(type=='create'){
    	...
    	<bean:size id="len" name="t07_cbh_rbifList" />;
...
-->
	...
	<script type="text/javascript" src="../../js/calendar.js"></script>
		<html:form action="/report/correct_huge_list.do" method="post">
		<div id="main">
<!-- conditions --> 
  <div class="conditions">
    <!-- title -->
	<div class="cond_t">
						<span>纠错大额<%=com.ist.util.Constans.REPORT_NAME %> 
						</span>
					<span class="buttons">	 
							<a href="#" id="checkall" ><img src="../../images/<%=session.getAttribute("style") %>/b_checkall.png" />全选</a>
						 <a href="#" onclick="dosubmit('<%=request.getContextPath()%>/pbcreport/report/createPacket.do?url=<%=request.getContextPath()%>/pbcreport/report/correct_huge_list.do&packet_type_cd=S&create_type=0&interfacekey=BH','create')" >
						 <img src="../../images/<%=session.getAttribute("style") %>/b_generatec.png" />选择生成数据包</a>		
						<a href="#" onclick="dosubmit('<%=request.getContextPath()%>/pbcreport/report/createPacket2.do?url=<%=request.getContextPath()%>/pbcreport/report/correct_huge_list.do&packet_type_cd=S&pbc_msg_type_cd=<bean:write name="pbc_msg_type_cd" />&create_type=1&interfacekey=BH','all')"  >
	  ...
	  <table border="0" cellpadding="0" cellspacing="0" width="100%">
	   		...
	   		<td width="10%" colspan="1" class="in_button" >
										...
										<input type="button" name="button2" value="可疑" class="input"
											onClick="dosubmit('<%=request.getContextPath()%>/pbcreport/report/cbh_spc_list.do?newsearchflag=2&pbc_msg_type_cd=<bean:write name="pbc_msg_type_cd" />','change')"/>
									</td>
								...
								<tr bgcolor="ECF3FF">
									...
									<td bgcolor="F6F9FF">
										...
										<input type="button" name="button3" value="查 询" class="in_button1"
											onclick="dosubmit('<%=request.getContextPath()%>/pbcreport/report/correct_huge_list.do?newsearchflag=1','search')"/>
									</td>
								</tr>
   ...
   <table border="0" cellspacing="0" cellpadding="0">
				...
				<logic:iterate id="t07_cbh_rbif" name="t07_cbh_rbifList" indexId="i"
					type="com.ist.aml.pbcreport.dto.T07_cbh_rbif">
					<TR align="center" class="interval" onMouseOver="this.className='interval2'" onMouseOut="this.className='interval'">
						...
						<TD height=22>
							<html:multibox property="reportkeys">
								<bean:write name="t07_cbh_rbif" property="reportkey" />
							</html:multibox>
						</TD>
						...
						<TD>
							<bean:write name="t07_cbh_rbif" property="rinm" />
						</TD>
						<TD>
							<bean:write name="t07_cbh_rbif" property="ricd" />
						</TD>
						<TD>
							<bean:write name="t07_cbh_rbif" property="cpdt_disp" />
						</TD>
						<TD>
							<bean:write name="t07_cbh_rbif" property="tstn" />
						</TD>
						<TD>
							<bean:write name="t07_cbh_rbif" property="create_org_name" />
						</TD>
					
						<TD>
							<a
								href="#" onclick="window.open('<%=request.getContextPath()%>/pbcreport/report/preview.do?reportkey=<bean:write name="t07_cbh_rbif" property="reportkey" />&pbc_msg_type_cd=<bean:write name="pbc_msg_type_cd" />&interfacekey=BH','enter2','height=700, width=700,left=400,top=100,scrollbars=yes,resizable=no');">
								预览报文<bean:write name="t07_cbh_rbif" property="reportkey" /> </a>
						</TD>
