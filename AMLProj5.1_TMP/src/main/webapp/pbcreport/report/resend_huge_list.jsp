...
function _dosubmit(theUrl,type){
...
-->
	...
	<script type="text/javascript" src="../../js/calendar.js"></script>
		<html:form action="/report/resend_huge_list.do" method="post">
		<input type="hidden" value="0" name="fromcase"/>
		<div id="main">
<!-- conditions --> 
  <div class="conditions">
	...
	大额重报报告
    		...
    		<span class="buttons">				
						...
						<a href="#" onclick="_dosubmit('<%=request.getContextPath()%>/pbcreport/report/createSPacket.do?url=<%=request.getContextPath()%>/pbcreport/report/resend_huge_list.do?pbc_msg_type_cd=<bean:write name="pbc_msg_type_cd" />&create_type=0&interfacekey=BH','create')" >
						 <img src="../../images/<%=session.getAttribute("style") %>/b_generatec.png" />选择生成数据包</a>	
						 <logic:equal value="1" name="is_allPacket">
						   <a href="#" onclick="_dosubmit('<%=request.getContextPath()%>/pbcreport/report/make_resend_hugePacketDo.do','all')" >
						   <img src="../../images/<%=session.getAttribute("style") %>/b_generate.png" />全部生成数据包</a>	
						 </logic:equal>
						<logic:notEqual value="1" name="is_allPacket">
						<a href="#" onclick="_dosubmit('<%=request.getContextPath()%>/pbcreport/report/createSPacket1.do?url=<%=request.getContextPath()%>/pbcreport/report/resend_huge_list.do?pbc_msg_type_cd=<bean:write name="pbc_msg_type_cd"/>&create_type=1&interfacekey=BH','all')"  >
						<img src="../../images/<%=session.getAttribute("style") %>/b_generate.png" />全部生成数据包</a>
						</logic:notEqual>
					</span>
	   		...
	   		<td width="10%" colspan="1" class="in_button" >
		 			<input type="button" name="button1" value="大额"  disabled="disabled" />
										<input type="button" name="button2" value="可疑" class="input"
											onclick="_dosubmit('<%=request.getContextPath()%>/pbcreport/report/resend_spc_list.do?newsearchflag=2&pbc_msg_type_cd=<bean:write name="pbc_msg_type_cd" />','change')"/>
</td>
								...
								<tr bgcolor="ECF3FF">
									...
									<td bgcolor="F6F9FF">
										...
										<input type="button" name="button3" value="查 询" class="in_button1"
											onclick="_dosubmit('<%=request.getContextPath()%>/pbcreport/report/resend_huge_list.do?pbc_msg_type_cd=<bean:write name="pbc_msg_type_cd" />&newsearchflag=1','search')" />
									</td>
								</tr>
