...
<!-- conditions --> 
  <div class="conditions">
    <!-- title -->
	<div class="cond_t">
						<span>删除大额<%=com.ist.util.Constans.REPORT_NAME %></span>				 
	  ...
	  <table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr >
	   		                 <td >
										<input type="button" class="in_button1"  name="button1" value="大额"  disabled="disabled"/>
									</td>
									    <td align="center">
					...
					<logic:notEqual name="reported" value="1">
						...
						<td>
							<a
								...
								预览报文<bean:write name="t07_dbh_rbif" property="reportkey" /> </a>
						</td>
