...
<!-- home_process -->
  ...
  <div class="home_process">
   ...
   <table width="96%" border="0" cellpadding="0" cellspacing="0" id="pc_text" >
	  ...
	  <tr>
		...
		<td valign="middle" class="pc_butarrow"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="pc_k">
          <tr>
            ...
            <td width="10%" rowspan="2"><img src="../images/<%=session.getAttribute("style") %>/pc_arrow.gif" /></td>
            <td><span><%=StringUtils.null2String((String)map.get("73"))%></span></td>
          </tr>
         <tr>
           ...
           <logic:equal name="spost" value="0"><a href="#" onclick="_Open('detail_list.do?msg_type=7&post_id=2')">审核岗</a></logic:equal></td>
           ...
           <logic:equal name="ppost" value="0"><a href="#" onclick="_Open('detail_list.do?msg_type=7&post_id=3')">审批岗</a></logic:equal>
            </td>
          </tr>
        </table><td valign="middle"><img src="../images/<%=session.getAttribute("style") %>/pc_arrow.gif" /></td>
	  ...
	  <tr>
	    <td><div class="pc_k pc_textsmall"> 回执交易补录 <span><a href="#" onclick="_Open('detail_list.do?msg_type=4')"><%=StringUtils.null2String((String)map.get("4"))%></a></span><br/>
	      回执客户补录 <span><a href="#" onclick="_Open('detail_list.do?msg_type=5')"><%=StringUtils.null2String((String)map.get("5"))%></a></span><br/>
	      回执账户补录 <span><a href="#" onclick="_Open('detail_list.do?msg_type=6')"><%=StringUtils.null2String((String)map.get("6"))%></a></span><br/>
        </div></td>
	    <td valign="middle"><img src="../images/<%=session.getAttribute("style") %>/pc_arrow.gif" /></td>
	    <td valign="middle" class="pc_butarrow"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="pc_k">
          <tr>
            <td><span><a href="#" onclick="_Open('detail_list.do?msg_type=81')"><%=StringUtils.null2String((String)map.get("81"))%></a></span></td>
            <td width="10%" rowspan="2"><img src="../images/<%=session.getAttribute("style") %>/pc_arrow.gif" /></td>
            <td><span><%=StringUtils.null2String((String)map.get("83"))%></span></td>
          </tr>
          <tr>
           <td><a href="#" onclick="_Open('detail_list.do?msg_type=8&post_id=1')"><img src="../images/<%=session.getAttribute("style") %>/pc_edit.png" />编辑岗</a></td>
            <td><img src="../images/<%=session.getAttribute("style") %>/pc_approval.png" />
             <logic:equal name="ppost" value="1">
           <a href="<%=root%>/report/case/t07_flow_list.do">审批岗</a></logic:equal>
           <logic:equal name="ppost" value="0"><a href="#" onclick="_Open('detail_list.do?msg_type=8&post_id=3')">审批岗</a></logic:equal>
            </td>
          </tr>
        </table></td>
	    <td valign="middle"><img src="../images/<%=session.getAttribute("style") %>/pc_arrow.gif" /></td>
