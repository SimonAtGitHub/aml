...
function dosubmit(theUrl){
        //if(document.getElementById("party_id_s").value == ""){
           // alert("必须输入客户号进行查询！！");
          //  return false;
      //  }
	         ...
	         <html:text property="host_cust_id" styleClass="text_white"  size="12"/>
	          -->
									...
									<html:button property="button3" value="查 询"
										...
										onclick="dosubmit('t47_party_list.do?newsearchflag=1&type=search')" />
