...
function getOrgInfo(){
    window.parent.getOrgInfo(window.parent.hiddenFrame, orgkey.length, window.parent.document.all.list1, window.parent.document.all.list2);
}
</SCRIPT>
</head>
<body leftmargin="0" topmargin="0" onload="getOrgInfo()">
<html:form action="/common/organ_hiddenbyrigth.do" method="post">
