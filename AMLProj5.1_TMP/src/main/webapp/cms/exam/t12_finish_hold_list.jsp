		...
		<div id='content'>
			...
			<div class='awp_title'>
				...
				<table>
					<tr>
						<td width="23%" nowrap>
							<span class="awp_title_td2">已完成考试 - 列 表</span>
						</td>
						<td align="right">
					...
					<tr>
						...
						<td>
							   <input type="button" name="button" value="查 询"
								onClick="dosubmit1('t12_publish_finish_hold_list.do?newsearchflag=1','search')"
								class="input">
						</td>
					</tr>
				...
				<logic:iterate id="publish" name="t12_publish_questionnaireList"
							...
							<tr>
								...
								<td align="center" noWrap>
							 	...
							 	<td align="center" noWrap>
							 	  <input type="button" value="答题情况" name=Button2 class="input"  
								   	 onClick="dosubmit('<%=request.getContextPath() %>/cms/t12_finish_hold_sheet.do?publishKey=<bean:write name="publish" property="publishkey" scope="page" />')">
