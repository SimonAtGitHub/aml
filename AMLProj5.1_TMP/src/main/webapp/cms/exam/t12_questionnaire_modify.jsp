				...
				<div class='awp_title'>
					...
					<table>
						<tr>
							...
							<td width="23%" nowrap>
								<span class="awp_title_td2">问卷管理-问卷编制管理-修改</span>
							</td>
							<td align="right">
								<html:button property="Button55" value="创建单选题"
									onclick="newTimu('cms/t12_test_question_add.do?newsearchflag=1','1')"
									styleClass="input" />
								<html:button property="Button55" value="创建多选题"
									onclick="newTimu('cms/t12_test_question_add.do?newsearchflag=1','2')"
									styleClass="input" />
								<html:button property="Button55" value="创建填空题"
									onclick="newTimu('cms/t12_test_question_add.do?newsearchflag=1','3')"
									styleClass="input" />
								<html:button property="Button55" value="创建问答题"
						...
						<tr>
							...
							<td noWrap>
								<html:button property="Button52" styleClass="input"
									onclick="dosubmit('cms/t12_questionnaire_modify_do.do','modify')">保 存</html:button>
							</td>
						</tr>
					</table>
				</div>
						...
						<c:forEach items="${subjectList}" var="dto">
							<c:if test="${dto.subjecttype eq '1'}">
								...
								<tr>
									...
									<td nowrap>
										<a
											href="javaScript:updTimu('cms/t12_test_question_modify.do','<c:out value="${dto.subjectkey}" />','<c:out value="${dto.subjecttype}" />')">修改</a>&nbsp;
										<a
											href="javaScript:delTimu('cms/t12_questions_subject_delete_do.do','<c:out value="${dto.subjectkey}" />')">删除</a>
									</td>
								</tr>
