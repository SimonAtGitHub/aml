		 ...
		 <div class='awp_title'>
				...
				<table>
					<tr>
						...
						<td width="23%" nowrap>
							<span class="awp_title_td2">问卷管理-问卷编制管理-修改
		...
		<div class='awp_detail'>
  			<table id="subjectTable">
  				...
  				<c:forEach items="${subject.choiceList}" var="choice" varStatus="status">
  					<tr>
  						<td noWrap>
  							<input type="radio" name="add_choice_id" value="<c:out value="${choice.choicekey}" />" 
  							<c:if test="${subject.solution eq choice.choicekey }">
  				...
  				<tr>
  					<td noWrap> </td>
  					<td noWrap><html:button property="Button52" value="添加选项" onclick="addrow()"/>&nbsp;
