		...
		<div class='awp_detail'>
  			<table id="subjectTable">
  				<tr>
  					...
  					<td><html:textarea property="content" cols="40" rows="5"></html:textarea></td>
  				...
  				<c:choose>
  					...
  					<tr>
	  					...
	  					<td><html:text property="score" size="5" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="2"/></td> 
  					</tr>
  					</c:when>
  					<c:otherwise>
  				...
  				<tr>
  					...
  					<html:button property="Button52" value="保 存" onclick="dosubmit('cms/t12_test_question_add_do.do','add')"/></td> 
  				</tr>
  			</table>
  		</div> 
  	</html:form></div>
