		...
		<div class='awp_detail'>
  			<table id="subjectTable">
  				<tr>
  					...
  					<td><html:textarea property="content" rows="5" cols="40"></html:textarea>
  				...
  				<tr>
	  				...
	  				<td><html:text property="solution" size="30"/>
  				...
  				<tr>
  					 <td></td>
  					<td noWrap align="center" width="100%" colspan="3"><html:button property="Button52" value="保 存" onclick="dosubmit('cms/t12_test_question_modify_do.do','modify')"/></td> 
  				</tr>
  			</table>
  		</div> 
  	</html:form></div>
