...
<HTML>
	<HEAD>
	  ...
	  function locate_programa_window(obj){
		...
		var whole_path = '/awp/common/location_window_dynamic.do?localname=t12_programaLocation&issingle=radio&forms=forms[0]&localset=relevancetype,relevancetype_disp&newsearchflag=1';
	...
	<body>
		<div id='content'>
			<html:form method="post"
				action="/system_manager/t12_programa/t12_programa_table_copy.do">
				...
				<div class='awp_title'>
					...
					<table>
						<tr>
							<td width="23%" nowrap>
								<span class="awp_title_td2">栏目管理 - 数据表管理 - 复制现有数据表</span>
							</td>
							<td align="right">
								<input type="button" class="input" value="暂时保存"
									onclick="commitColumn('t12_programa_table_copy_save.do')"
									align="right">
								<input type="button" class="input" value="应 用"
									onclick="commitColumn('t12_programa_table_copy_do.do')"
									align="right">
								<input type="button" value="返 回" name="Button22322"
									class="input"
									onclick="awpDoSubmit('t12_programa_table.do','add')" />
				...
				<div class='awp_cond' id="searchtable">
					<table>
						...
						<tr>
							...
							<td>
								<html:text property="tablename" name="t12_programaActionForm"
							...
							<td>
								...
								<input type="text"
									value="<bean:write name="t12_programaActionForm" property="tablecode"/>"
									size="32" maxlength="32" disabled="disabled">
							</td>
						</tr>
				...
				<tr>
							<td>
								...
								<html:text property="selected_tablename" size="32" readonly="readonly"/>
								<input type="hidden" name="selected_tablecode">
							
								<input type="button" name="locate" value="选择已有数据表"
									class="text_white"
									onclick="locate_pop_window('<%=request.getContextPath()%>','t12_programa_table','radio','forms[0]','selected_tablecode,selected_tablename','');" />
								&nbsp;
								<input type="button" class="input" value="确定选择"
									onclick="awpDoSubmit('t12_programa_table_copy.do','save');return false;" align="right">
							</td>
							...
							<td  nowrap align="right">
								...
								<input type="hidden" name="selected_programakey" value="" />
				...
				<div class='awp_dynamic_list'>
					...
					<table id="tableid">
						...
						<logic:iterate id="col" name="t12_programa_default_colsList"
							...
							<td noWrap align="left">
							 ...
							 -->
								...
								<logic:equal name="col" property="isdefaultfield" value="0">
								   ...
								   <logic:notEqual value="1" name="col" property="isrelevance">
								...
								<td noWrap>
									...
									<logic:notEqual name="col" property="isrelevance" value="1">
										<span id="iscond">  
										<html:select name="col" property="iscond">
											<html:options collection="yesNoMap" property="label"
												labelProperty="value" />
								...
								<td noWrap><html:text name="col" property="dispseq" size="10"
										maxlength="10" />
								<br></td>
