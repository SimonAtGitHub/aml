...
<link  href="<%=request.getContextPath()%>/skin/<%=style %>/css/awp_base.css" rel="stylesheet" type="text/css">
	...
	<BODY>
	<div id='content'>
		<html:form method="post" action="/system_manager/t12_ca_programa/t12_ca_programa_list_n.do">
								...
								<tr>
									...
									<td>
										<input type="button" name="button" value="查 询"
											onClick="awpDoSubmit('t12_ca_programa_list_n.do?newsearchflag=1','search')"
											class="input">
									</td>
								</tr>
							</TABLE>
