...
<body>
	<div id='content'>
		<html:form method="POST"
			action="/system_manager/t12_se_file_path/t12_se_file_path_modify.do">
			<div class='awp_title'>

				<table>
					<tr>
						<td width="23%" nowrap>
							<span class="awp_title_td2">文件搜索定义 - 修 改 </span>
						</td>
						<td align="right">
			...
			<div class='awp_detail'>
				<TABLE>
					...
					<tr>
						...
						<td>
							<html:text property="path" size="64"></html:text>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							...
							<html:text property="filter" size="64"></html:text>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<input type="hidden" name="id"
								value="<bean:write property="id" name="t12_se_file_pathActionForm"/>" />
						</td>
						<td>
							<html:button property="button" value="提  交" styleClass="input"
								onclick="checkForm('t12_se_file_path_modify_do.do')" />
