 	  ...
 	  <html:hidden property="parmkey"/> 
 		<div class="conditions">	
	 		<div class='cond_t'>
	 		     <span>指标管理 - 修 改</span>
	 		     <span class="buttons">
	 		       <a href="javascript:void(0);" onClick="checkForm('t09_page_in_parm_modify_do.do');return false;"><img src="../../images/<%=session.getAttribute("style") %>/b_save.png" />保 存</a>
								...
								<tr   style="display:none" id="user_sel_2">
									...
									<td bgcolor="F6F9FF">
                                        ...
                                        <a href="#" onclick="locate_dict_window('<%=request.getContextPath()%>','location','targetcde,targetcde_disp');" ><span class="cond_buttons"><img
													src="../../images/blue/b_location.png"/>定位</span> </a>									</td>
								</tr>
