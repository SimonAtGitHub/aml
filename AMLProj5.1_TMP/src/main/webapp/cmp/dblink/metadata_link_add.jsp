...
<HEAD>
		...
		<link id="skincss" href="../../css/aml_<bean:write name="style"/>.css" rel="stylesheet" type="text/css" />
...
<body leftmargin="0" topmargin="0">
	<html:form action="/dblink/metadata_link_add_do.do" method="POST">
		<div id="main">
			<!-- conditions --> 
						...
						<tr >
							...
							<td >
								<html:button property="button" styleClass="in_button1" value="提  交"
									onclick="checkForm('metadata_link_add_do.do')" />
