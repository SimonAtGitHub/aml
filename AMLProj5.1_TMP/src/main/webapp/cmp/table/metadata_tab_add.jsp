...
<script type="text/javascript" src="../../js/aml.js"></script>
	...
	function checkForm(theUrl){
	    ...
	    else if(getLength(document.forms[0].tableename.value)==0){
		        errMsg+="表英文名不能为空！";
...
<div id='content'>
	<html:form action="/table/metadata_tab_add_do.do" method="POST">
	<input type="hidden" name="objtype"/>
	<input type="hidden" name="tabschema"/>
	<div class="conditions">
            <div class="cond_t">
               <span>元数据管理- 新建表信息</span>
			   <span class="buttons">
		...
		<div class="cond_c2">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
								...
								<td >
									<bean:write name="categorykey_disp"/>
								</td>
							</tr>
						...
						<tr >
							...
							<tr >
								...
								<td >
								<html:textarea property="des" rows="4" cols="60" styleClass="text_white"/>
							...
							<tr >
								...
								<td >
									<html:button property="button" styleClass="in_button1" value="提  交"
										onclick="checkForm('metadata_tab_add_do.do')" />
