	...
	<HEAD>
		...
		function caltypeChange(selObj)
		{
			...
			}else if(selObj.value=='1')
			{
				...
				+"<td align='left'><input type='text' name='elementname' size='50' maxlength='200' /><input type='hidden' name='elementkey' value='' /></tr>"			
			...
			}else if(selObj.value=='2')
			{
				...
				+"<td align='left'><input type='hidden' name='elementkey' value='' /><input type='hidden' name='indickey' value='' /><input type='hidden' name='valnum' value='0' />"
			...
			}else if(selObj.value=='3')
			{
				...
				+"	  <td align='left'><select name='is_audit'><option value='1' selected='selected'>是</option>"
				+"	  <option value='0' >否</option></select></td></tr>"
				+"<input type='hidden' name='is_sum' value='1' /><input type='hidden' name='base_score' value='0' /><input type='hidden' name='riskcaltype' value='' /><input type='hidden' name='randomChar' value='' /></td></tr>"				
			...
			}else if(selObj.value=='5')
			{
				...
				+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"					
				+"<font color='red'>*</font><a href='#' title='编辑要点区间' onclick=\"editRange('"+randomChar8+"')\"><img src='../../images/<%=session.getAttribute("style")%>/b_add.png' />编辑要点区间</a></td></tr>"
				+"<tr><td align='right'>是否允许调整</td>"
				+"	  <td align='left' colspan='3'><select name='is_audit'><option value='1' selected='selected'>是</option>"
				+"	  <option value='0' >否</option></select></td></tr>"			
				+"<tr><td align='right'>描述</td>"
		...
		<html:form action="/t31_def_element/t31_def_element_add.do"
			...
			<div id="main">
				...
				<div class="conditions">
					<!-- title -->
					<div class="cond_t">
						<span>积分评级模板 - 修改风险要点</span><span class="buttons"><strong>是否最后一层：是</strong>
						<html:hidden  property="is_last"/>
							</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<strong>计算方式：</strong><html:select  property="js_type" >
									<html:options collection="js_typeMap" property="label"
											labelProperty="value" />
									</html:select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<a href="javascript:void(0);" onclick="addRow();"><img
									src="../../images/blue/b_add2.png" />增加要点</a> <a
							href="###"
							onclick="dosubmit('t31_def_element_modify_do.do');"><img
					...
					<div class="list">
						<table border="0" cellpadding="0" cellspacing="0" id="tab">
							...
							<logic:iterate id="t31_def_element" name="t31_def_elementList" type="com.ist.aml.newrisk.dto.T31_def_element" scope="request" >
							<tr>
							<td>
									<bean:write name="t31_def_element"  property="caltype_disp"/>
									<html:hidden  name="t31_def_element" property="caltype" />
							</td>
							<td>
								<table>
									
										<logic:equal name="t31_def_element" property="caltype" value="1" scope="page">
												<tr>
													<td align='right'>
														<font color='red'>*</font>指标编码
													</td>
													<td align='left'>														
														<html:text name="t31_def_element"  property='indickey'  readonly="true" />
														<a href='#' title='选择' 
														onclick="selectElement(this.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.rowIndex);">
														<img src='../../images/<%=session.getAttribute("style")%>/b_add.png' />选择</a>
													</td>
													<td align='right'>
														<font color='red'>*</font>风险要素名称
													</td>
													<td align='left'>
														<html:hidden name="t31_def_element"  property='elementkey'  />												
														<html:text name="t31_def_element"  property='elementname' size='50'  maxlength='200' />
														
													</td>
												</tr>
												<tr>
													<td align='right'>
														<font color='red'>*</font>指标顺序
													</td>
													<td align='left'>
														<html:text name="t31_def_element" property='valnum' size='20' maxlength='2' />
													</td>
													<td align='right'>
														权重（%）
													</td>
													<td align='left'>
														<html:text  name="t31_def_element"  property='base_occ' size='20'  maxlength='7' />														
														<html:hidden  name="t31_def_element"  property='riskcaltype'  />
														<input type='hidden' name='randomChar' value='' />
													</td>
												</tr>
												<tr>
													<td align='right'>
														<font color='red'>*</font>基准分值
													</td>
													<td align='left'>
														<html:text  name="t31_def_element"  property='base_score' size='20' maxlength='11' />
													</td>
													<td align='right'>
														累计方式
													</td>
													<td align='left'>
														<html:select name="t31_def_element" property='is_sum'>
												...
												<tr>
													<td align='right'>
														<font color='red'>*</font>子项分值
													</td>
													<td align='left'>
														<html:text name="t31_def_element"  property='element_score' size='20'	maxlength='7' />														
													</td>
													<td align='right'>
														是否允许调整
													</td>
													<td align='left'>
														<html:select name="t31_def_element" property='is_audit'>
															<html:options collection="is_auditMap" property="label" labelProperty="value" />
														</html:select>
													</td>
												</tr>
												<tr>
													...
													<td align='left' colspan='3'>
														<html:textarea name="t31_def_element" property="des"  rows='2' cols='50' maxlength='1000'></html:textarea>
													</td>
												</tr>
											</logic:equal>
									<logic:equal name="t31_def_element" property="caltype" value="2" scope="page">
												<tr>
													<td align='right'>
														<font color='red'>*</font>风险要素名称
													</td>
													<td align='left'>
														<html:hidden name="t31_def_element"  property='elementkey'  />
														<html:hidden name="t31_def_element"  property='indickey'  />
														<html:hidden name="t31_def_element"  property='valnum' />
													...
													<td align='left'>
														<html:text name="t31_def_element"  property='base_occ' size='20'
															maxlength='7' />
													</td>
												</tr>
												<tr>
													...
													<td align='left'>
														<html:text name="t31_def_element"  property='element_score' size='20'	maxlength='7' />
														<html:hidden name="t31_def_element"  property='is_sum' />
														<html:hidden name="t31_def_element"  property='base_score'/>
														<input type='hidden' name='randomChar' value='' />
													</td>
													<td align='right'>
														风险事件算法
													...
													<td align='left'>
														<html:select name="t31_def_element"  property='riskcaltype'>
											...
											<logic:equal name="t31_def_element" property="caltype" value="3" scope="page">
												<tr>
													<td align='right'>
														<font color='red'>*</font>风险要素名称
													</td>
										...
										<logic:equal name="t31_def_element" property="caltype" value="4" scope="page">
												<tr>
													<td align='right'>
														<font color='red'>*</font>指标编码
													</td>
									...
									<logic:equal name="t31_def_element" property="caltype" value="5" scope="page">
												<tr>
													<td align='right'>
														<font color='red'>*</font>指标编码
													</td>
												...
												<tr>
													...
													<td align='left'>
														...
														<html:hidden  name="t31_def_element"  property='riskcaltype'  />
														<html:hidden  name="t31_def_element"  property='base_score'  />														
														<input type='hidden' name='randomChar' value='<bean:write name="t31_def_element"  property='elementkey' />' />
													</td>
												</tr>
												...
												<td align='right'>
													...
													<td align='left'>
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;												
												<font color='red'>*</font><a href='#' title='编辑要点区间'  onclick="editRange('<bean:write name="t31_def_element"  property='elementkey' />')"><img 
