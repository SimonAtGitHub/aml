...
String url=request.getContextPath()+"/newrisk/result/result_modify.do?resulekeys="+templatekey+",";
%>
...
<logic:iterate id="attach" name="t37_risk_attachList" type="com.ist.aml.newrisk.dto.T37_risk_attach">
