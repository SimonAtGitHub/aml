...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1381 style='border-collapse:
 ...
 <tr class=xl27 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td height=30 class=xl32 width=105 style='height:22.5pt;width:79pt'>客户号</td>
  <td class=xl33 width=140 style='width:105pt'>客户名称</td>
  ...
  <td class=xl38 width=146 style='border-top:none;border-left:none;width:110pt'>最终风险等级</td>
  <td class=xl38 width=125 style='border-top:none;border-left:none;width:94pt'>模板类型</td>
  <td class=xl38 width=91 style='border-top:none;border-left:none;width:68pt'>评级日期</td>
  <td class=xl40 style='border-top:none;border-left:none'>人工调整日期</td>
  <td class=xl40 style='border-top:none;border-left:none'>开户日期</td>
 </tr>
 
 <logic:iterate id="result" name="tempList"  type="com.ist.aml.newrisk.dto.T37_party_result_uh">
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
   <td height=30 class=xl34 width=105 style='height:22.5pt;width:79pt'><bean:write name="result" property="party_id" /></td>
  <td class=xl34 width=140 style='border-left:none;width:105pt'><bean:write name="result" property="party_chn_name" /></td>
  ...
  <td class=xl34 width=91 style='border-top:none;border-left:none;width:68pt'><bean:write name="result" property="statistic_dt_disp" /></td>
  <td class=xl39 width=111 style='border-top:none;border-left:none;width:83pt'><bean:write name="result" property="modifydate_disp" /></td>
