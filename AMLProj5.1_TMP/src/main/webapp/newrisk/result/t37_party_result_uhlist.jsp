								...
								<tr align="center">
									<td >
									 <logic:equal name="result" property="temptype" value="1">
										<a href="#" onclick="dosubmit('<%=request.getContextPath()%>/newrisk/result/t37_party_jf_result_uhDisp.do?resulekey=<%=resulekey %>&organkey=<bean:write name="result" property="organkey" />')"><img src="../../images/<%=session.getAttribute("style")%>/b_caseinfo.png" title="评级信息" /></a>
									 </logic:equal>
								    <logic:equal name="result" property="temptype" value="2">
									    <a href="#" onclick="dosubmit('<%=request.getContextPath()%>/newrisk/result/t37_party_gs_result_uhDisp.do?resulekey=<%=resulekey %>&statistic_dt_disp=<bean:write name="result" property="statistic_dt_disp" />&organkey=<bean:write name="result" property="organkey" />')"><img src="../../images/<%=session.getAttribute("style")%>/b_caseinfo.png" title="评级信息" /></a>
									</logic:equal>
									</td>
									<td nowrap>
