...
function dosubmit(theUrl,type){
   ...
   else if(type=='all')
   {
    ...
    <bean:size id="len" name="tempList" />
   ...
   if(type=='search'){
   		if(!_compareTwoDateForString(document.forms[0].modifydate_disp.value, document.forms[0].modifydate_disp_end.value))
   		{
    		errMsg = "开始时间不能大于结束时间";	
    	}
...
<BODY leftmargin="0" topmargin="0">
	<html:form action="/result/t37_party_result_list2.do" method="post">
	<input type="hidden" name="backurl" value="t37_party_result_list2.do?marked=<bean:write name="marked"/>"/>
		<div id="main">
				<!-- conditions -->
			<div class="conditions">
				...
				<div class="cond_t">
					<span>
						<logic:equal name="marked" value="0">当前评级结果</logic:equal>
						<logic:equal name="marked" value="1">历史评级结果</logic:equal>
					</span>
					<span class="buttons">
						<a href="#" id="hdd_display" class="bt_hidden"></a>
						
						<a href="#" onclick="dosubmit('t37_party_result2_export.do?type=select','export')" />
						<img src="../../images/<%=session.getAttribute("style") %>/b_export.png" />导出客户风险信息</a>
						<a href="#" onclick="dosubmit('t37_party_result2_exportall.do?type=all','all')" />
                            ...
                            <tr >
								...
								<td width="37%" >
									...
									<input type="button" value="查  询" name=Button522
										onClick="dosubmit('t37_party_result_list2.do?newsearchflag=1&marked=<bean:write name="marked"/>','search')"
										class="in_button1">
								</td>
							</tr>
						</table>
						...
						<logic:present name="tempList">
							<logic:iterate id="result" name="tempList"
								...
								<tr align="center" bgcolor="#FFFFFF">
									...
									<td>
							             <bean:write name="result" property="modify_cd_disp" />
									</td>
									<td>
