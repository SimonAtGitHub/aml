...
<html:form method="post" action="/t31_def_gs/t31_def_gs_modify.do">
  		...
  		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="left" width="10%">
					<div align="right">
						<font color="red">*</font>公式编号：
					</div>
				</td>
				<td width="40%">
					<html:text property="gskey" styleClass="text_white" size="20" readonly="true" />
					<html:img border="0" page="../../images/lock.jpg" align="absmiddle" alt="内容不允许修 改"></html:img>
				</td>
				<td bgcolor="F6F9FF" align="left" width="10%">
					<div align="right">
						<font color="red">*</font>公式名称：
					</div>
				</td>
				<td width="40%"><html:text property="gsname" styleClass="text_white" size="40" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><html:text property="calseq_str" styleClass="text_white" size="20" /></td>
				<td>是否启用：</td>
			...
			<tr>
				...
				<td>值编号：</td>
				<td><html:text property="valnum" styleClass="text_white" size="20" /></td>
			</tr>
			...
			<tr>
				...
				<td id="valtitle"><div align="right"><font color="red">*</font>参数值：</div></td>
				<td id="single" style="display:none" ><html:text property="valparamin" styleClass="text_white" size="20" /></td>
				<td id="double" style="display:none" align="left"><html:text property="valparamin1" styleClass="text_white" />-<html:text property="valparamax" styleClass="text_white" /></td>
			...
			<tr>
				...
				<td align="right" colspan="3">
					<input type="button" name="button1" class="in_button1" value="提 交" onclick="checkForm('t31_def_gs_modify_do.do')" />
