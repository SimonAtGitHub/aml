...
<div id="main">
   <div class="conditions">
    <!-- title -->
	<div class="cond_t">
	  <span> 新增<logic:equal name="temptype" value="1">积分评级模板</logic:equal>
				 <logic:equal name="temptype" value="2">公式评级模板</logic:equal>
	  </span>
        <span class="buttons">
	...
	<div class="cond_c2">
  		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td bgcolor="F6F9FF" align="left">
					<div align="right"><font color="red">*</font>是否覆盖：</div>
				</td>
				<td>
			...
			<tr>
				...
				<td align="right" colspan="3">
					<input type="button" name="button1" class="in_button1" value="提 交" onclick="checkForm('t31_def_temp_add_do.do')" />
