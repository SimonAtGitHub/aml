...
<body leftmargin="0" topmargin="0"  class="mainbg" >
		<html:form action="/t31_def_temp/t31_def_temp_main_modify.do" method="post">
			<div id="main">
				<!-- conditions -->
				<html:errors/>
				<!-- 大选项卡开始 -->
		...
		<div id="bigTab">
			<dl class="tabm">
				<dd class="tabcur">
					<span><a  target="t21_rule" href="<%=request.getContextPath()%>/newrisk/t31_def_temp/t31_def_temp_modify.do?templatekey=<bean:write name="t31_def_tempActionForm" property="templatekey" />&temptype=<bean:write name="t31_def_tempActionForm" property="temptype" />" class="bglink">基本属性</a></span>
				</dd>
				<dd>
		...
		<iframe src="<%=request.getContextPath()%>/newrisk/t31_def_temp/t31_def_temp_modify.do?templatekey=<bean:write name="t31_def_tempActionForm" property="templatekey" />&temptype=<bean:write name="t31_def_tempActionForm" property="temptype" />" width="100%" height="450" scrolling="auto" frameborder="0" name="t21_rule" id="t21_rule"></iframe>
