...
<html>
	<head>
		...
		<title><c:out value="${t02_tp_bas_inf.tplaname}" escapeXml="false"></c:out></title>
					 ...
					 <table>
					  ...
					  <logic:iterate id="show" name="showList" type="com.ist.avp.template.dto.T02_tp_show">
					  	...
					  	<c:if test="${show.showkey ne currshowkey}">
					  		<td width="80"><a href="javascript:void(0);" onClick="javascript:avpCondSubmit('tpla_chk_main.do?new_qry_flag=1&jump_rslt_flag=1&showkey=<c:out value="${show.showkey}"/>');return false;"><c:out value="${show.showname}" /></a></td>
					 	</c:if>
					  </logic:iterate>
					  </c:if>
					  </tr>
				...
				<div class="awp_msgtab">
				  <table>
					<tr> 
				        ...
				        <c:out value="${t02_tp_bas_inf.fundes}" escapeXml="false"></c:out></p>
				        </td>
			        </tr>
			      </table>
			    </div>
