...
<div class='awp_title'>
				<table>
					<tr>
						<td width="23%">
							<span class="awp_title_td2">后台执行- 查证模型
							</span>
						</td>
						<td align="right">
							...
							<input type="button" name="btsearch2" value="删 除"
									onclick="dosubmit('<%=request.getContextPath() %>/avp/template/tpla_backexec_deleteDo.do?newsearchflag=1&back=1', 'del')" />		
					</tr>
				</table>
			</div>      
  ...
  <table>
								...
								<tr >		
								       <td >
										...
										<td > <input type="button" name="button11" value="查 询" onClick="dosubmit('<%=request.getContextPath() %>/avp/template/tpla_backexec_list.do?newsearchflag=1','search')" ></td>
								</tr>
