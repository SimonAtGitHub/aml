...
function chgInParmTree1(){
 ...
 <BODY>
 <div id="content">
 <html:form method="post" action="/template/t02_tp_in_parm_add.do">
 	...
 	<div class='awp_title'>
				<table>
					<tr>
						...
						<td width="23%" nowrap>
							<span class="awp_title_td2">模板管理 - 查询参数 - 修改输入参数</span>
						</td>
						<td align="right">
							<input type=button value="保 存" onClick="checkForm('t02_tp_in_parm_modify_do.do');">
	      		<input type=button value="返 回" name=Button223  onClick="dosubmit('t02_tp_in_parm_list.do');">&nbsp;</td>
					</tr>
				</table>
			</div>   
