...
<link  href="<%=request.getContextPath()%>/skin/<%=style %>/css/awp_base.css" rel="stylesheet" type="text/css">
	...
	<BODY>
	  <div id="content">
		<html:form method="post" action="/template/tpla_stat_cond.do">
			<div class='awp_title'>
				<table>
					<tr>
						...
						<td align="right">
							<c:out value="${closeButtonHtml}" escapeXml="false"/>&nbsp;</td>
					</tr>
				</table>
			</div> 
				...
				<table>
					...
					<tr>
						...
						<td width="250" align='center'>
							<select name="stat_disp" style="{width:250px}" size="15"
								multiple="multiple"
					...
					<tr>
						...
						<td width="250" align='center'>
							<select name="grp_disp" style="{width:250px}" size="15"
								multiple="multiple" 
					...
					<tr>
						...
						<td align="left" colspan=4>
							...
							<input type="button" value="提 交"
								onClick="doSubmit('tpla_stat_rslt.do')">

							<input type="button" value="重 选"
								onClick="avpJumpSubmit('tpla_stat_cond.do')">
						</td>
					</tr>
				</table>
			</div>
