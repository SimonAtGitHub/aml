...
<body>
	<!-- 系统总体框架，占页面宽度的98％ -->
	<div id='content'>
		<html:form method="post" action="/template/t02_tp_show_add.do">
			<html:hidden property="tplakey"/>
			<!-- 标题区域 -->
			<div class='awp_title'>
				<table>
					<tr>
						<td width="23%" nowrap><span class="awp_title_td2">定义图表展现 -- 新建</span></td>
						<td align="right">
			...
			<div class='awp_detail'>
				<table>
					...
					<tr>
				    	<td></td>
						<td  align="center">
						<input type="button"  value="保 存" class="botton" onClick="dosubmit('t02_tp_show_add_do.do','save')">
