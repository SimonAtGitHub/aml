...
<link  href="<%=request.getContextPath()%>/skin/<%=style %>/css/awp_base.css" rel="stylesheet" type="text/css">
 ...
 <html:form method="post" action="/template/t02_tp_in_parm_add.do">
		...
		<html:hidden property="parmkey" name="t02_tp_in_parmActionForm"/>
...
<div class='awp_title'>
				<table>
					<tr>
						...
						<td width="23%" nowrap>
							<span class="awp_title_td2">模板管理 - 查询参数 - 添加输入参数</span>
						</td>
						<td align="right">
							<input type=button value="保 存" name=Button223  onClick="checkForm('t02_tp_in_parm_add_do.do');">
