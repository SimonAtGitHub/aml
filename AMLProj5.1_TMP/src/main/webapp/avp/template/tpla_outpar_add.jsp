...
function checkForm(theUrl){
	...
	<BODY leftmargin="0" topmargin="0">
			...
			<html:form method="post" action="/template/t02_tp_disp_rst_list.do">
				...
				<table>
					<tr>
						...
						<td width="23%" nowrap>
							<span class="awp_title_td2">模板管理 - 调整输出结果 - 新 建</span>
						</td>
						<td align="right">
							<input type=button value="保 存" onClick="checkForm('t02_tp_disp_rst_add_do.do')">
							...
							<td >
								<html:select property="align" style="width:160">
									<html:options collection="alignMap" property="label"
										style="width:160" labelProperty="value" />
								</html:select>
							</td>
						</tr>
						<tr >
		...
		<script type="text/javascript">
		   chgInParmType('datasrc','outcolkey','outcont');chgInParmType1('iscdchg','dictcd');
		   document.forms[0].dispname.focus(); 
		</script>
	</BODY>
</HTML>
