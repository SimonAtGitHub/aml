...
function reback(aimName1,aimName2){
	...
	<div id="content">
		<html:form method="post" action="/template/t02_tp_exec_rst_add.do">
			...
			<html:hidden property="outcolkey" />
			<div class='awp_title'>
				<table>
					<tr>
						<td width="23%" nowrap><span class="awp_title_td2">模型管理 - 定义复杂列 - 修改</span></td>
						<td align="right">
							 <input type=button value="保 存" name=Button52 class="input"
							onClick="dosubmit('t02_tp_exec_rst_modify_do.do','sub')">
			...
			<div class="awp_detail">	
					<table>
								<tr >
									...
									<td >
										<html:text size="28" property="outcolname"
								...
								<tr >
									...
									<td>
										<html:textarea readonly="false"  property="pseudocode"
											cols="80" rows="10" styleClass="text_white"></html:textarea>
										<html:textarea style="display:none" readonly="false" 
											property="outcolcd" cols="80" rows="10"
