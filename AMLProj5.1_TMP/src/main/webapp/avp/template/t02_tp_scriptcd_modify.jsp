...
<html>
 ...
 <script language="JavaScript">
  <!--
  	function validateForm() {
    	...
    	awpDoSubmit('modifyT02_tp_scriptcdDo.do')
  	}
 ...
 <body>
  <!-- 系统总体框架，占页面宽度的98％ -->
  <div id='content'>
   <html:form action="/template/modifyT02_tp_scriptcd.do" method="post">
   <!-- 标题区域 -->
   <div class='awp_title'>
				<table>
					<tr>
						
						<td width="23%" nowrap><span class="awp_title_td2"><c:out value="${t02_tp_bas_infActionForm.tplaname}" /> - 模型脚本代码</span></td>
						<td align="right">
