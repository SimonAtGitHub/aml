...
<body>
	<!-- 系统总体框架，占页面宽度的98％ -->
	<div id='content'>
		<html:form method="post" action="/template/t02_tp_chart_add.do">
			<html:hidden property="tplakey"/>
			<!-- 标题区域 -->
			<div class='awp_title'>
				<table>
					<tr>
						<td width="23%" nowrap><span class="awp_title_td2"><c:out value="${labelStr}"></c:out> - 新建图形条件</span></td>
						<td align="right">
...
<%--						<input type="button" name="button" value="查看图形" onClick="showChart('<%=request.getContextPath()%>')"> --%>
						<input type="button"  value="保 存" class="botton" onClick="dosubmit('t02_tp_chart_add_do.do','save')">
