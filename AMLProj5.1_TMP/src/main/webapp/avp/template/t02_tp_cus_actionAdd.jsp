...
<html>
	<head>
		...
		<script type="text/javascript">
			function addDo() {
				if (checkform()) {
					awpDoSubmit('t02_tp_cus_action_add_do.do');
				}
			}
		</script>
	</head>
			...
			<html:form method="post" action="/template/t02_tp_cus_action_add.do">
				...
				<table>
					<tr>
						...
						<td align="right">
							<input type="button" value="保 存" onClick="addDo()">
							<input type="button" value="返 回" onClick="awpDoSubmit('t02_tp_cus_action_list.do')"> </td>
					</tr>
				</table>
			</div>      
			...
			<div class="awp_msgtab">
			  <table>
		        ...
		        <td ><p><strong>系统提示：</strong><br>
		           &nbsp;&nbsp;动作脚本的方法名称不能修改，必须要有返回值，返回值类型为Boolean。<br>
		        </td>
		        </tr>
		      </table>
		    </div>
