...
<html>
  ...
  <body>
 	<!-- 系统总体框架，占页面宽度的98％ -->
    <div id='content'>
      <html:form method="post" action="/search/t02_srch_info_add.do">
	    ...
	    <div class='awp_title'>
	      <table>
	        <tr>
	        	<td width="23%"><span class="awp_title_td2">定义跳转模型</span></td>
		      	<td align="right">
		            <input type="button" name="Submit1" value="保 存" onClick="checkForm('t02_srch_info_add_do.do');">
		            <input type="button" name="return" value="返 回" onClick="awpDoSubmit('t02_srch_info_list.do');">
			        &nbsp;
	          </td>
	        </tr>
	      </table>
 	    ...
 	    <div class='awp_detail'>
  	      <table>
              ...
              <td nowrap="nowrap" colspan="3">
                <html:text property="srchname" minlength="1" maxlength="64" warning="搜索名称"/>（最多32个汉字）
			  </td>
	   	    </tr>
	   	    <tr>
                ...
                <html:text property="tplaname" readonly="true" minlength="1" warning="模型名称" />
				 ...
				 onClick="locate_pop_window('<%=request.getContextPath()%>','t02_TemplateLocation','radio','forms[0]','tplakey,tplaname','tplastat=\'1\'');" />
			    （单选）
              </td>
            </tr>
	   	    <tr> 
