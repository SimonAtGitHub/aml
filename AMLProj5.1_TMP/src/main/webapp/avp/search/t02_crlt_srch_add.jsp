...
<html>
  <head>
	...
	<body>
		<!-- 系统总体框架，占页面宽度的98％ -->
		<div id='content'>
			<html:form method="post" action="/search/t02_crlt_srch_add.do">
				...
				<div class='awp_title'>
				  <table>
			        <tr>
			        	<td width="23%"><span class="awp_title_td2">定义相关搜索</span></td>
		              	<td align="right">
		                    <input type="button" name="Submit1" value="保 存" onClick="save('t02_crlt_srch_add_do.do');">
				...
				<div class='awp_detail'>
					<table>
						<tr>
							<td width="10%" nowrap>
								<font color="#FF3300">*</font>相关搜索名称：
							</td>
							<td colspan="3">
								<html:text property="crltsrchname" minlength="1" maxlength="64" warning="相关搜索名称"/>
								（最多32个汉字）
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="25%">
								<html:select property="parmelmtcod" size="20"
									ondblclick="copychar('parmelmtcod','crltsrchsql')">
						...
						<tr>
							<td nowrap="nowrap" align="right">
								<font color="#FF0000">*</font>相关搜索链接参数：<br>（最多512个汉字）
							</td>
							<td>
							...
							<td nowrap="nowrap" align="center">
								<html:select property="parmelmtcod" size="10" style="width:160;" ondblclick="cpSelToText(this,'linkparm','')">
