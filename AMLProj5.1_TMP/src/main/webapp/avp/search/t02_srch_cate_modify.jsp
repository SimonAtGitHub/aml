...
<html>
  ...
  <body>
 	<!-- 系统总体框架，占页面宽度的98％ -->
    <div id='content'>
      <html:form method="post" action="/search/t02_srch_cate_modify.do">
	    ...
	    <div class='awp_title'>
	      <table>
	        <tr>
	        	<td width="23%"><span class="awp_title_td2">统一视图 － 修改业务类别</span></td>
		      	<td align="right">
	            	<input type="button" value="保 存" onClick="checkForm('t02_srch_cate_modify_do.do');">
