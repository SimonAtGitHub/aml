...
function _Onblur(pname){
 ...
 function dosubmit(theUrl,type){
	...
	<body class="mainbg">
		<div id="main">
			<html:form action="/reportsum/t07_inrep_fr_ky_list.do" method="post">
				<div class="conditions">
					...
					<div class="cond_t">
						...
						<a onclick="btnDisplayHidden(this, 'searchtable')" class="btn1"></a>
							<a href="#" onclick="javascript:dosubmit('<%=request.getContextPath()%>/inves/reportsum/exportT07_inrep_fr.do','export')">
							...
							<tr>
								...
								<td>
									...
									<input type="button" name="button3" value="查 询"
										class="in_button1"
										onclick="dosubmit('<%=request.getContextPath()%>/inves/reportsum/t07_inrep_fr_ky_list.do?newsearchflag=1','search')" />
								</td>
							</tr>
				...
				<div class="list">
					...
					<tr class="listrowspan">
						...
						<th colspan="6">交易信息</th>
					</tr>
					
					<tr>
						<th colspan="2">总量</th>
						<th colspan="2">需补录总量</th>
						<th colspan="2">已补录</th>
						<th colspan="2">总量</th>
						<th colspan="2">需补录总量</th>
						<th colspan="2">已补录</th>
					...
					<tr>
						...
						<logic:iterate id="t07_inrep_fr" name="inrep_list"
							...
							<tr>
								<td><bean:write name="t07_inrep_fr" property="organname" /></td>
								<td><bean:write name="t07_inrep_fr" property="cust_all_c"/></td>
								<td><bean:write name="t07_inrep_fr" property="cust_all_i"/></td>
								<td><bean:write name="t07_inrep_fr" property="cust_need_c"/></td>
								<td><bean:write name="t07_inrep_fr" property="cust_need_i"/></td>
								<td><bean:write name="t07_inrep_fr" property="cust_done_c"/></td>
								<td><bean:write name="t07_inrep_fr" property="cust_done_i"/></td>
								<td><bean:write name="t07_inrep_fr" property="trans_all_dc"/></td>
								<td><bean:write name="t07_inrep_fr" property="trans_all_fc"/></td>
								<td><bean:write name="t07_inrep_fr" property="trans_need_dc"/></td>
								<td><bean:write name="t07_inrep_fr" property="trans_need_fc"/></td>
								<td><bean:write name="t07_inrep_fr" property="trans_done_dc"/></td>
								<td><bean:write name="t07_inrep_fr" property="trans_done_fc"/></td>
							</tr>
						</logic:iterate>
					</table>
				</div>
