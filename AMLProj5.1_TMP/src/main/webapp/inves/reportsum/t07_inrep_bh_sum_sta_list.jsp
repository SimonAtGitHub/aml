...
function _Onblur(pname){
 ...
 function dosubmit(theUrl,type){
	...
	<body class="mainbg">
		<div id="main">
			<html:form action="/reportsum/t07_inrep_bh_sum_sta_list.do" method="post">
				<div class="conditions">
					<!-- title -->
					<div class="cond_t">
						<span>大额汇总统计表(筛选)</span>
						<span class="buttons"> <a href="#" id="hdd_display" class="bt_hidden"></a> 
						<a onclick="btnDisplayHidden(this, 'searchtable')" class="btn1"></a>
							<a href="#" onclick="javascript:dosubmit('<%=request.getContextPath()%>/inves/reportsum/exportT07_inrep_bh_sum_sta.do','export')">
							...
							<tr>
								...
								<td>
									...
									<input type="button" name="button3" value="查 询"
										class="in_button1"
										onclick="dosubmit('<%=request.getContextPath()%>/inves/reportsum/t07_inrep_bh_sum_sta_list.do?newsearchflag=1','search')" />
								</td>
							</tr>
				...
				<div class="list">
					...
					<tr class="listrowspan">
						<th rowspan="3">机构</th>
						<th colspan="4">单位客户</th>
						<th colspan="4">个人客户</th>
					</tr>
					...
					<tr>
						...
						<logic:iterate id="t07_inrep_bh_sum_sta" name="inrep_list"
							...
							<tr>
								<td><bean:write name="t07_inrep_bh_sum_sta" property="organname" /></td>
								<td><bean:write name="t07_inrep_bh_sum_sta" property="trans_dc_c"/></td>
								<td><bean:write name="t07_inrep_bh_sum_sta" property="amt_dc_c"/></td>
								<td><bean:write name="t07_inrep_bh_sum_sta" property="trans_fc_c"/></td>
								<td><bean:write name="t07_inrep_bh_sum_sta" property="amt_fc_c"/></td>
								<td><bean:write name="t07_inrep_bh_sum_sta" property="trans_dc_i"/></td>
								<td><bean:write name="t07_inrep_bh_sum_sta" property="amt_dc_i"/></td>
								<td><bean:write name="t07_inrep_bh_sum_sta" property="trans_fc_i"/></td>
								<td><bean:write name="t07_inrep_bh_sum_sta" property="amt_fc_i"/></td>
							</tr>
						</logic:iterate>
					</table>
				</div>
