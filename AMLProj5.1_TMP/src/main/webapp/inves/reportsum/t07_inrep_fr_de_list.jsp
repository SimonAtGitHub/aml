...
function _Onblur(pname){
 ...
 function dosubmit(theUrl,type){
	...
	<body class="mainbg">
		<div id="main">
			<html:form action="/reportsum/t07_inrep_fr_de_list.do" method="post">
							...
							<tr>
								...
								<td>
									...
									<input type="button" name="button3" value="查 询"
										class="in_button1"
										onclick="dosubmit('<%=request.getContextPath()%>/inves/reportsum/t07_inrep_fr_de_list.do?newsearchflag=1','search')" />
								</td>
							</tr>
