		...
		<div id="main">
			<html:form action="/reportsearch_ms/t07_reportsearch_bs.do"
				...
				<div class="conditions">
					...
					<div class="cond_t">
						...
						<span class="buttons"> <a href="#" id="hdd_display"
							...
							<a href="#" onclick="toExcel('export_trans_bs.do');"><img
									src="../../images/<%=session.getAttribute("style") %>/b_excel.png" />导出Excel</a> </span>
                ...
                <html:text   property="app_dt_end_disp" size="12" onclick="calendar.show(this);" readonly="true" styleClass="calimg" />
								...
								<td>
								<html:text property="party_id"  size="15" maxlength="60"
										 onblur="_Onblur('party_name')"/>
 				...
 				<a href="#" onclick="window.open('<%=request.getContextPath()%>/common/t47_party_list.do?newsearchflag=1&input_name=party_id&input_name_disp=party_name','enter2','height=400, width=600,left=100,top=100,scrollbars=yes,resizable=yes');" ><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>
							...
							<tr>
								...
								<td>
									<html:text property="app_org_id" onblur="_Onblur('app_org_name')"
										  size="15" maxlength="60" />
					<html:text property="app_org_name" 
										 readonly="true" size="15" maxlength="60" />
					<a href="#" onclick="window.open('<%=request.getContextPath()%>/common/t00_organ_search.do?newsearchflag=1&input_name=app_org_id&input_name_disp=app_org_name','enter2','height=400, width=600,left=100,top=100,scrollbars=yes,resizable=yes');" ><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>
								...
								<td>
									<html:text property="acct_num" maxlength="40"/>
									</td>
							</tr>
							...
							<td></td>
								...
								<td>
									...
									<input type="button" name="ok" value="查 询" class="in_button1"
										onclick="dosubmit('t07_reportsearch_bs.do?newsearchflag=1','search')" />
								</td>
							</tr>
						</table>
					</div>
					...
					<table border="0" cellspacing="0" cellpadding="0">
						...
						<logic:present name="t47_transactionList">
							...
							<bean:write name="search" property="tx_dt_disp" scope="page" />
									...
									<td>
										<bean:write name="search" property="app_dt_disp" scope="page" />
									</td>
									<td>
										<bean:write name="search" property="tx_dt_disp" scope="page" />
									</td>
									...
									<td>
										<bean:write name="search" property="party_chn_name"
											scope="page" />
									</td>
									<td>
									...
									<td>
										<bean:write name="search" property="receive_pay_cd_disp"
											scope="page" />
									</td>
									<td>
									...
									<td>
										<a href="#"
											onclick="_Open('../../inves/trade/t47_transaction_disp.do?transactionkey=<%=search.getTransactionkey()%>&casesearchtime=1')">
											<bean:write name="search" property="tx_no" scope="page" />
										</a>
									</td>
									<td>
										<bean:write name="search" property="staff_ind_disp"
											scope="page" />
									</td>
									<td>
										<bean:write name="search" property="app_state_cd" scope="page" />
									</td>
									<td>
