...
<%
      String cast_type=(String)request.getAttribute("cast_type");
		...
		String downloadname =typename+"案例基本信息导出列表" + nowdate;
...
<body link=blue vlink=purple>
 ...
 <tr height=58 style='mso-height-source:userset;height:43.5pt'>
  ...
  <td colspan=18 class=xl26 width=3942 style='width:2957pt'>   
                          <logic:equal value="1" name="cast_type">大额案例基本信息表</logic:equal>
						     <logic:equal value="2" name="cast_type">可疑案例基本信息表</logic:equal></td>
 </tr>
 <tr height=51 style='mso-height-source:userset;height:38.25pt'>
  ...
  <td class=xl25 width=60 style='border-top:none;border-left:none;width:67pt'>客户类型</td>
  ...
  <td class=xl25 width=72 style='border-top:none;border-left:none;width:54pt'>处理岗位</td>
  <td class=xl25 width=72 style='border-top:none;border-left:none;width:54pt'>岗位操作</td>
  <td class=xl25 width=72 style='border-top:none;border-left:none;width:54pt'>处理意见</td>
  <td class=xl25 width=72 style='border-top:none;border-left:none;width:54pt'>处理时间</td>
 </tr>
 ...
 <tr height=28 style='mso-height-source:userset;height:21.0pt'>
  ...
  <td class=xl28 style='border-top:none;border-left:none'>　<bean:write name="trans" property="party_class_cd"/>   </td>
  ...
  <td class=xl28 style='border-top:none;border-left:none'>　<bean:write name="trans" property="curr_post"/>   </td>
  <td class=xl28 style='border-top:none;border-left:none'>　<bean:write name="trans" property="curr_oper_id"/>   </td>
  <td class=xl28 style='border-top:none;border-left:none'>　<bean:write name="trans" property="application_advice"/>   </td>
  <td class=xl28 style='border-top:none;border-left:none'>　<bean:write name="trans" property="last_upd_dt_disp"/>   </td>
 </tr>
 </logic:iterate>
</table>
