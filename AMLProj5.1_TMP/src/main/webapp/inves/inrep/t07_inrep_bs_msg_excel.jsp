...
<html xmlns:o="urn:schemas-microsoft-com:office:office"
	...
	<%
		...
		String downloadname = "可疑报文统计表" + nowdate;
	...
	<body link=blue vlink=purple>
		...
		<table border=0 cellpadding=0 cellspacing=0 width=790
			...
			<tr height=33 style='mso-height-source: userset; height: 24.95pt'>
				<td colspan=6 height=33 class=xl27 width=790
					style='height: 24.95pt; width: 596pt'>
					可疑报文统计表
				</td>
			</tr>
			<tr class=xl65 height=16 style='height: 16.0pt'>
				...
				<td colspan=2>
					<bean:write name="t07_inrep_bs_msg" property="report_dt_disp"
						format="yyyy-MM-dd" />
					至
					<bean:write name="t07_inrep_bs_msg" property="report_dt_end"
						format="yyyy-MM-dd" />
				</td>
				<td >
					单位:份
			...
			<logic:iterate id="trans" name="t07_inrep_bs_msgList" type="com.ist.aml.inves.dto.T07_INREP_BS_msg">
			...
			<tr>
			 	<td colspan=6 class=x135 style='height:2pt'></td>
			 </tr>
		</table>
