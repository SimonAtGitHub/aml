...
function initDate(){
	...
	<body onload="initDate()" class="mainbg">
		...
		<div id="main">
			<html:form action="/t07_inrep_bs_msg/t07_inrep_bs_msg_list.do"
				method="post">
				...
				<div class="conditions">
					...
					<div class="cond_t">
						...
						<span class="buttons"> <a href="#" id="hdd_display"
							...
							<a href="#" onclick="toExcel('t07_inrep_bs_msg.do');"><img
							...
							<tr>
								...
								<td>
									...
									<input type="button" name="ok" value="查 询" class="in_button1"
										onclick="dosubmit('t07_inrep_bs_msg_list.do?newsearchflag=1','search')" />
								</td>
							</tr>
						</table>
					</div>
				...
				<div class="list">
					<table border=0 cellpadding="0" cellspacing="0">
						...
						<logic:present name="t07_inrep_bs_msgList">
							<logic:iterate id="search" name="t07_inrep_bs_msgList"
								type="com.ist.aml.inves.dto.T07_INREP_BS_msg">
								<tr>
									<td>
