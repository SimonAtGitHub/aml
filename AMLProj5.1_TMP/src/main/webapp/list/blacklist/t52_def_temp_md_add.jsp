...
<html:form method="post" action="/blacklist/t52_def_temp_md_add.do">
  		...
  		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td align="right" colspan="3">
					<input type="button" name="button1" class="in_button1" value="提 交" onclick="checkForm('t52_def_temp_md_add_do.do')" />
