...
<body class="mainbg">
<html:form method="post" action="/blacklist/t52_def_temp_gran_add.do">
  ...
  <%
	...
	<div class="cond_c2">
  		<table border="0" cellpadding="0" cellspacing="0">
			...
			<table id="TBSQL">
				 <tr>
				 	<td align="left">计算顺序</td>
                    <td align="left">评级对象(执行sql)
			...
			<tr>
				...
				<td align="right" colspan="3">
					<input type="button" name="button1" class="in_button1" value="提 交" onclick="checkForm('t52_def_temp_gran_add_do.do')" />
    ...
    <div class="sys_warning"><strong><img src="../../images/<%=session.getAttribute("style") %>/warning.png" />系统提示：</strong>
     <p>&nbsp;&nbsp;&nbsp;&nbsp;             			  <b>查询结果转成  ID， NAME, CARD_NO， COUNTRY_CD， TRANSACTIONKE其中一个或多个 </b> <b>ID客户号必填</b></p>
