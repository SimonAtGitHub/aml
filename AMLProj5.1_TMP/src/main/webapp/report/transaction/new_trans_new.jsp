...
function _Confim(url){
			...
			var time_disp=document.forms[0].dt_time_disp.value;
		if(!_compareTwoDateForString(time_disp, str)) {
			alert("交易时间不能大于当前的时间");
			return false;
		}
	...
	if(getLength(document.forms[0].tx_cd.value)==0){
  		errMsg="交易代码不能为空  ";
     }
   //业务标识码
 ...
 if(valflag=="1" ||valflag=="3"){
    ...
    if (getLength(document.forms[0].acct_num.value)==0&&document.forms[0].org_trans_rela.value=="01") {
        errMsg = "金融机构与交易的关系为'收单行'时,账号不能为空！";
        document.forms[0].acct_num.focus();
        }

      //金融机构与大额交易的关系
     if (getLength(document.forms[0].org_trans_rela.value)==0) {
        errMsg = "金融机构与交易的关系不能为空！";
...
//if(valflag=="2"||valflag=="3"){
 ...
 //    }
 //}
 	 if(getLength(document.forms[0].organ_name.value)==0){
        errMsg="金融机构网点名称不能为空  ";
	}else   if(getLength(document.forms[0].organkey_new.value)==0){
   		 errMsg="金融机构网点代码不能为空  ";
...
//验证金额格式 obj字段  flag 1可以为空  0不可以为空
	...
	{	
		var flag=document.getElementsByName("is_party");
			...
			var party_id=document.getElementsByName("party_id");
...
.STYLE2 {
	...
	<body class="mainbg"
		onload="card_inf_exp('1','');_Change('curr_cd');change_isParty('init');">
		<div id="main">
			<html:form action="/transaction/new_trans_new.do"
				method="post">
				...
				<div class="conditions">
					...
					<div class="cond_t">
						<span>添加交易</span>
						<span class="buttons"> 
						<a href="#"	onclick="_Confim('new_trans_new_do.do')"> <img src="../../images/<%=session.getAttribute("style") %>/b_save.png" />保 存</a> 
						<a href="#" onclick="dosubmit('new_trans_list.do')"><img src="../../images/<%=session.getAttribute("style") %>/b_back.png" />返回</a> 
						</span>
					</div>
					...
					<div class="cond_c2">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td align="left">
									<html:text property="organ_name" readonly="true"	size="25"	/>
										<%
												String root = request.getContextPath();
												String root3 = "\"window.open('"
												+ root
												+ "/common/t00_organ_search.do?newsearchflag=1&input_name=organkey_new&input_name_disp=organ_name','enter2','height=400, width=600,left=100,top=100,scrollbars=yes,resizable=yes')\"";
										%>
								...
								<td align="left">
									<html:text property="organkey_new" readonly="true" alt="金融机构网点代码"   size="25"
										 />
						...
						<!--			<html:text property="organ_area" size="9" readonly="true" />
							...
							<tr>
								...
								<td align="left" colspan="3">
									<html:select property="org_trans_rela" alt="金融机构与交易的关系"   
					...
					<div class="cond_c2">
						<table border="0" cellpadding="0" cellspacing="0" align="center"
							...
							<tr>
								...
								<td align="left">
									<html:text property="agent_name" onchange="change();"  size="25"
					...
					<div class="cond_c2">
						<table width="100%" border="0" cellpadding="1" cellspacing="1">
							...
							<tr> 
								...
								<tr>
									...
									<td >
										...
										<a id="no_party_id" href="#" onclick="window.open('../../common/t47_party_list1.do?newsearchflag=1&input_name=party_id&input_name_disp=party_chn_name&type=party_class_cd','', 'height=400, width=900,left=100,top=100,scrollbars=yes,resizable=yes');" ><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>	
										<font  color="red">*</font>
									...
									<td >
										<html:text property="party_id" readonly="true" 
							...
							<tr>
								...
								<td bgcolor="F6F9FF" >
									<input type="text" name="dt_time_disp" alt="交易时间"
										onpropertychange="isDate(this,0)" size="25" maxlength="20"
								...
								<td bgcolor="F6F9FF">
									<html:text property="tx_no" alt="流水号" size="25" maxlength="32"/>
									<font color="#FF0000"> *</font>
								</td>
							</tr>
							<tr>
								...
								<td bgcolor="F6F9FF">
									...
									<input type="text" name="amt_disp" maxlength="15" size="25"
							...
							<tr>
								...
								<td  bgcolor="F6F9FF">
									<html:text property="acct_num" onchange="change();"  size="25"
							...
							<tr>
								...
								<td bgcolor="F6F9FF" colspan="3" align="left">
									<html:text property="use_des" size="25" maxlength="64"  
					...
					<div class="cond_c2">
						<table border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td align="left">
									<html:text property="opp_acct_num" onchange="change();"  size="25"
								...
								<td align="left">
									<%
										if (validateflag.equals("1") || validateflag.equals("3")) {
									%>
									<html:text property="opp_name" onchange="change();"  size="25"
									...
									%>
									<!--  <a href="#" onclick="_Open2('<%=request.getContextPath() %>/report/case/t47case_opp_info_list.do?flag=1')" ><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>
								-->
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left">
									<html:text property="opp_card_no" onchange="change();"  size="25"
								...
								<td align="left">
									<html:text property="opp_organname" onchange="change();" 
										...
										<a href="#" onclick="_Open2('<%=request.getContextPath() %>/report/case/t47case_opp_bank_list.do?newflag=1')" ><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>
					...
					<div class="sys_warning">
						...
						<p>
							...
							<br />
							&nbsp;&nbsp;3、报送机构填写“账户类型(CATP)”或“交易对手账户类型(TCAT)”时，如无法区分人民币个人银行帐户为“本地帐户”或是“异地帐户”，一律选择“本地帐户”填写。
							<br />
							&nbsp;&nbsp;4、报送机构填写“账户类型(CATP)”或“交易对手账户类型(TCAT)”时，当该账户既是“6100银证转账帐户”(或“6200银证转账帐户”)又是其他帐户类型(例如0011人民币本地存款人-基本帐户)时,一律选择“6100银证转账帐户”(或“6200银证转账帐户”)填写。
							<br />
						</p>
					</div>
				</div>
