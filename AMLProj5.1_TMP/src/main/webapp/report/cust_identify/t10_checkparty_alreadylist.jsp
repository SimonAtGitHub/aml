   ...
   <table   border="0"   cellpadding="0" cellspacing="0"  >       
			...
			<td>识别类型：</td>
         	<td>
				...
				<input name="" type="button" value="查　询"  class="in_button1" onClick="dosubmit('<%=request.getContextPath() %>/report/cust_identify/t10_checkparty_alreadylist.do?newsearchflag=1','search')"/>
			</td>
