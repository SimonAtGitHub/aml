 ...
 <div class="conditions">
   ...
   <table   border="0"   cellpadding="0" cellspacing="0"  >       
            ...
            <td>客户类型：</td>
         	...
         	<td></td>
         	<td>
         	    <input name="" type="button" value="查　询"  class="in_button1" onClick="dosubmit('<%=request.getContextPath() %>/report/cust_identify/t10_checkparty_rateRiskList.do?newsearchflag=1','search')"/>
			</td>
           </tr>
        </table>
      </div>
  ...
  <table border="0" cellpadding="0" cellspacing="0"  >
    ...
    <tr>
       ...
       <td>
       <a href="#" onclick="dosubmit('<%=request.getContextPath()%>/report/cust_identify/t10_checkparty_riskRateMain.do?ischecked=newclient&changeflag=7&check_type=1&party_id=<%=party_id %>&party_class_cd=<bean:write name="checkparty" property="party_class_cd" scope="page" />&url=t10_checkparty_rateRiskList.do?');">
       	<img src="../../images/<%=session.getAttribute("style")%>/b_pass.png" title="调查" /></a>
       </td>
