...
function checkForm(theUrl){
     var errMsg ="";
     if(getLength(document.forms[0].party_id.value)>32){
     	errMsg="客户号不能超过32个字符！";
     ...
     else if(getLength(document.forms[0].check_reason.value) == 0){
	    errMsg="请填写识别原因！";
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<TD bgcolor="F6F9FF">
									<div align="left">
										...
										<html:text property="party_chn_name" styleClass="text_white" maxlength="50" size="20" readonly="true" />
							...
							<tr>
								...
								<TD bgcolor="F6F9FF" align="left">
									<html:text property="party_id" value="" maxlength="50" readonly="true"></html:text>
								</TD>
							</tr>
							<TR align="center">
								<TD height="22" bgcolor="ECF3FF">
							...
							<tr>
          					...
          					<tr>
								...
								<td colspan="3">
									<html:textarea property="check_reason" cols="70" rows="6" styleId="check_reason">
									</html:textarea>
								</td>
          					</tr>
						...
						<tr>
								...
								<td align="right">
									<input type="button" name="button1" class="in_button1" value="提 交"
										onclick="checkForm('add_t10_survey_partyDo.do')" />
