 ...
 <div class="conditions">
   ...
   <table   border="0"   cellpadding="0" cellspacing="0"  >       
            ...
            <td>客户类型：</td>
         	...
         	<td></td>
         	<td>
         	    <input name="" type="button" value="查　询"  class="in_button1" onClick="dosubmit('<%=request.getContextPath() %>/report/cust_identify/t10_checkparty_newlist.do?newsearchflag=1','search')"/>
			</td>
           </tr>
        </table>
      </div>
