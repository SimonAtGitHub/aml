...
<html:form method="post" action="/cust_identify/addT10_party_cretal.do">
  <div id="main">
    <!-- conditions -->
    <div class="conditions">
      <!-- title -->
	 <div class="cond_t">
	   <span>新建机构信用代码应用表</span>
	   <span class="buttons">
      ...
      <div class="cond_c2">
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td>
             <html:hidden property="status_cd" value="0"/>
             <html:text property="statistic_dt_disp" onclick="calendar.show(this);" readonly="true"  size="6" />
            </td>
            <td><font color="#FF0000">*</font>查询笔数(重新客户识别)：</td>
            <td>
               <html:text property="querycount_r"/>
            </td>
          ...
          <tr>
            ...
            <td>
               <html:text property="querycount_n"/>
            </td>
            <td><font color="#FF0000">*</font> 涉及客户数(重新客户识别)：</td>
            <td>
             <html:text property="partycount_r"/>
            </td>
          ...
          <tr>
            ...
            <td>
             <html:text property="partycount_n"/>
            </td>
            <td><font color="#FF0000">*</font>涉及账户数(重新客户识别)：</td>
            <td>
               <html:text property="acctcount_r"/>
            </td>
          ...
          <tr>
            ...
            <td>
               <html:text property="acctcount_n"/>
            </td>
            <td><font color="#FF0000">*</font> 发现异常或可疑线索数(重新客户识别)：</td>
            <td>
             <html:text property="kycount_r"/>
            </td>
          </tr>
          <tr>
            <td><font color="#FF0000">*</font> 发现异常或可疑线索数(新开客户)：</td>
            <td colspan="3">
             <html:text property="kycount_n"/>
            </td>
          </tr>
          <tr>
            <td align="center" colspan="4"><input name="" type="button" class="in_button1" value="提 交" onclick="checkForm('addT10_party_cretal.do')" />
