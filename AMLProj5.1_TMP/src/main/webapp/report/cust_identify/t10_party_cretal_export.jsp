...
<body link=blue vlink=purple>
 ...
 <tr><td height=58 width=72 style='height:43.5pt;width:54pt'></td>
    <td colspan="8" class=xl27>填报单位：</td>
    <td  colspan="2" class=xl27>填报日期：<bean:write name="t10_party_cretal"  property="statistic_dt_disp" scope="request"/></td>
 </tr>
...
<logic:iterate id="party_cretal" name="list"  type="com.ist.aml.cust_identify.dto.T10_party_cretal">
 <tr  style='mso-height-source:userset;height:25pt'>
  <td width=72 style='height:25pt;'></td>
  <td class=xl25 style='border-top:none;'><bean:write name="party_cretal"  property="organname" scope="page"/></td>
  <td class=xl25 style='border-top:none;border-left:none'><bean:write name="party_cretal"  property="querycount_s" scope="page"/></td>
  <td class=xl25 style='border-top:none;border-left:none'><bean:write name="party_cretal"  property="querycount_n" scope="page"/></td>
  <td class=xl25 style='border-top:none;border-left:none'><bean:write name="party_cretal"  property="partycount_n" scope="page"/></td>
  <td class=xl25 style='border-top:none;border-left:none'><bean:write name="party_cretal"  property="acctcount_n" scope="page"/></td>
  <td class=xl25 style='border-top:none;border-left:none'><bean:write name="party_cretal"  property="kycount_n" scope="page"/></td>

  <td class=xl25 style='border-top:none;border-left:none'><bean:write name="party_cretal"  property="querycount_r" scope="page"/></td>
  <td class=xl25 style='border-top:none;border-left:none'><bean:write name="party_cretal"  property="partycount_r" scope="page"/></td>
  <td class=xl25 style='border-top:none;border-left:none'><bean:write name="party_cretal"  property="acctcount_r" scope="page"/></td>
  <td class=xl25 style='border-top:none;border-left:none'><bean:write name="party_cretal"  property="kycount_r" scope="page"/></td>
 </tr>
 </logic:iterate>
