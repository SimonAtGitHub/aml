...
jq(function(){
 jq("#checkall").toggle(
	...
	<BODY leftmargin="0" topmargin="0" class="mainbg">
		<div id="main">
		<html:form action="/listmanager/t07_obj_rule_list_check0.do" method="post" enctype="multipart/form-data" styleId="form0">
		<html:hidden property="checkflag" value="check0"/>
				<!-- conditions -->
				<div class="conditions">
					...
					<div class="cond_t">
						...
						　　 <a href="#" id="checkall" ><img src="../../images/<%=session.getAttribute("style") %>/b_checkall.png" />全选</a>
						 <a href="#"
							onClick="dosubmit('t07_obj_rule_modify_check0.do?is_check=yes&list_type=<bean:write name="t07_obj_ruleActionForm" property="list_type" />','check')"><img
									src="../../images/<%=session.getAttribute("style") %>/b_pass.png" />审核通过</a> <a href="#"
							onClick="dosubmit('t07_obj_rule_modify_check0.do?is_check=no&list_type=<bean:write name="t07_obj_ruleActionForm" property="list_type" />','check')"><img
									src="../../images/<%=session.getAttribute("style") %>/b_passnot.png" />审核不通过</a><!--  20091106
					...
					<div class="cond_c" id="searchtable">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<html:text property="organkey" size="10" size="10" require="false" datatype="number|limit_max" max="12" msg="请输入数字|不能超过12个数字"></html:text>
							...
							<tr>
								...
								<td>
									<input type="button" class="in_button1" value="查 询"
										onclick="dosubmit('t07_obj_rule_list_check0.do?newsearchflag=1&intPage=0&checkflag=check0','search')" />
									</td>
							</tr>
						</table>
					</div>
							...
							<logic:iterate id="t07_obj_rule" indexId="i"
								...
								<TR>
									...
									<TD align="center" height=22>
									    ...
									    <html:link name="map" page="/listmanager/t07_obj_rule_disp.do?changeflag=3">
											<bean:write name="t07_obj_rule" property="party_id" />
										</html:link>
										</logic:equal>
										
										<logic:equal value="2" name="t07_obj_ruleActionForm" property="list_type">
										<html:link name="map" page="/listmanager/t07_blacklist_disp.do?changeflag=3">
											<bean:write name="t07_obj_rule" property="party_id" />
										</html:link>
										</logic:equal>
