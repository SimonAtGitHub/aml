...
function onClick(theUrl,type){
    ...
    if(type=='insert'){
        ...
        if(errMsg==''){
        	...
        	alert("查询结果大于1000，请重新选择查询条件再添加！");
        	}
        	else if(errMsg==''){
           	 if(confirm('你真的要添加所有的交易吗？')){
                    isSub = true;
                }
         }
    }
		...
		<div id="main">
			<html:form action="/nb/t47_transaction_search.do" method="post">
				...
				<div class="conditions">
					...
					<a href="#" onClick="onClick('t13_mfa_nb_transinsert_do.do?add=1','insert')"><img src="../../images/<%=session.getAttribute("style") %>/b_generatec.png" />部分添加</a>
					<a href="#" onClick="onClick('t13_mfa_nb_transinsert_do.do?add=2','insertall')"><img src="../../images/<%=session.getAttribute("style") %>/b_generate.png" />全部添加</a>
					</span>
					</div>
					<!-- table content -->
