                         ...
                         <tr>
							...
							<font color="red">* </font>
                               ...
                               <td><input type="button" name="button3" value="查 询" class="in_button1"
										onclick="dosubmit('t07_cd_apply_trans_list.do?newsearchflag=1&modflag=1','search')" /></td>
                         		</tr>
                   </table>
             </div>
             </div>
             ...
             <div class="list_page">
	     	  ...
	     	  <tr>
				<td class="in_button"  align="right">
					<input  type="button" value="选定" onclick="dosubmit('t07_cd_apply_trans_add.do?modflag=1','choose')"/>
					<input  type="button" value="完成" onclick="dosubmit('t07_cd_apply_trans_result_list.do?modflag=1','submit')"/>		
				</td>
	   			</tr>
