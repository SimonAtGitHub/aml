...
<div id="main">
<html:form method="post" action="/apply/t07_cd_apply_list.do">
       <div class="conditions" >
             <div class="cond_t" >
             	<span>逾期申请</span >
                   <span class="buttons" >
                   		<a href="#" onclick="dosubmit('t07_cd_apply_add.do?msg_type=2&initflag=1','add');" ><img src="../../images/blue/b_add.png" />新建</a>
                   		<a href="#" onclick="dosubmit('t07_cd_apply_modify.do','mod')"><img src="../../images/blue/b_edit.png" />修改</a>
                 		<a href="#" onclick="dosubmit('t07_cd_apply_delete.do','del');" ><img src="../../images/blue/b_delete.png" />删除</a>
                   		<a href="#" onclick="dosubmit('t07_cd_apply_submit.do?status=2&opertype=1','sub');" ><img src="../../images/blue/b_susnot.png" />提交</a>
                 </span>
             </div>
                         ...
                         <tr><td>申请日期：</td >
							...
							<html:text size="12" property="end_dt_disp" onclick="calendar.show(this);" readonly="true" styleClass="calimg" />
                               ...
                               <td><input type="button" name="button3" value="查 询" class="in_button1"
										onclick="dosubmit('<%=request.getContextPath()%>/report/apply/t07_cd_apply_list.do?newsearchflag=1&status_cd=1,3','search')" /></td>
                         </tr>
                   </table>
             </div>
             </div>
             ...
             <div class="list" >
                  <table border="0" cellspacing="0" cellpadding="0" id="table_name">
						<tr>
				          ...
				          <td>
				          	<a href="t07_cd_apply_detail.do?return_type=1&apply_no=<bean:write name="t07_cd_apply" property="apply_no"/>&msg_type=<bean:write name="t07_cd_apply" property="msg_type"/>&status_cd=<bean:write name="t07_cd_apply" property="status_cd"/>"><bean:write name="t07_cd_apply" property="apply_no" /></a>
				          </td>
