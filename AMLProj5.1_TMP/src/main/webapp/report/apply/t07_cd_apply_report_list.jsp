                         ...
                         <tr>
							...
							<html:text size="12" property="end_dt_disp" onclick="calendar.show(this);" readonly="true" styleClass="calimg" />
                               ...
                               <td><input type="button" name="button3" value="查 询" class="in_button1"
										onclick="dosubmit('t07_cd_apply_report_list.do?newsearchflag=1','search')" /></td>
                         </tr>
                   </table>
             </div>
             </div>
             ...
             <div class="list_page">
	     	  ...
	     	  <tr>
				<td class="in_button"  align="right">
					<input  type="button" value="选定" onclick="dosubmit('t07_cd_apply_report_add.do','choose')"/>
					<input  type="button" value="完成" onclick="dosubmit('t07_cd_apply_report_result_list.do','submit')"/>		
				</td>
	   			</tr>
