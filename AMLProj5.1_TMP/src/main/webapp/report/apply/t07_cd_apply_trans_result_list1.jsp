             ...
             <div class="list" >
	     	  ...
	     	  <tr>
				<td class="in_button"  align="right">
					<input  type="button" value="添加" onclick="dosubmit('t07_cd_apply_add.do?msg_type=1&modflag=1','add')"/>
					<input  type="button" value="完成" onclick="dosubmit('t07_cd_apply_trans_add_do.do?modflag=1','submit')"/>		
				</td>
	   			</tr>
