             ...
             <div class="cond_t" >
             	<span>新增申请 - 可疑</span >
                   <span class="buttons" >
						...
						<a href="#" onclick="dosubmit('t07_cd_apply_add.do?msg_type=1&initflag=1')"><img src="../../images/blue/b_large.png" />大 额</a>
             ...
             <div class="list" >
                  <table border="0" cellspacing="0" cellpadding="0" id="tb">
						<tr>
				          ...
				          <tr>
				          	...
				          	<td><a href="#" onclick="dosubmit('t07_cd_apply_item_delete.do?msg_type=2&reportkey=<bean:write name="t07_report" property="reportkey" />','delete')" title="删除"><img src="../../images/blue/b_delete.png" /></td>
				          </tr>
				          </logic:iterate>
				          </logic:present>
				          </table>
	     	  ...
	     	  <tr>
				<td class="in_button"  align="right">
					<input  type="button" value="添加" onclick="dosubmit('t07_cd_apply_add.do?msg_type=2','add')"/>
					<input  type="button" value="完成" onclick="dosubmit('t07_cd_apply_report_add_do.do','submit')"/>		
				</td>
	   			</tr>
