...
<html:form method="post" action="/apply/t07_cd_apply_detail.do">
	<div class="conditions" >
    	<div class="cond_t" >
             	<span>申请详情</span >
                   <span class="buttons" >
                   <a href="#" onclick="dosubmit('t07_cd_apply_submit.do?status=4&opertype=2&apply_no=<bean:write property="apply_no" name="t07_cd_apply" />','sub');" ><img src="../../images/blue/b_pass.png" />审核通过</a>
                   <a href="#" onclick="dosubmit('t07_cd_apply_submit.do?status=3&opertype=2&apply_no=<bean:write property="apply_no" name="t07_cd_apply" />','sub');" ><img src="../../images/blue/b_rereport.png" />退回</a>
                   <a href ="#" onclick="dosubmit('t07_cd_apply_check_list.do')"><img src="../../images/blue/b_back.png" />返  回</a>
                 </span>
         </div>
         <div class="cond_c2" >
	...
	<dl class="tabc">
		...
		<iframe frameborder="0" width="100%" height="500px" src="<%=request.getContextPath()%>/report/apply/t07_bs_report_list.do?newsearchflag=1&apply_no=<bean:write name="t07_cd_apply" property="apply_no"/>" scrolling="no"  id="report_detail" name="report_detail"></iframe>
		 ...
		 <iframe frameborder="0" width="100%" height="500px" src="<%=request.getContextPath()%>/report/apply/t07_bh_tsdt_list.do?newsearchflag=1&apply_no=<bean:write name="t07_cd_apply" property="apply_no"/>" scrolling="no"  id="report_detail" name="report_detail"></iframe>
		 </logic:equal>
