...
function validate_type(value){
			...
			||IndexSpace(validate_type_value)>0){
				showValidateMsg($$(value,0),'2','请输入证件的详细信息，不能有空格，并且在4至30个字符之内!');
			}else{
...
.STYLE2 {
	...
	<body  class="mainbg" 
		...
		<a href='#' title="保存" onclick="_Confim('t47_transaction_se_modify_do1.do?saveType=1')"><img src="../../images/blue/b_save.png" /></a>
		<a href='#' title="保存并下一条" onclick="_Confim('t47_transaction_se_modify_do1.do?saveType=2')"><img src="../../images/blue/b_save.png" /></a>
		</div>
		
	<div id="main">	
		<html:form action="/case/t47_transaction_se_modify1.do" method="post">
					...
					<div class="cond_t">
	                   ...
	                   <%} %>
	                    <a href="#" onclick="window.close();" ><img src="../../images/blue/b_shut.png" />关 闭</a>
                   		...
                   		<div class="cond_t2">
						<span class="buttons"> <strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户名:&nbsp;<bean:write
								name="t47_transaction" property="party_chn_name" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;摘要:&nbsp;<bean:write
						...
						<table border="0" cellpadding="0" cellspacing="0">
						    <tr>
						       <td align="center">
						          ...
						          <html:button property="button" styleClass="in_button1" onclick="_Confim('t47_transaction_se_modify_do1.do?saveType=1')">保存</html:button>
						       </td>
						    </tr>
						</table>
					</div>
