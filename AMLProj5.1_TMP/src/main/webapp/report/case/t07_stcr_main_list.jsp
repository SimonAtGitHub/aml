...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="0" topmargin="0" class="mainbg">
		<html:form method="post" action="/case/stcr_main_list.do">
		    <%
				String root = request.getContextPath();
				String root1 = url + "/report/case/stcr_party_list.do?stcr="
					  + request.getAttribute("stcr") + "&application_num=" + request.getAttribute("application_num") + "&newsearchflag=1";
			    String root2 = url + "/report/case/stcr_acct_list.do?stcr="
					  + request.getAttribute("stcr") + "&application_num=" + request.getAttribute("application_num") + "&newsearchflag=1";
			    String root3 = url + "/report/case/stcr_trans_list.do?stcr="
					  + request.getAttribute("stcr") + "&application_num=" + request.getAttribute("application_num") + "&newsearchflag=1";
