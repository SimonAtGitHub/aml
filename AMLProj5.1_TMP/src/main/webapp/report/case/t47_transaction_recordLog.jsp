...
<%@ page import="com.ist.aml.report.dto.T47_transaction"%>
  ...
  <body class="mainbg">
  <html:form action="/case/t47_transaction_recordLog.do" method="post">
				<html:errors />
  	<div class="conditions">
					<div class="cond_t">
						<span> 交易信息补录日志管理 </span>
					</div>
					<!-- table content -->
					<div class="cond_c">
							...
							<tr>
								...
								<td colspan=3><html:text property="create_dt" size="12" onclick="calendar.show(this);" readonly="true" styleClass="calimg" />    	
									<input type="button" name="search" class="in_button1" value="查 询"
										onclick="dosubmit('<%=request.getContextPath()%>/report/case/t47_transaction_recordLog.do?newsearchflag=1')" />
								</td>
							</tr>
						</table>
					</div>
    ...
    <div class="list">
    	<table border="0" cellspacing="0" cellpadding="0">
    		...
    		<logic:present name="t47_trans_recordLogList" scope="request">
			<logic:iterate id="transaction" indexId="i"
				name="t47_trans_recordLogList"
				type="com.ist.aml.report.dto.T47_trans_recordLog">
				<tr>
					<td><bean:write name="transaction" property="transactionkey" /></td>
					<td><bean:write name="transaction" property="tx_no" /></td>
					<td><bean:write name="transaction" property="tx_dt" format="yyyy-MM-dd"/></td>
					<td><bean:write name="transaction" property="acct_num" /></td>
					<td><bean:write name="transaction" property="party_id" /></td>
					<td><bean:write name="transaction" property="create_dt" /></td>
					<td><bean:write name="transaction" property="create_usr" /></td>
				</tr>
			</logic:iterate>
		</logic:present>
    	</table>
    </div>
    <logic:present name="t47_trans_recordLogList">
		<!-- list_page --> 
		  <div class="list_page">
