...
<input type="hidden" name="casetype" value="1"/>
	...
	<table  border="0" cellpadding="0" cellspacing="0">
			<tr>
             ...
             <tr>
              ...
              降序
              <input type="button" name="ok" value="查询" class="in_button1"  onclick="_Confim('<%=request.getContextPath()%>/report/case/t07_case_app_add_de_c_page.do?newsearchflag=1')" /></td>
             </tr>
         </table>
       </div>
       </div>  
  ...
  <div class="list_page">
   ...
   <!--  <table  border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="right" >&nbsp; 
        <html:button property="button4" value="全部创建" styleClass="input" onclick="dosubmit('addT07_caseErrorDeDo.do?type=all', 'all')"/>
      </td>
    </tr>
