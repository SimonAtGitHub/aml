...
<![endif]-->
 ...
 T47_transaction t47_transaction=(T47_transaction)request.getAttribute("t47_transaction");
 String validateflag=t47_transaction.getValidateflag();
 
 if(t47_transaction.getTx_occur_area2()!=null && !"".equals(t47_transaction.getTx_occur_area2().trim()))
  tx_occur_area2=t47_transaction.getTx_occur_area2();
  if(t47_transaction.getTx_occur_area1()!=null  && !"".equals(t47_transaction.getTx_occur_area1()))
   tx_occur_area1=t47_transaction.getTx_occur_area1();
   if(t47_transaction.getTx_occur_area()!=null  && !"".equals(t47_transaction.getTx_occur_area()))
    tx_occur_area=t47_transaction.getTx_occur_area();
  
 if(t47_transaction.getTx_go_area2()!=null && !"".equals(t47_transaction.getTx_go_area2().trim()))
  tx_go_area2=t47_transaction.getTx_go_area2();
 if(t47_transaction.getTx_go_area1()!=null && !"".equals(t47_transaction.getTx_go_area1().trim()))
  tx_go_area1=t47_transaction.getTx_go_area1();
   if(t47_transaction.getTx_go_area()!=null && !"".equals(t47_transaction.getTx_go_area().trim()))
  tx_go_area0=t47_transaction.getTx_go_area();   


  
    String cashind="";
  if(t47_transaction.getCash_ind()!=null && !"".equals(t47_transaction.getCash_ind())){
    cashind=t47_transaction.getCash_ind();
  }
   String alertType="BS";
  if(validateflag.equals("1")||validateflag.equals("3"))alertType="BH";
%>
		...
		function validateDetail() {
			...
			g_changed = true; 
			   ...
			   g_changed = true;
				...
				g_changed = true;
				document.forms[0].org_area.value=document.forms[0].organ_area.value;
				validate($$('org_area',0), 'firc', '');
	   ...
	   if(type=='all'||type=='acct_type'){
        ...
        if(type=='all'||type=='opp_name'){
           if (valflag==2||valflag==3){
			    ...
			    if(valflag==3)
			    {
			     validate1($$('opp_name',0), '', 'opp_card_type','BS',get_obj_value('receive_pay_cd'),get_opp_country('opp_country','opp_area1','opp_area2','opp_area'),get_opp_country('tx_go_country','tx_go_area1','tx_go_area2','tx_go_area'),get_tstp_value('currency_cd','cash_ind','settle_type_cd'));		     
		...
		if(type=='all'||type=='opp_acct_num'){
           if(valflag==3){
               g_changed = true;
			   validate1($$('opp_acct_num',0), 'opp_acct_type_cd', '','HS',get_obj_value('receive_pay_cd'),get_opp_country('opp_country','opp_area1','opp_area2','opp_area'),get_opp_country('tx_go_country','tx_go_area1','tx_go_area2','tx_go_area'),get_tstp_value('currency_cd','cash_ind','settle_type_cd'));
            }else if (valflag==1){
			    g_changed = true;
   ...
   var err = "";
    if (errMsg != "") {
        ...
        return false;
			...
			{
				var alinkID = window.opener.document.getElementById('verify_btnID').value;//父页面input隐藏域的值
	        	window.opener.document.getElementById(alinkID).innerHTML = (window.opener.document.getElementById(alinkID).innerHTML == '未通过')?'通过':'通过';
...
.STYLE2 {
	...
	<body  class="mainbg" 
		...
		<!--简单按钮浮动层-->
		<div class="floatdiv floatbtnbg" style="right:4px; top:42px;*top:expression(this.offsetParent.scrollTop+42); ">		
		<a href='#' title="保存" onclick="_Confim('t47_transaction_se_verify_do.do?saveType=1')"><img src="../../images/blue/b_save.png" /></a>
		<%--<a href='#' title="保存并下一条" onclick="_Confim('t47_transaction_se_modify_do1.do?saveType=2')"><img src="../../images/blue/b_save.png" /></a>
		--%></div>
		
	<div id="main">	
		<html:form action="/case/t47_transaction_se_verify.do" method="post">
			...
			<input type="hidden" name="t47_transactionString"
				value="<bean:write name="t47_transactionString" />" />
			...
			<!-- conditions --> 
               <div class="conditions">
					...
					<div class="cond_t">
						<span>交易补录</span>						
						<span class="buttons"> 
						<% if("1".equals((String)request.getAttribute("isHasImage"))) { %>
						<a href="#" onClick="ymPrompt.win({message:'',width:600,height:400,title:'影像',handler:handler,iframe:true,fixPosition:true,dragOut:false});" ><img src="../../images/blue/b_stopublish.png" />影像接口</a>
	                   <%} %>
	                    <a href="#" onclick="window.close();" ><img src="../../images/blue/b_shut.png" />关 闭</a>
					     </span>
					</div>
                   		<div class="cond_t2">
						<span class="buttons"> <strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;摘要:&nbsp;<bean:write
								name="t47_transaction" property="des" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;交易渠道:&nbsp;<bean:write
								name="t47_transaction" property="channel" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;交易代码:&nbsp;<bean:write
								name="t47_transaction" property="cb_tx_cd" /></strong> </span>
					</div>
					...
					<div class="cond_c2">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td align="left">
									<html:text property="organ_code_type_disp" readonly="true" />
								...
								<td align="left">
									...
									<img src="../../images/<%=session.getAttribute("style") %>/b_lock.png" height='20' />
									<html:hidden property="organkey"></html:hidden>
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td align="left">
									<html:text readonly="true" property="organ_area_disp" />
									...
									<input type="hidden" name="org_area"  />
									<img src="../../images/<%=session.getAttribute("style") %>/b_lock.png" height='20' />
								</td>
							</tr>
							<tr>
					...
					<div class="cond_t2">
						<span class="buttons"> <strong><img
									src="../../images/<%=session.getAttribute("style") %>/titleicon02.png" />代办人信息（如填写一项则其他项都需填写）</strong> </span>
					</div>
						...
						<table border="0" cellpadding="0" cellspacing="0" align="center" >
							...
							<tr>
								...
								<td align="left" colspan="3">
									...
									<input type="hidden" name="agent_table" value="1" />
									<!--  <img style="display: none" dir=""  width="20" height="20" />-->
								</td>
							</tr>
					...
					<div class="cond_c2">
						 <table width="100%" border="0" cellpadding="1" cellspacing="1">
								...
								<!-- 交易信息  -->
								<tr>
								  <td height="22" align="right"  bgcolor="ECF3FF">业务标识码：</td>
								  <td width="25%" bgcolor="F6F9FF"><html:text property="transactionkey"  alt="业务标识码"  readonly="true" /><img src="../../images/<%=session.getAttribute("style") %>/b_lock.png" height='20'/>							  </td>
							      <td width="24%" align="right"  bgcolor="ECF3FF">交易时间：</td>
							      <td width="29%" bgcolor="F6F9FF"><html:text property="dt_time_disp" readonly="true" alt="交易时间"/><img src="../../images/<%=session.getAttribute("style") %>/b_lock.png" height='20'/>
							            
			                       </td>
							  </tr>
								<tr>
									  <td align="right"  bgcolor="ECF3FF" >资金收付标识： </td>
								    <td bgcolor="F6F9FF">
									 <html:select property="receive_pay_cd" alt="资金收付标识" disabled="true">
											<html:options collection="receive_pay_cdMap" property="key" labelProperty="value" />
										</html:select><font color="#FF0000"> *</font>   
									 </td>
								    <td align="right"  bgcolor="ECF3FF" >交易金额： </td>
								    <td bgcolor="F6F9FF"> 
								    <html:hidden  property="cny_amt" />
								    <html:text name="t47_transaction" property="amt_string" readonly="true"/><img src="../../images/<%=session.getAttribute("style") %>/b_lock.png" height='20'/></td>
								</tr>
				
									
								    <tr>
                                      <td height="18" align="right" bgcolor="ECF3FF"> 币种： </td>
                                      <td bgcolor="F6F9FF"> 
									  <html:select property="currency_cd" alt="币种" style="width:80" disabled="true">
											<html:options collection="currency_cdMap" property="key"
												labelProperty="value" />
										</html:select><font color="#FF0000"> *</font>
									  </td>
                                      <td align="right"  bgcolor="ECF3FF" >现钞标志：</td>
                                      <td bgcolor="F6F9FF">
						        ...
						        <tr>
								    <td align="right"  bgcolor="ECF3FF" >账号：</td>
								    <td bgcolor="F6F9FF">
								         <html:text property="acct_num" onchange="change();" onblur="validateDetail2('acct_num');" alt="账号" readonly="true" />
								         <img src="../../images/<%=session.getAttribute("style") %>/b_lock.png" height='20'/>
                                    </td>
                                   <td align="right"  bgcolor="ECF3FF" >流水号：</td>
								   <td  bgcolor="F6F9FF">
								         <html:text property="tx_no" alt="流水号" readonly="true" />
								         <img src="../../images/<%=session.getAttribute("style") %>/b_lock.png" height='20'/>
									</td>
								</tr>
						      	<tr>
								<td align="right"  bgcolor="ECF3FF" >帐户类型： </td>
								   <td  bgcolor="F6F9FF" colspan="3">
										<html:select property="acct_type" onchange="change();" onblur="validateDetail2('acct_type');" alt="帐户类型" >
											<html:options collection="acct_typeMap" property="label" labelProperty="value" />
										</html:select>
										 
									</td>
								</tr>
							    <tr>
									<td height="18" align="right" bgcolor="ECF3FF"><!--TSTP-->
										
										 支付工具及结算方式：
									</td>
									<td bgcolor="F6F9FF" colspan="3">										
										 <html:select style="width:250px" onmouseover="selMouseOver(this,$('div_hint'))"
										onmouseout="selMouseOut(this,$('div_hint'))" property="settle_type_cd"  onchange="validateDetail2('all');des_disp();">
			                                 <html:options collection="t87_pbc_gjfsMap"
                                                 property="label"
                                                  labelProperty="value" /> 
			                                    </html:select>  <font color="#FF0000"> *</font>
										</td>
								...
								<tr>
									<td  height="18" align="right" bgcolor="ECF3FF"><!--TSCT-->
			      ...
			      <html:select property="tsctkey" style="width:250px" onmouseover="selMouseOver(this,$('div_hint'))"
										onmouseout="selMouseOut(this,$('div_hint'))" >
                   <html:options collection="tsctMap"
                                    property="label"
                                   labelProperty="value" />
	               </html:select>
	               <input type="text" id="ipaddr" style="display:none" value="<bean:write name="t47_transactionActionForm" property="tsctkey"/>"  name="ipaddr" onblur="testRegx(this);"></input>
								   ...
								   <tr>
								   	...
								   	<td  height="18" align="right" bgcolor="ECF3FF"><!--CRSP-->
								...
								<tr>
									...
									<td  height="18" align="right" bgcolor="ECF3FF"><!--TRCD-->
										
										 交易发生地：
									</td>
								
									   <td bgcolor="F6F9FF">
										<html:select property="tx_occur_country"  style="width:150" onmouseover="selMouseOver(this,$('div_hint'))"
										 onmouseout="selMouseOut(this,$('div_hint'))"  
                                   ...
                                   labelProperty="value" /> 
                                    ...
                                    <input type="hidden" name="tx_occur" vaule=""/>	
									</td>
									<logic:equal name="t47_transaction" property="tx_occur_area"
										...
										<td height="22" bgcolor="ECF3FF" colspan="1" align="left"
								 ...
								 onchange="_Click('tx_occur_area1','tx_occur_area2');_Click('tx_occur_area2','tx_occur_area');set_tx_occur_allValue();change();" onmouseover="selMouseOver(this,$('div_hint'))" onmouseout="selMouseOut(this,$('div_hint'))"
								 onblur="validateDetail2('tx_occur');">
                           ...
                           <bean:write property="tx_occur_area2name" name="t47_transaction" />
                          </option>
                             </html:select>  
                            <html:select property="tx_occur_area"  style="width:100"
                             onmouseover="selMouseOver(this,$('div_hint'))" onmouseout="selMouseOut(this,$('div_hint'))"
				...
				<% if(validateflag.equals("1")||validateflag.equals("3")){ %>	
									<tr>
										<!-- 大额 -->
										<td width="20%" height="18" align="right" bgcolor="ECF3FF"><!--TDRC-->
											
											 交易方向：
										</td><td  bgcolor="F6F9FF">
										
										<html:select property="tx_go_country"  onchange="_DispRep('tx_go_country','org1','orgreplay1','2');_Click('tx_go_area1','tx_go_area2','0');_Click('tx_go_area2','tx_go_area','0');change();set_tx_go_allValue();"  
										onblur="validateDetail2('all');" style="width:150" onmouseover="selMouseOver(this,$('div_hint'))" onmouseout="selMouseOut(this,$('div_hint'))">
			                               <html:options collection="countryMap"
                                                    property="label"
									...
									<html:select property="tx_go_area1" onchange="_Click('tx_go_area1','tx_go_area2','0');_Click('tx_go_area2','tx_go_area');set_tx_go_allValue();change();"  
										onblur="validateDetail2('tx_go');"  style="width:150"  onmouseover="selMouseOver(this,$('div_hint'))" onmouseout="selMouseOut(this,$('div_hint'))">
			     <html:options collection="area1Map"
                                    property="label"
                                   labelProperty="value" /> </html:select>
								   
				<html:select property="tx_go_area2" onchange="_Click('tx_go_area2','tx_go_area','0');change();set_tx_go_allValue();"  
										onblur="validateDetail2('tx_go');" style="width:100" onmouseover="selMouseOver(this,$('div_hint'))" onmouseout="selMouseOut(this,$('div_hint'))">
                <option value="">请选择</option>
                
			 </html:select> 
			 <html:select property="tx_go_area"   style="width:100" onchange="change();set_tx_go_allValue();"  
							...
							<tr>
								...
								<td align="left" colspan="3">
									<html:select property="opp_acct_type_cd" style="width:250px" onmouseover="selMouseOver(this,$('div_hint'))"
										onmouseout="selMouseOut(this,$('div_hint'))"
										onchange="change();validateDetail2('opp_acct_num');"
...
<%--										 onchange="change();validate($$('opp_acct_num',0), 'opp_acct_type_cd', '');"--%>
							...
							<tr>
								...
								<td align="left">
									...
									<a href="#" onclick="_Open2('<%=request.getContextPath()%>/report/case/t47case_opp_info_list.do?newsearchflag=2');" ><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td align="left" colspan="3">
									...
									<html:select property="opp_card_type" styleId="opp_card_type" style="width:250px" onmouseover="selMouseOver(this,$('div_hint'))"
										onmouseout="selMouseOut(this,$('div_hint'))"
									...
									<html:text property="opp_card_inf" styleId="opp_card_inf" size="30" maxlength="30"
							...
							<tr>
								...
								<a href="#" onclick="_Open2('<%=request.getContextPath() %>/report/case/t47case_opp_bank_list.do?newflag=2')" ><span class="cond_buttons"><img src="../../images/<%=session.getAttribute("style") %>/b_location.png" />定位</span></a>
								</td>
							</tr>
							...
							<% if(validateflag.equals("2") || validateflag.equals("3")){%>					
									<tr>
									  <td height="18" align="right" bgcolor="ECF3FF">对方金融机构网点行政区划代码：</td>
									<td   bgcolor="F6F9FF">
			  <html:select property="opp_country" style="width:150"  
			    ...
			    onblur="validateDetail2('all');" onmouseover="selMouseOver(this,$('div_hint'))" onmouseout="selMouseOut(this,$('div_hint'))">
                      <html:options collection="countryMap"
                                    property="label"
                                   labelProperty="value" />
                </html:select> 
                <input type="hidden" name="opp_organarea" vlaue=""/></td>
			  <logic:equal name="t47_transaction" property="opp_area" value="<%=p_areavalue.toString()%>">
              <td height="22" bgcolor="F6F9FF" colspan="2" align="left" id="orgreplay">
			  </td>  
            	<td height="22" bgcolor="ECF3FF" colspan="2" align="left"  id="org" style="display:none ">
            </logic:equal>
			  <logic:notEqual  name="t47_transaction" property="opp_area" value="<%=p_areavalue.toString()%>">
			  
              <td height="22" bgcolor="F6F9FF" colspan="2" align="left" id="orgreplay" style="display:none ">
			  </td>
            	<td height="22" bgcolor="ECF3FF" colspan="2" align="left"  id="org" >
            </logic:notEqual>
				    <html:select property="opp_area1" style="width:150" onchange="_Click('opp_area1','opp_area2');change();set_opp_area_allValue();"
			    onblur="validateDetail2('opp_organarea');" onmouseover="selMouseOver(this,$('div_hint'))" onmouseout="selMouseOut(this,$('div_hint'))">
                    <html:options collection="area1Map"
                                    property="label"
                                   labelProperty="value" />
              </html:select>&nbsp;&nbsp;
			  <html:select property="opp_area2" style="width:100" onchange="_Click('opp_area2','opp_area');change();set_opp_area_allValue();"
			    onblur="validateDetail2('opp_organarea');" onmouseover="selMouseOver(this,$('div_hint'))" onmouseout="selMouseOut(this,$('div_hint'))">
                     <option value="">请选择</option>
		    ...
		    <%} %>
					...
					<div class="cond_c2">
						<table border="0" cellpadding="0" cellspacing="0">
						    <tr>
						       <td align="center"><%--
						          <input type="button" value="保存并下一条" class="in_button2"  onclick="_Confim('t47_transaction_se_modify_do1.do?saveType=2')"/>
						          --%><html:button property="button" styleClass="in_button1" onclick="_Confim('t47_transaction_se_verify_do.do?saveType=1')">保存</html:button>
						       </td>
						    </tr>
						</table>
					</div>
					...
					<div class="sys_warning">
						...
						<p>
							&nbsp;&nbsp;1、当交易金额与证件号码完全相同须进行核实，如：客户身份证件号码，交易对手身份证件号码，账号或交易对手账号，代办人身份证件号码，对公法定代表人身份证件号码(仅限可疑)。
							<br />
							&nbsp;&nbsp;2、当单笔大额或可疑交易金额超过1亿元人民币或等值1000万美元时须进行核实。
							<br />
							&nbsp;&nbsp;3、报送机构填写“帐户类型(CATP)”或“交易对手帐户类型(TCAT)”时，如无法区分人民币个人银行帐户为“本地帐户”或是“异地帐户”，一律选择“本地帐户”填写。
							<br />
							&nbsp;&nbsp;4、报送机构填写“帐户类型(CATP)”或“交易对手帐户类型(TCAT)”时，当该帐户既是“6100银证转账帐户”(或“6200银证转账帐户”)又是其他帐户类型(例如0011人民币本地存款人-基本帐户)时,一律选择“6100银证转账帐户”(或“6200银证转账帐户”)填写。
							<br />
						</p>
					</div>
					</div>
