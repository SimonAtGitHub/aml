...
function _Confim(url){
		...
		var subForm= document.frames[0].document.forms[0];
      	...
      	if(document.forms[0].finm.value==''){
			...
			errMsg = "金融机构代码不能为空！";
		}else   if(getLength(CheckBoxMustChecked(subForm))>0){
           errMsg="请选择交易信息！";
         }
		...
		if (errMsg != "") {
    		...
    		{reportkeys=subForm.reportkeyCheckBox.value;
    		  url+='?reportkey1='+reportkeys;
    		}else {
				url+='?reportkey1='+reportkeys.substr(0,reportkeys.length-1);
				}
...
<div id="main">
 <html:form action="/case/t07_case_app_add_de_c.do" method="post">
 		...
 		<div class="conditions">
			 ...
			 <iframe src="<%=request.getContextPath()%>/report/case/t07_case_app_add_de_c_page.do?newsearchflag=2"
		 ...
		 <table align="right">
	     	  <tr>
				<td  class="in_button" align="right">
					 <input name="" type="button" value="完成" onclick="_Confim('<%=request.getContextPath() %>/report/case/t07_case_app_add_de_c_comp.do')"/>		</td>
	   			</tr>
