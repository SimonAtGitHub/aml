...
function _Open1(url){
	...
	<body id="iframecontent">
		<html:form method="post" action="/case/stcr_party_list.do">
			<div class="list">
					...
					%>
						<tr>
							...
							<td>
								...
								<td>
								       <logic:equal name="party" property="validate" value="1">
												<img src="../../images/<%=session.getAttribute("style") %>/b_submit.png" />
											</logic:equal>
											<logic:notEqual name="party" property="validate" value="1">
