...
<div id="main">
<html:form action="/t07_report_organ/t07_report_organ_modify_do.do" method="post">
<!-- conditions --> 
	...
	<div class="cond_c2">
	  <table border="0" cellpadding="0" cellspacing="0">
	   ...
	   <tr>
         ...
         <td> <html:text property="report_organkey" readonly="true"/>
       ...
       <tr>
         ...
         <input type="button" class="in_button1" value="提 交" onclick="checkForm('t07_report_organ_modify_do.do')"/>
