...
<div id="main">
<html:form action="/t07_report_organ/t07_report_organ_map_modify_do.do" method="post">
<!-- conditions --> 
	  ...
	  <table border="0" cellpadding="0" cellspacing="0">
	   ...
	   <tr>
         ...
         <td> 
          ...
          <html:hidden property="organ_mapkey"/>
       ...
       <tr>
         ...
         <input type="button" class="in_button1" value="提 交" onclick="checkForm('t07_report_organ_map_modify_do.do')"/>
