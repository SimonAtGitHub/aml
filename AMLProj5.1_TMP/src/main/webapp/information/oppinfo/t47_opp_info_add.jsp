...
function checkForm(theUrl){
  ...
  //验证证件号码格式
    ...
    else if(document.forms[0].opp_card_no.length < 18){
    	errMsg="证件号码必须小于18位";
    	document.forms[0].opp_card_no.focus();
    }else if (document.forms[0].opp_card_type.value=="11"&&(getLength(document.forms[0].opp_card_no.value)!=15&&getLength(document.forms[0].opp_card_no.value)!=18)){
    errMsg = "身份证应为15或18位！";
        document.forms[0].opp_card_no.focus();
    }
   //账号必须为数字
...
<body class="mainbg">
<html:form method="post" action="/oppinfo/t47_opp_info_add.do">
<div id="main">
<!-- conditions --> 
	  ...
	  <table border="0" cellpadding="0" cellspacing="0">
       <tr>
        ...
        <tr>
         ...
         <td>
           <html:select property="opp_acct_type_cd" style="width:300px;" onmouseover="FixWidth(this);">
        ...
        <tr>
         ...
         <td colspan="3">
           <html:select property="opp_card_type"  onchange="cardChange();">
            ...
            <input type="text" name="opp_card_type_inf"  style="display:none"/>        
        </td>
		...
		<td align="center" class="in_button" colspan="4">
          ...
          <html:button property="button" value="提 交" onclick="checkForm('t47_opp_info_add_do.do')"/>
